import { _ as s, k as xt, m as E, l as q, ad as kt, ae as vt, af as _t, ag as bt, W as wt, ah as St, P as Et } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { d as nt } from "./arc-DfUqEaKX.js";
var X = function() {
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + (M + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (I[0]) {
          case 1:
            ...
            break;
          case 2:
            if (H = this.productions_[I[1]][1], W.$ = y[y.length - H], W._$ = {
              ...
              return K;
            H && (h = h.slice(0, -1 * H * 2), y = y.slice(0, -1 * H), o = o.slice(0, -1 * H)), h.push(this.productions_[I[1]][0]), y.push(W.$), o.push(W._$), et = S[h[h.length - 2]][h[h.length - 1]], h.push(et);
            break;
          case 3:
            return !0;
        }
...
var z = "", lt = 0, Y = [], U = [], V = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  Y.length = 0, U.length = 0, z = "", V.length = 0, Et();
...
}, "drawSection"), rt = -1, Ht = /* @__PURE__ */ s(function(n, t, e) {
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  return t.height = p.height + x * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, g.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), zt(c, t, i, l), t;
}, "drawNode"), Wt = /* @__PURE__ */ s(function(n, t, e) {
  var g;
...
}, Vt = /* @__PURE__ */ s(function(n, t, e, l) {
  var O, v, N;
  ...
  for (const [L, b] of x.entries()) {
    ...
    for (const w of b.events) {
      ...
      A += F.getVirtualNodeHeight(p, P, i);
    }
