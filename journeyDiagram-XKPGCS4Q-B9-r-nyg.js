import { a as gt, g as lt, f as mt, d as xt } from "./chunk-TZMSLE5B-CC_Hok-z.js";
import { g as kt } from "./chunk-FMBD7UC4-DiZrDO7E.js";
import { _ as n, h as _t, s as vt, i as bt, j as wt, J as Tt, I as St, k as R, l as G, n as $t, P as Mt } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { d as et } from "./arc-DfUqEaKX.js";
var U = function() {
...
U.parser = U;
var Et = U, V = "", J = [], L = [], B = [], Ct = /* @__PURE__ */ n(function() {
  ...
  ${kt()}
`, "getStyles"), jt = Bt, Z = /* @__PURE__ */ n(function(t, e) {
  return xt(t, e);
  ...
  s.diagramMarginX * (e.taskCount - 1), r.height = s.height, r.class = "journey-section section-type-" + e.num, r.rx = 3, r.ry = 3, Z(c, r), ht(s)(
    e.text,
    c,
    r.x,
    r.y,
  ...
  const u = lt();
  u.x = e.x, u.y = e.y, u.fill = e.fill, u.width = s.width, u.height = s.height, u.class = "task task-type-" + e.num, u.rx = 3, u.ry = 3, Z(r, u);
  let y = e.x + 14;
  e.people.forEach((g) => {
