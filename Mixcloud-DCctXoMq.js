import { v as _, r as f } from "./embed-entry-BQjeO8mI.js";
import { au as m, av as g } from "./mermaid-VLURNSYL-C7dSNHug.js";
function v(t, e) {
...
var P = Object.create, i = Object.defineProperty, O = Object.getOwnPropertyDescriptor, b = Object.getOwnPropertyNames, M = Object.getPrototypeOf, x = Object.prototype.hasOwnProperty, w = (t, e, r) => e in t ? i(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, j = (t, e) => {
  for (var r in e)
    i(t, r, { get: e[r], enumerable: !0 });
}, c = (t, e, r, s) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let o of b(e))
      !x.call(t, o) && o !== r && i(t, o, { get: () => e[o], enumerable: !(s = O(e, o)) || s.enumerable });
  return t;
  ...
  t
)), S = (t) => c(i({}, "__esModule", { value: !0 }), t), a = (t, e, r) => (w(t, typeof e != "symbol" ? e + "" : e, r), r), d = {};
j(d, {
  default: () => l
});
  ...
  render() {
    ...
    return /* @__PURE__ */ p.default.createElement(
      "iframe",
      {
        ...
        ref: this.ref,
        style: o,
        src: `https://player-widget.mixcloud.com/widget/iframe/?${n}`,
        frameBorder: "0",
        allow: "autoplay"
      }
    );
...
a(l, "loopOnEnded", !0);
const T = /* @__PURE__ */ _(h), A = /* @__PURE__ */ v({
  __proto__: null,
  default: T
}, [h]);
export {
