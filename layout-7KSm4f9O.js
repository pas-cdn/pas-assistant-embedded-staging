import { b as Ve, G as g, i as m, v as E } from "./graph-B4TybZj5.js";
import { i as X, d as C, k as Ye, o as $e, p as ve, q as pe, t as De, u as we, v as qe, w as be, c as V, x as We, b as Xe, y as ze, n as f, m as I, r as B } from "./_baseUniq-BU3V84HH.js";
import { f as O, b as me, a as He, c as Ue, m as w, d as P } from "./min-BCXVVCvd.js";
import { bo as M, bT as Je, bU as Ke, bv as ge, bV as S, bf as ye, bM as Qe, aF as Ze, bR as en, bW as nn, aH as xe, bQ as rn, bu as Ee, aG as ke, bm as tn, bx as an, bX as z } from "./mermaid-VLURNSYL-C7dSNHug.js";
var on = /\s/;
function un(e) {
...
var Oe = Object.prototype, xn = Oe.hasOwnProperty, En = ge(function(e, n) {
  ...
  for (i && S(n[0], n[1], i) && (t = 1); ++r < t; )
    for (var o = n[r], a = ye(o), u = -1, d = a.length; ++u < d; ) {
      var s = a[u], c = e[s];
      (c === void 0 || Qe(c, Oe[s]) && !xn.call(e, s)) && (e[s] = o[s]);
    }
  return e;
});
function F(e) {
...
function Fn(e, n) {
  if (e !== n) {
    var r = e !== void 0, t = e === null, i = e === e, o = X(e), a = n !== void 0, u = n === null, d = n === n, s = X(n);
...
var k = $n(), R = ge(function(e, n) {
  if (e == null)
    return [];
  var r = n.length;
  return r > 1 && S(e, n[0], n[1]) ? n = [] : r > 2 && S(n[0], n[1], n[2]) && (n = [n[0]]), Bn(e, Xe(n), []);
}), Dn = 0;
function K(e) {
  var n = ++Dn;
  return ze(e) + n;
...
function Qn(e) {
  var n = e.graph().acyclicer === "greedy" ? Un(e, r(e)) : Zn(e);
  f(n, function(t) {
    var i = e.edge(t);
...
function Ae(e, n, r, t) {
  var i = r.v, o = r.w;
  e.removeEdge(i, o), e.setEdge(t.v, t.w, {}), ee(e), Z(e, n), xr(e, n);
}
function xr(e, n) {
...
function Xr(e) {
  ...
  f(e.graph().dummyChains, function(r) {
    for (var t = e.node(r), i = t.edgeObj, o = zr(e, n, i.v, i.w), a = o.path, u = o.lca, d = 0, s = a[d], c = !0; r !== i.w; ) {
      if (t = e.node(r), c) {
    ...
    f(u, function(s) {
      ...
      if (c.length) {
        ...
        for (var l = (c.length - 1) / 2, h = Math.floor(l), v = Math.ceil(l); h <= v; ++h) {
          var p = c[h];
          o[s] === s && d < a[p] && !Qr(r, s, p) && (o[p] = s, o[s] = i[s] = i[p], d = a[p]);
        }
      }
    });
  }), { root: i, align: o };
...
function at(e) {
  var n = G(e), r = z(Ur(e, n), Jr(e, n)), t = {}, i;
  f(["u", "d"], function(a) {
    i = a === "u" ? n : E(n).reverse(), f(["l", "r"], function(u) {
      u === "r" && (i = w(i, function(l) {
        return E(l).reverse();
      }));
      var d = (a === "u" ? e.predecessors : e.successors).bind(e), s = Zr(e, i, r, d), c = et(e, i, s.root, s.align, u === "r");
