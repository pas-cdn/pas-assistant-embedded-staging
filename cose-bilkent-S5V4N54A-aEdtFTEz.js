import { _ as V, m as $, l as lt } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { c as J } from "./cytoscape.esm-ZmItrg9y.js";
import { A as Q, v as gt } from "./embed-entry-BQjeO8mI.js";
var tt = { exports: {} }, k = { exports: {} }, Z = { exports: {} }, q;
function ut() {
...
async function st(G, b) {
  ...
  try {
    ...
    return $.debug(`Layout completed: ${I.length} nodes, ${T.length} edges`), {
      nodes: I,
      edges: T
    };
  } catch (N) {
