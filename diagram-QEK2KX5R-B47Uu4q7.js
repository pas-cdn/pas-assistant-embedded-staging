import { _ as l, s as k, h as I, J as R, I as _, i as E, j as F, a1 as D, P, Y as y, Z as C, $ as G, m as z, a3 as V } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { p as W } from "./chunk-4BX2VUAB-Dry3wvbl.js";
import { p as j } from "./treemap-KMMF4GRG-CEx6UpjY.js";
var m = {
  showLegend: !0,
  ticks: 5,
  max: null,
  ...
  curves: [],
  options: m
}, h = structuredClone(w), B = G.radar, H = /* @__PURE__ */ l(() => y({
  ...B,
  ...C().radar
}), "getConfig"), b = /* @__PURE__ */ l(() => h.axes, "getAxes"), Y = /* @__PURE__ */ l(() => h.curves, "getCurves"), Z = /* @__PURE__ */ l(() => h.options, "getOptions"), J = /* @__PURE__ */ l((a) => {
  h.axes = a.map((t) => ({
    name: t.name,
    label: t.label ?? t.name
  }));
}, "setAxes"), N = /* @__PURE__ */ l((a) => {
  h.curves = a.map((t) => ({
    name: t.name,
    label: t.label ?? t.name,
    entries: U(t.entries)
  }));
}, "setCurves"), U = /* @__PURE__ */ l((a) => {
  if (a[0].axis == null)
...
}, "computeCurveEntries"), X = /* @__PURE__ */ l((a) => {
  var e, r, s, o, i;
  const t = a.reduce(
    (n, c) => (n[c.name] = c, n),
    {}
  ...
  const s = r.db, o = s.getAxes(), i = s.getCurves(), n = s.getOptions(), c = s.getConfig(), d = s.getDiagramTitle(), p = D(t), u = et(p, c), g = n.max ?? Math.max(...i.map((f) => Math.max(...f.entries))), x = n.min, v = Math.min(c.width, c.height) / 2;
