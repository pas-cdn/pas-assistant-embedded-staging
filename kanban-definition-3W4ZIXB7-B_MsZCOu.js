import { _ as c, m as te, k as W, a1 as fe, ak as ye, al as be, am as me, ad as _e, $ as Y, q as G, K as ke, L as Ee, ae as Se, af as le, ag as ce } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { g as Ne } from "./chunk-FMBD7UC4-DiZrDO7E.js";
var $ = function() {
  var t = /* @__PURE__ */ c(function(_, s, n, a) {
    for (n = n || {}, a = _.length; a--; n[_[a]] = s) ;
    return n;
  }, "o"), g = [1, 4], d = [1, 13], r = [1, 12], p = [1, 15], k = [1, 16], f = [1, 20], h = [1, 19], L = [6, 7, 8], C = [1, 26], w = [1, 24], N = [1, 25], i = [6, 7, 11], M = [1, 31], x = [6, 7, 11, 24], P = [1, 6, 13, 16, 17, 20, 23], U = [1, 35], j = [1, 36], A = [1, 6, 7, 11, 13, 16, 17, 20, 23], H = [1, 38], V = {
    ...
    parse: /* @__PURE__ */ c(function(s) {
      ...
      for (var q in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, q) && (T.yy[q] = this.yy[q]);
      ...
      c(ae, "lex");
      for (var E, R, v, Q, F = {}, K, I, oe, X; ; ) {
        if (R = a[a.length - 1], this.defaultActions[R] ? v = this.defaultActions[R] : ((E === null || typeof E > "u") && (E = ae()), v = B[R] && B[R][E]), typeof v > "u" || !v.length || !v[0]) {
          var Z = "";
          X = [];
          for (K in B[R])
            this.terminals_[K] && K > ue && X.push("'" + this.terminals_[K] + "'");
          b.showPosition ? Z = "Parse error on line " + (z + 1) + `:
` + b.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Z = "Parse error on line " + (z + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Z, {
            text: b.match,
        ...
        switch (v[0]) {
          case 1:
            a.push(E), u.push(b.yytext), e.push(b.yylloc), a.push(v[1]), E = null, ie = b.yyleng, l = b.yytext, z = b.yylineno, J = b.yylloc;
            break;
          case 2:
...
` + t);
  const k = r.db.getData(), f = W();
  f.htmlLabels = !1;
  const h = fe(g), L = h.append("g");
  L.attr("class", "sections");
  const C = h.append("g");
  C.attr("class", "items");
  const w = k.nodes.filter(
  ...
  for (const m of w) {
    ...
    let n = s;
    const a = k.nodes.filter((e) => e.parentId === m.id);
    for (const e of a) {
      if (e.isGroup)
