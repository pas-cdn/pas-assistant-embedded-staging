...
}, Bd = (gi = Math.hypot) !== null && gi !== void 0 ? gi : function(r, e) {
...
function Pd(r, e) {
  ...
  for (var v = u.length, f = [], c = 0; c < v; c++) {
    var h = u[c], d = u[(c + 1) % v], y = a(d, h), g = s({
      x: y.y,
      y: -y.x
    });
    f.push(g);
  ...
  for (var p = f.map(function(x, T) {
    var k = t(u[T], n(x, e)), D = t(u[(T + 1) % v], n(x, e));
    return {
      p1: k,
      p2: D
    };
...
function Ad(r, e, t, a, n, i) {
  var s = Vd(r, e, t, a, n), o = Pd(s, i), l = wr();
  return o.forEach(function(u) {
    return mv(l, u.x, u.y);
  }), l;
}
var wv = function(e, t, a, n, i, s, o) {
  var l = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : "auto", u = l === "auto" ? vt(i, s) : l, v = i / 2, f = s / 2;
  u = Math.min(u, v, f);
  var c = u !== v, h = u !== f, d;
  if (c) {
    var y = a - v + u - o, g = n - f - o, p = a + v - u + o, m = g;
    if (d = it(e, t, a, n, y, g, p, m, !1), d.length > 0)
      return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + u - o, E = b, C = n + f - u + o;
    if (d = it(e, t, a, n, b, w, E, C, !1), d.length > 0)
      return d;
  }
  if (c) {
    var x = a - v + u - o, T = n + f + o, k = a + v - u + o, D = T;
    if (d = it(e, t, a, n, x, T, k, D, !1), d.length > 0)
      return d;
  }
  if (h) {
    var B = a - v - o, P = n - f + u - o, A = B, R = n + f - u + o;
    if (d = it(e, t, a, n, B, P, A, R, !1), d.length > 0)
      return d;
  }
  var L;
  {
    var I = a - v + u, M = n - f + u;
    if (L = ya(e, t, a, n, I, M, u + o), L.length > 0 && L[0] <= I && L[1] <= M)
      return [L[0], L[1]];
  }
  {
    var O = a + v - u, V = n - f + u;
    if (L = ya(e, t, a, n, O, V, u + o), L.length > 0 && L[0] >= O && L[1] <= V)
      return [L[0], L[1]];
  }
  {
    var G = a + v - u, N = n + f - u;
    if (L = ya(e, t, a, n, G, N, u + o), L.length > 0 && L[0] >= G && L[1] >= N)
      return [L[0], L[1]];
  }
  {
    var F = a - v + u, U = n + f - u;
    if (L = ya(e, t, a, n, F, U, u + o), L.length > 0 && L[0] <= F && L[1] >= U)
      return [L[0], L[1]];
  }
  return [];
  ...
  for (var p = -1, m, b, w, E = 0; E < y.length; E++)
    m = Math.pow(1 - y[E], 2) * a + 2 * (1 - y[E]) * y[E] * i + y[E] * y[E] * o, b = Math.pow(1 - y[E], 2) * n + 2 * (1 - y[E]) * y[E] * s + y[E] * y[E] * l, w = Math.pow(m - e, 2) + Math.pow(b - t, 2), p >= 0 ? w < p && (p = w) : p = w;
  return p;
  ...
  if (g >= 0 && g <= 1 && m.push(g), p >= 0 && p <= 1 && m.push(p), m.length === 0)
    return [];
  var b = m[0] * l[0] + e, w = m[0] * l[1] + t;
  if (m.length > 1) {
    if (m[0] == m[1])
      return [b, w];
    var E = m[1] * l[0] + e, C = m[1] * l[1] + t;
    return [b, w, E, C];
  } else
    return [b, w];
}, pi = function(e, t, a) {
  ...
  var v = e - i, f = a - e, c = o - i, h = t - s, d = n - t, y = l - s, g = c * h - y * v, p = f * h - d * v, m = y * f - c * d;
  if (m !== 0) {
  ...
  for (var g, p, m, b, w = 0; w < h.length / 2; w++)
    g = h[w * 2], p = h[w * 2 + 1], w < h.length / 2 - 1 ? (m = h[(w + 1) * 2], b = h[(w + 1) * 2 + 1]) : (m = h[0], b = h[1]), v = it(e, t, n, i, g, p, m, b), v.length !== 0 && u.push(v[0], v[1]);
  return u;
  ...
  for (var h = 0; h < c.length / 4; h++)
    f = it(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], !1), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
...
var Gd = cr({
  ...
  pageRank: function(e) {
    for (var t = Gd(e), a = t.dampingFactor, n = t.precision, i = t.iterations, s = t.weight, o = this._private.cy, l = this.byGroup(), u = l.nodes, v = l.edges, f = u.length, c = f * f, h = v.length, d = new Array(c), y = new Array(f), g = (1 - a) / f, p = 0; p < f; p++) {
      for (var m = 0; m < f; m++) {
        var b = p * f + m;
        d[b] = 0;
      }
    ...
    for (var w = 0; w < h; w++) {
      ...
      if (C !== x) {
        var T = u.indexOfId(C), k = u.indexOfId(x), D = s(E), B = k * f + T;
        d[B] += D, y[T] += D;
      }
    }
    ...
    for (var O = new Array(f), V = new Array(f), G, N = 0; N < f; N++)
      O[N] = 1;
    for (var F = 0; F < i; F++) {
      for (var U = 0; U < f; U++)
        V[U] = 0;
...
var Yo = cr({
  ...
  closenessCentralityNormalized: function(e) {
    for (var t = Yo(e), a = t.harmonic, n = t.weight, i = t.directed, s = this.cy(), o = {}, l = 0, u = this.nodes(), v = this.floydWarshall({
      weight: n,
      directed: i
    }), f = 0; f < u.length; f++) {
  ...
  closenessCentrality: function(e) {
    var t = Yo(e), a = t.root, n = t.weight, i = t.directed, s = t.harmonic;
    a = this.filter(a)[0];
...
var Wd = cr({
  ...
  betweennessCentrality: function(e) {
    for (var t = Wd(e), a = t.directed, n = t.weight, i = n != null, s = this.cy(), o = this.nodes(), l = {}, u = {}, v = 0, f = {
      set: function(b, w) {
        u[b] = w, w > v && (v = w);
      },
      get: function(b) {
    ...
    for (var y = function() {
      for (var b = o[g].id(), w = [], E = {}, C = {}, x = {}, T = new Va(function(Q, K) {
        return x[Q] - x[K];
      }), k = 0; k < o.length; k++) {
        var D = o[k].id();
        E[D] = [], C[D] = 0, x[D] = 1 / 0;
      ...
      for (C[b] = 1, x[b] = 0, T.push(b); !T.empty(); ) {
        ...
        if (w.push(B), i)
          for (var P = 0; P < l[B].length; P++) {
            var A = l[B][P], R = s.getElementById(B), L = void 0;
...
var $d = cr({
  ...
  for (var h = 0; h < a.length; h++) {
    var d = a[h], y = s[d.source().id()], g = s[d.target().id()], p = Kd(d, i.attributes);
    v[y * l + g] += p, v[g * l + y] += p;
  }
...
var sh = cr({
  ...
  i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, l = mi(a, i.k, i.attributes)) : ar(i.testCentroids) === "object" ? l = i.testCentroids : l = mi(a, i.k, i.attributes) : l = mi(a, i.k, i.attributes);
  for (var u = !0, v = 0; u && v < i.maxIterations; ) {
    for (var f = 0; f < a.length; f++)
      n = a[f], o[n.id()] = Sv(n, l, i.distance, i.attributes, "kMeans");
    u = !1;
    for (var c = 0; c < i.k; c++) {
      var h = kv(c, a, o);
      if (h.length !== 0) {
  ...
  for (var f = !0, c = 0; f && c < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], l[n.id()] = Sv(n, o, i.distance, i.attributes, "kMedoids");
    f = !1;
  ...
  var t = ph(e), a = yh[t.linkage];
  return a != null && (t.linkage = a), t;
}, tu = function(e, t, a, n, i) {
  for (var s = 0, o = 1 / 0, l, u = i.attributes, v = function(k, D) {
    return Nn(i.distance, u.length, function(B) {
      return u[B](k);
    }, function(B) {
      return u[B](D);
    }, k, D);
  ...
  for (var p = 0; p < e.length; p++) {
    var m = e[p];
    d.key === m.key ? l = 1 / 0 : i.linkage === "min" ? (l = a[d.key][m.key], a[d.key][m.key] > a[y.key][m.key] && (l = a[y.key][m.key])) : i.linkage === "max" ? (l = a[d.key][m.key], a[d.key][m.key] < a[y.key][m.key] && (l = a[y.key][m.key])) : i.linkage === "mean" ? l = (a[d.key][m.key] * d.size + a[y.key][m.key] * y.size) / (d.size + y.size) : i.mode === "dendrogram" ? l = v(m.value, d.value) : l = v(m.value[0], d.value[0]), a[d.key][m.key] = a[m.key][d.key] = l;
  }
  ...
  if (!e) return [];
  var n = [], i = [], s = [];
  return t === 0 ? (e.left && $t(e.left, n), e.right && $t(e.right, i), s = n.concat(i), [a.collection(s)]) : t === 1 ? e.value ? [a.collection(e.value)] : (e.left && $t(e.left, n), e.right && $t(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = Ls(e.left, t - 1, a)), e.right && (i = Ls(e.right, t - 1, a)), n.concat(i));
}, au = function(e) {
  for (var t = this.cy(), a = this.nodes(), n = mh(e), i = n.attributes, s = function(b, w) {
  ...
  for (var h = 0; h < o.length; h++)
    for (var d = 0; d <= h; d++) {
      var y = void 0;
      n.mode === "dendrogram" ? y = h === d ? 1 / 0 : s(o[h].value, o[d].value) : y = h === d ? 1 / 0 : s(o[h].value[0], o[d].value[0]), l[h][d] = y, l[d][h] = y, y < l[h][u[h]] && (u[h] = d);
    }
  for (var g = tu(o, v, l, u, n); g; )
    g = tu(o, v, l, u, n);
  var p;
  return n.mode === "dendrogram" ? (p = Ls(o[0], n.dendrogramDepth, t), n.addDendrogram && Ms(o[0], t)) : (p = new Array(o.length), o.forEach(function(m, b) {
    m.key = m.index = null, p[b] = t.collection(m.value);
  })), p;
}, bh = {
  hierarchicalClustering: au,
  hca: au
}, wh = cr({
  distance: "euclidean",
  ...
  return n.some(function(i) {
    ...
    return "'".concat(i, "'");
  }).join(", "), "] or a number.  Got: ").concat(a)), wh(e);
}, Eh = function(e, t, a, n) {
  var i = function(o, l) {
    return n[l](o);
  };
  ...
  var a = null;
  return t === "median" ? a = xd(e) : t === "mean" ? a = wd(e) : t === "min" ? a = md(e) : t === "max" ? a = bd(e) : a = t, a;
}, Th = function(e, t, a) {
  for (var n = [], i = 0; i < e; i++)
  ...
  for (var t = this.cy(), a = this.nodes(), n = xh(e), i = {}, s = 0; s < a.length; s++)
    i[a[s].id()] = s;
  var o, l, u, v, f, c;
  ...
  for (var d = 0; d < o; d++)
    for (var y = 0; y < o; y++)
      d !== y && (u[d * o + y] = Eh(n.distance, a[d], a[y], n.attributes));
  v = Ch(u, n.preference);
  for (var g = 0; g < o; g++)
    u[g * o + g] = v;
  f = new Array(l);
  ...
  for (k = 0; k < n.maxIterations; k++) {
    for (var D = 0; D < o; D++) {
      for (var B = -1 / 0, P = -1 / 0, A = -1, R = 0, L = 0; L < o; L++)
        b[L] = f[D * o + L], R = c[D * o + L] + u[D * o + L], R >= B ? (P = B, B = R, A = L) : R > P && (P = R);
      for (var I = 0; I < o; I++)
        f[D * o + I] = (1 - n.damping) * (u[D * o + I] - B) + n.damping * b[I];
      f[D * o + A] = (1 - n.damping) * (u[D * o + A] - P) + n.damping * b[A];
    }
    for (var M = 0; M < o; M++) {
      for (var O = 0, V = 0; V < o; V++)
        b[V] = c[V * o + M], w[V] = Math.max(0, f[V * o + M]), O += w[V];
  ...
  for (var re = Th(o, f, c), ne = Sh(o, u, re), J = {}, z = 0; z < re.length; z++)
    J[re[z]] = [];
  for (var q = 0; q < a.length; q++) {
    var H = i[a[q].id()], Y = ne[H];
    Y != null && J[Y].push(a[q]);
  }
  ...
  hierholzer: function(e) {
    ...
    var a = Dh(e), n = a.root, i = a.directed, s = this, o = !1, l, u, v;
    ...
    i ? s.forEach(function(m) {
      ...
      if (m.isNode()) {
        ...
        C == 1 ? l ? o = !0 : l = b : x == 1 ? u ? o = !0 : u = b : (x > 1 || C > 1) && (o = !0), f[b] = [], m.outgoers().forEach(function(T) {
      ...
      if (m.isNode()) {
        var w = m.degree(!0);
        w % 2 && (l ? u ? o = !0 : u = b : l = b), f[b] = [], m.connectedEdges().forEach(function(E) {
    ...
    if (y.size() === 0)
      ...
      y.forEach(function(w) {
        g = w.source().id(), p = w.target().id(), m = g === h ? p : g, m !== d && (b = w.id(), o[b] || (o[b] = !0, s.push({
          ...
          y: m,
          edge: w
        })), m in t ? t[h].low = Math.min(t[h].low, t[m].id) : (u(c, m, h), t[h].low = Math.min(t[h].low, t[m].low), t[h].id <= t[m].low && (t[h].cutVertex = !0, l(h, m))));
      });
    }
  };
...
var ta = typeof Promise < "u" ? Promise : Nr, Is = function(e, t, a) {
  var n = Ys(e), i = !n, s = this._private = be({
    duration: 1e3
  }, t, a);
  if (s.target = e, s.style = s.style || s.css, s.started = !1, s.playing = !1, s.hooked = !1, s.applying = !1, s.progress = 0, s.completes = [], s.frames = [], s.complete && Ue(s.complete) && s.completes.push(s.complete), i) {
    var o = e.position();
...
function zh() {
  if (gu) return Si;
  gu = 1;
  var r = Lh(), e = Oh(), t = Na(), a = Nh(), n = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, s = Function.prototype, o = Object.prototype, l = s.toString, u = o.hasOwnProperty, v = RegExp(
...
function _h() {
  if (xu) return Ri;
  xu = 1;
  var r = Fn(), e = "__lodash_hash_undefined__", t = Object.prototype, a = t.hasOwnProperty;
  function n(i) {
    var s = this.__data__;
    if (r) {
      var o = s[i];
...
function Gh() {
  if (Eu) return Mi;
  Eu = 1;
  var r = Fn(), e = Object.prototype, t = e.hasOwnProperty;
  function a(n) {
    var i = this.__data__;
...
function Hh() {
  if (Cu) return Li;
  Cu = 1;
  var r = Fn(), e = "__lodash_hash_undefined__";
  function t(a, n) {
    var i = this.__data__;
...
function Wh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Ii = i, Ii;
}
var Oi, Su;
function $h() {
  if (Su) return Oi;
...
function Uh() {
  if (Bu) return Fi;
  Bu = 1;
  var r = Vn(), e = Array.prototype, t = e.splice;
  function a(n) {
...
function Zh() {
  ...
  return i.prototype.clear = r, i.prototype.delete = e, i.prototype.get = t, i.prototype.has = a, i.prototype.set = n, Gi = i, Gi;
}
var Hi, Lu;
function Qh() {
  if (Lu) return Hi;
  Lu = 1;
  var r = so(), e = Ln(), t = r(e, "Map");
  return Hi = t, Hi;
}
var Wi, Iu;
function Jh() {
...
function ig() {
  if (Gu) return Ji;
  Gu = 1;
  var r = ng(), e = "Expected a function";
  function t(a, n) {
...
function Iv() {
  if (Wu) return es;
  Wu = 1;
  var r = sg(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, t = /\\(\\)?/g, a = r(function(n) {
    var i = [];
...
function og() {
  if (Uu) return ts;
  Uu = 1;
  var r = Qs(), e = Ov(), t = zn(), a = za(), n = r ? r.prototype : void 0, i = n ? n.toString : void 0;
  function s(o) {
    if (typeof o == "string")
      return o;
    if (t(o))
...
var vg = lg(), fg = /* @__PURE__ */ Oa(vg), us, Ju;
function cg() {
  if (Ju) return us;
  Ju = 1;
  var r = so(), e = function() {
...
function hg() {
  if (el) return vs;
  el = 1;
  var r = dg(), e = Lv(), t = Object.prototype, a = t.hasOwnProperty;
  function n(i, s, o) {
    var l = i[s];
...
var mg = yg(), bg = /* @__PURE__ */ Oa(mg), hs, nl;
function wg() {
  if (nl) return hs;
  nl = 1;
  function r(e, t) {
...
function xg() {
  if (il) return gs;
  il = 1;
  var r = Ov(), e = wg(), t = zn(), a = za(), n = Iv(), i = oo(), s = Nv();
  function o(l) {
    return t(l) ? r(l, i) : a(l) ? [l] : e(n(s(l)));
  }
  return gs = o, gs;
}
var Eg = xg(), Cg = /* @__PURE__ */ Oa(Eg), Tg = {
  // access data field
  data: function(e) {
    var t = {
      field: "data",
    ...
    return e = be({}, t, e), function(n, i) {
      var s = e, o = this, l = o.length !== void 0, u = l ? o : [o], v = l ? o[0] : o;
      if (ge(n)) {
        var f = n.indexOf(".") !== -1, c = f && Cg(n);
        if (s.allowGetting && i === void 0) {
          var h;
          return v && (s.beforeGet(v), c && v._private[s.field][n] === void 0 ? h = fg(v._private[s.field], c) : h = v._private[s.field][n]), h;
          ...
          if (d) {
            ...
            for (var g = 0, p = u.length; g < p; g++) {
              var m = u[g];
              s.canSet(m) && (c && v._private[s.field][n] === void 0 ? bg(m._private[s.field], c, i) : m._private[s.field][n] = i);
            }
  ...
  toggleClass: function(e, t) {
    ...
    for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++)
      for (var l = a[s], u = l._private.classes, v = !1, f = 0; f < e.length; f++) {
        var c = e[f], h = u.has(c), d = !1;
        t || n && !h ? (u.add(c), d = !0) : (!t || n && h) && (u.delete(c), d = !0), !v && d && (i.push(l), v = !0);
      }
...
var qe = function() {
  ...
  populate: function(e, t, a) {
    var n = Je(a, 3), i = n[0], s = n[1], o = n[2], l = new RegExp("^" + Me.string + "$").exec(o) != null;
  ...
  populate: function(e, t) {
    if (e.currentSubject == null) {
      ...
      var s = qe(), o = e[e.length - 1], l = qe(), u = qe(), v = qe(), f = qe();
      return s.checks.push({
...
var Ag = function(e) {
  ...
  var t = this, a = t.inputText = e, n = t[0] = qe();
  ...
  for (var u = 0; u < t.length; u++) {
    ...
    v.edgeCount === 1 && Ve("The selector `" + e + "` is deprecated.  Edge selectors do not take effect on changes to source and target nodes after an edge is added, for performance reasons.  Use a class or data selector on edges instead, updating the class or data of an edge when your app detects a change in source or target nodes.");
  }
  return !0;
}, Lg = function() {
  ...
  var n, i = ge(e), s = ae(e), o = ge(a), l, u, v = !1, f = !1, c = !1;
...
Xe[se.NODE_NEIGHBOR] = function(r, e) {
  return We(r.node, e) && e.neighborhood().some(function(t) {
...
Xe[se.NODE_SOURCE] = function(r, e) {
  return We(r.source, e) && e.outgoers().some(function(t) {
    return t.isNode() && We(r.target, t);
  });
};
Xe[se.NODE_TARGET] = function(r, e) {
  return We(r.target, e) && e.incomers().some(function(t) {
...
Xe[se.PARENT] = function(r, e) {
  return We(r.parent, e) && e.children().some(function(t) {
    return We(r.child, t);
  });
};
Xe[se.DESCENDANT] = function(r, e) {
  return We(r.descendant, e) && e.ancestors().some(function(t) {
    return We(r.ancestor, t);
  });
};
Xe[se.ANCESTOR] = function(r, e) {
  return We(r.ancestor, e) && e.descendants().some(function(t) {
...
var Fg = function(e) {
  ...
  this.inputText = e, this.currentSubject = null, this.compoundCount = 0, this.edgeCount = 0, this.length = 0, e == null || ge(e) && e.match(/^\s*$/) || (Dr(e) ? this.addQuery({
    checks: [{
      type: se.COLLECTION,
      value: e.collection()
    }]
  ...
  }) : ge(e) ? this.parse(e) || (this.invalid = !0) : $e("A selector must be created from a string; found "));
}, ct = ft.prototype;
...
var Rr = function(e, t) {
  return function(n, i, s, o) {
    ...
    if (l == null ? v = "" : Dr(l) && l.length === 1 && (v = l.id()), u.length === 1 && v) {
      var f = u[0]._private, c = f.traversalCache = f.traversalCache || {}, h = c[t] = c[t] || [], d = Dt(v), y = h[d];
...
Or = Gv = {
  ...
  renderedPosition: function(e, t) {
    var a = this[0], n = this.cy(), i = n.zoom(), s = n.pan(), o = Le(e) ? e : void 0, l = o !== void 0 || t !== void 0 && ge(e);
    if (a && a.isNode())
      if (l)
  ...
  relativePosition: function(e, t) {
    var a = this[0], n = this.cy(), i = Le(e) ? e : void 0, s = i !== void 0 || t !== void 0 && ge(e), o = n.hasCompoundNodes();
    if (a && a.isNode())
      if (s)
...
var Ar = function(e) {
  ...
  if (!t.cy().headless()) {
    ...
    if (o) {
      var l = t.pstyle("text-halign"), u = t.pstyle("text-valign"), v = fa(s, "labelWidth", a), f = fa(s, "labelHeight", a), c = fa(s, "labelX", a), h = fa(s, "labelY", a), d = t.pstyle(n + "text-margin-x").pfValue, y = t.pstyle(n + "text-margin-y").pfValue, g = t.isEdge(), p = t.pstyle(n + "text-rotation"), m = t.pstyle("text-outline-width").pfValue, b = t.pstyle("text-border-width").pfValue, w = b / 2, E = t.pstyle("text-background-padding").pfValue, C = 2, x = f, T = v, k = T / 2, D = x / 2, B, P, A, R;
      if (g)
      ...
      B += L, P += I, A += M, R += O;
      var V = a || "main", G = i.labelBounds, N = G[V] = G[V] || {};
      ...
      if (F || U) {
        var Q = F ? fa(i.rstyle, "labelAngle", a) : p.pfValue, K = Math.cos(Q), j = Math.sin(Q), re = (B + P) / 2, ne = (A + R) / 2;
        if (!g) {
          switch (l.value) {
            case "left":
              re = P;
        ...
        var J = function(Ce, we) {
          return Ce = Ce - re, we = we - ne, {
            x: Ce * K - we * j + re,
            y: Ce * j + we * K + ne
          };
        }, z = J(B, A), q = J(B, R), H = J(P, A), Y = J(P, R);
        B = Math.min(z.x, q.x, H.x, Y.x), P = Math.max(z.x, q.x, H.x, Y.x), A = Math.min(z.y, q.y, H.y, Y.y), R = Math.max(z.y, q.y, H.y, Y.y);
      }
      var te = V + "Rot", ce = G[te] = G[te] || {};
      ce.x1 = B, ce.y1 = A, ce.x2 = P, ce.y2 = R, ce.w = P - B, ce.h = R - A, Ir(e, B, A, P, R), Ir(i.labelBounds.all, B, A, P, R);
    }
    return e;
  }
}, ol = function(e, t) {
  ...
  var a = e._private.cy, n = a.styleEnabled(), i = a.headless(), s = wr(), o = e._private, l = e.isNode(), u = e.isEdge(), v, f, c, h, d, y, g = o.rstyle, p = l && n ? e.pstyle("bounds-expansion").pfValue : [0], m = function(Ae) {
  ...
  if (b) {
    ...
    if (n && (k = e.pstyle("width").pfValue, D = k / 2), l && t.includeNodes) {
      ...
      v = d - A, f = d + A, c = y - L, h = y + L, Ir(s, v, c, f, h), n && ol(s, e), n && t.includeOutlines && !i && ol(s, e), n && Wg(s, e);
    } else if (u && t.includeEdges)
      if (n && !i) {
        var I = e.pstyle("curve-style").strValue;
        if (v = Math.min(g.srcX, g.midX, g.tgtX), f = Math.max(g.srcX, g.midX, g.tgtX), c = Math.min(g.srcY, g.midY, g.tgtY), h = Math.max(g.srcY, g.midY, g.tgtY), v -= D, f += D, c -= D, h += D, Ir(s, v, c, f, h), I === "haystack") {
          var M = g.haystackPts;
          if (M && M.length === 2) {
        ...
        var U = e.source(), Q = U.position(), K = e.target(), j = K.position();
    ...
    if (n && t.includeEdges && u && (ja(s, e, "mid-source"), ja(s, e, "mid-target"), ja(s, e, "source"), ja(s, e, "target")), n) {
      ...
      if (J) {
        var z = e.pstyle("ghost-offset-x").pfValue, q = e.pstyle("ghost-offset-y").pfValue;
    ...
    te.all != null ? kd(te.all) : te.all = wr(), n && t.includeLabels && (t.includeMainLabels && ys(s, e, null), u && (t.includeSourceLabels && ys(s, e, "source"), t.includeTargetLabels && ys(s, e, "target")));
  }
  ...
  var a = e._private, n, i = e.isEdge(), s = t == null ? ll : $v(t), o = s === ll;
...
pt.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === !0, a = Qt(function(v) {
    var f = v._private;
  ...
  if (t && this.length === 1 && !a(this[0]))
    r === void 0 ? r = Pa : r = vl(r), e = ul(this[0], r);
  else {
    e = wr(), r = r || Pa;
    var n = vl(r), i = this, s = i.cy(), o = s.styleEnabled();
...
var Yv = /^([^.]+)(\.(?:[^.]+))?$/, ip = ".*", Zv = {
  ...
  context: null
}, cl = Object.keys(Zv), sp = {};
function Gn() {
  for (var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : sp, e = arguments.length > 1 ? arguments[1] : void 0, t = 0; t < cl.length; t++) {
    var a = cl[t];
    this[a] = r[a] || Zv[a];
  }
  this.context = e || this.context, this.listeners = [], this.emitting = 0;
}
var dt = Gn.prototype, Qv = function(e, t, a, n, i, s, o) {
  ...
  for (var n = _e(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    ...
    if (!ut(s)) {
      var o = s.match(Yv);
      if (o) {
        var l = o[1], u = o[2] ? o[2] : null, v = dl(e, {
          type: l,
          namespace: u,
          target: e.context
        });
...
dt.on = dt.addListener = function(r, e, t, a, n) {
  return Qv(this, function(i, s, o, l, u, v, f) {
    Ue(v) && i.listeners.push({
      event: s,
      // full event string
      callback: v,
      // callback to run
...
dt.emit = dt.trigger = function(r, e, t) {
  ...
  return this.emitting++, _e(e) || (e = [e]), op(this, function(i, s) {
    t != null && (a = [{
      event: s.event,
      type: s.type,
    ...
    for (var o = function() {
      var v = a[l];
      if (v.type === s.type && (!v.namespace || v.namespace === s.namespace || v.namespace === ip) && i.eventMatches(i.context, v, s)) {
        var f = [s];
        e != null && Qc(f, e), i.beforeEmit(i.context, v, s), v.conf && v.conf.one && (i.listeners = i.listeners.filter(function(d) {
          return d !== v;
        }));
...
He.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = !1, C = 0; C < w; C++) {
        var x = b[C], T = y[x];
        ae(T) && (T = y[x] = "" + y[x]), T == null || T === "" ? ($e("Can not create edge `" + g + "` with unspecified " + x), E = !0) : a.hasElementWithId(T) || ($e("Can not create edge `" + g + "` with nonexistant " + x + " `" + T + "`"), E = !0);
      }
      if (E) {
        c();
        continue;
  ...
  for (var B = 0; B < i.length; B++) {
    ...
    if (L || P._private.parent) {
      ...
      if (I.empty())
        ...
        Ve("Node added with missing parent, reference to parent removed"), A.parent = void 0, P._private.parent = null;
      else {
  ...
  if (o.length > 0) {
    ...
    var F;
    n.hasCompoundNodes ? F = a.collection().merge(V).merge(V.connectedNodes()).merge(V.parent()) : F = V, F.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(r), r ? V.emitAndNotify("add") : e && V.emit("add");
  }
  return t;
};
He.removed = function() {
...
function yp(r, e, t, a) {
  ...
  function E(D) {
    for (var B = 0, P = 1, A = l - 1; P !== A && c[P] <= D; ++P)
      B += u;
    --P;
    var R = (D - c[P]) / (c[P + 1] - c[P]), L = B + R * u, I = p(L, r, t);
...
function bp(r, e, t, a) {
  ...
  if (!s.easingImpl)
    if (o == null)
      ...
      if (ge(o)) {
        ...
        f = o;
      var h, d;
      ge(f) ? (h = f, d = []) : (h = f[1], d = f.slice(2).map(function(V) {
        return +V;
  ...
  if (s.duration === 0 ? g = 1 : g = (t - l) / s.duration, s.applying && (g = s.progress), g < 0 ? g = 0 : g > 1 && (g = 1), s.delay == null) {
    ...
    D && (da(T, k) && (i.zoom = ka(i.minZoom, zt(T, k, g, y), i.maxZoom)), r.emit("zoom")), (x || D) && r.emit("viewport");
    var B = s.style;
    if (B && B.length > 0 && n) {
      for (var P = 0; P < B.length; P++) {
        var A = B[P], R = A.name, L = A, I = s.startStyle[R], M = v.properties[I.name], O = zt(I, L, g, y, M);
...
function Cl(r, e) {
  ...
  function n(v, f) {
    ...
    for (var p = function(C) {
      ...
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = !1), w.started || wp(v, b, r), bp(v, b, r, f), w.applying && (w.applying = !1), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = !1, w.playing = !1, w.started = !1, p(w.completes)), y = !0);
    }
...
var hn = {
  ...
  collection: function(e, t) {
    return ge(e) ? this.$(e) : Dr(e) ? e.collection() : _e(e) ? (t || (t = {}), new fr(this, e, t.unique, t.removed)) : new fr(this);
  },
  nodes: function(e) {
...
ur.updateStyleHints = function(r) {
  var e = r._private, t = this, a = t.propertyGroupNames, n = t.propertyGroupKeys, i = function(H, Y, te) {
  ...
  if (o) {
    var F = e.styleKeys, U = F.nodeBody, Q = F.nodeBorder, K = F.nodeOutline, j = F.backgroundImage, re = F.compound, ne = F.pie, J = F.stripe, z = [U, Q, K, j, re, ne, J].filter(function(q) {
      return q != null;
    }).reduce(Xa, [Tt, Ht]);
    e.nodeKey = et(z), e.hasPie = ne != null && ne[0] !== Tt && ne[1] !== Ht, e.hasStripe = J != null && J[0] !== Tt && J[1] !== Ht;
  }
  return s !== e.styleKey;
};
...
ur.applyParsedProperty = function(r, e) {
  ...
  switch (a.mapped) {
    ...
    case s.fn: {
      var G = a.value, N = a.fnValue != null ? a.fnValue : G(r);
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = !1, u = 0; u < n.length; u++) {
      ...
      if (c) {
        ...
        d && (ae(d.pfValue) && ae(y.pfValue) ? (g = y.pfValue - d.pfValue, p = d.pfValue + m * g) : ae(d.value) && ae(y.value) ? (g = y.value - d.value, p = d.value + m * g) : _e(d.value) && _e(y.value) && (g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2], p = d.strValue), g && (o[v] = y.strValue, this.applyBypass(r, v, p), l = !0));
      }
    }
    if (!l)
      return;
    ...
    if (s) {
      ...
      if (t && i.number && o != null && ae(o)) {
        var v = r.cy().zoom(), f = function(g) {
          ...
          return f(g) + p;
        }, h = _e(o), d = h ? l.every(function(y) {
          return y != null;
        }) : l != null;
        return d ? h ? o.map(function(y, g) {
          return c(y, l[g]);
        }).join(" ") : c(o, l) : h ? o.map(function(y) {
          return ge(y) ? y : "" + f(y);
        }).join(" ") : "" + f(o);
      } else if (u != null)
        return u;
...
var Qe = {};
(function() {
  var r = tr, e = bc, t = xc, a = Ec, n = Cc, i = function(q) {
    return "^" + q + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, s = function(q) {
    var H = r + "|\\w+|" + e + "|" + t + "|" + a + "|" + n;
    return "^" + q + "\\s*\\(([\\w\\.]+)\\s*\\,\\s*(" + r + ")\\s*\\,\\s*(" + r + ")\\s*,\\s*(" + H + ")\\s*\\,\\s*(" + H + ")\\)$";
  }, o = [`^url\\s*\\(\\s*['"]?(.+?)['"]?\\s*\\)$`, "^(none)$", "^(.+)$"];
  Qe.types = {
    time: {
      number: !0,
  ...
  var l = {
    ...
    triggersBoundsOfParallelEdges: function(q, H) {
      return q === H ? !1 : q === "bezier" || // remove from bundle
      H === "bezier";
    }
  }, {
  ...
  var L = [];
  Qe.stripeBackgroundN = 16, L.push({
    name: "stripe-size",
    type: u.sizeMaybePercent
  }), L.push({
  ...
  var M = [], O = Qe.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
  [{
    name: "arrow-shape",
    type: u.arrowShape,
    triggersBounds: l.any
    ...
    O.forEach(function(q) {
      var H = q + "-" + z.name, Y = z.type, te = z.triggersBounds;
      M.push({
        name: H,
        type: Y,
        triggersBounds: te
  ...
  var V = Qe.properties = [].concat(y, b, g, p, m, B, d, h, v, f, c, E, C, x, T, A, L, k, D, M, P), G = Qe.propertyGroups = {
    // common to all eles
    behavior: y,
    transition: b,
    visibility: g,
    ...
    edgeArrow: M,
    core: P
  }, N = Qe.propertyGroupNames = {}, F = Qe.propertyGroupKeys = Object.keys(G);
...
Un.parse = function(r, e, t, a) {
  ...
  var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, l = cv(r, o, s, i), u = n.propCache = n.propCache || [], v;
...
Un.parseImpl = function(r, e, t, a) {
  ...
  if (u.multiple && a !== "multiple") {
    var b;
    if (l ? b = e.split(/\s+/) : _e(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", T = !1, k = 0; k < b.length; k++) {
      var D = n.parse(r, b[k], t, "multiple");
      T = T || ge(D.value), w.push(D.value), C.push(D.pfValue != null ? D.pfValue : D.value), E.push(D.units), x += (k > 0 ? " " : "") + D.strValue;
    }
    return u.validate && !u.validate(w, E) ? null : u.singleEnum && T ? w.length === 1 && ge(w[0]) ? {
      name: r,
      value: w[0],
      strValue: w[0],
      bypass: t
  ...
  if (u.number) {
    ...
    return u.unitless || P !== "px" && P !== "em" ? I.pfValue = e : I.pfValue = P === "px" || !P ? e : this.getEmSizeInPixels() * e, (P === "ms" || P === "s") && (I.pfValue = P === "ms" ? e : 1e3 * e), (P === "deg" || P === "rad") && (I.pfValue = P === "rad" ? e : Ed(e)), P === "%" && (I.pfValue = e / 100), I;
  } else if (u.propList) {
    var M = [], O = "" + e;
    if (O !== "none") {
    ...
    for (var Q = u.regexes ? u.regexes : [u.regex], K = 0; K < Q.length; K++) {
      var j = new RegExp(Q[K]), re = j.exec(e);
      if (re)
        return {
          name: r,
...
pr.selector = function(r) {
  var e = r === "core" ? null : new ft(r), t = this.length++;
  return this[t] = {
    selector: e,
    properties: [],
    mappedProperties: [],
...
var kp = {
  ...
  setStyle: function(e) {
    var t = this._private;
    return tv(e) ? t.style = e.generateStyle(this) : _e(e) ? t.style = or.fromJson(this, e) : ge(e) ? t.style = or.fromString(this, e) : t.style = or(this), t.style;
  },
  ...
  panBy: function(e, t) {
    ...
    switch (a.length) {
      case 1:
        Le(e) && (o = a[0], l = o.x, u = o.y, ae(l) && (n.x += l), ae(u) && (n.y += u), this.emit("pan viewport"));
        break;
      case 2:
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = !0), ae(e) ? s = e : Le(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = !0)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var l = a, u = n, v = s, f = {
        x: -v / u * (i.x - l.x) + i.x,
  ...
  viewport: function(e) {
    ...
    if (!e)
      return this;
    if (ae(e.zoom) || (a = !1), Le(e.pan) || (n = !1), !a && !n)
      return this;
    if (a) {
      var l = e.zoom;
...
var Ra = function(e) {
  ...
  a && (a._cyreg = n), n.cy = t;
  var s = rr !== void 0 && a !== void 0 && !e.headless, o = e;
  o.layout = be({
    name: s ? "grid" : "null"
  ...
  var l = function(d, y, g) {
    ...
    pan: {
      x: Le(o.pan) && ae(o.pan.x) ? o.pan.x : 0,
      y: Le(o.pan) && ae(o.pan.y) ? o.pan.y : 0
    },
    animation: {
      // object for currently-running animations
      current: [],
  ...
  var c = function(d, y, g) {
    ...
    p.length > 0 && p.remove(), d != null && (Le(d) || _e(d)) && t.add(d), t.one("layoutready", function(b) {
  ...
  v([o.style, o.elements], function(h) {
    var d = h[0], y = h[1];
    u.styleEnabled && t.style().append(d), c(y, function() {
...
be(kn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = !0, t.invalidateSize(), t.initRenderer(be({}, n, n.renderer, {
...
af.prototype.run = function() {
  ...
  }), n = t, i = r.directed, s = r.acyclic || r.maximal || r.maximalAdjustments > 0, o = !!r.boundingBox, l = wr(o ? r.boundingBox : structuredClone(e.extent())), u;
  if (Dr(r.roots))
    u = r.roots;
  else if (_e(r.roots)) {
  ...
  var p = [], m = {}, b = function(ie, de) {
    ...
    var he = Ft(ie), Ee = he.depth, pe = he.index;
  ...
  var T = function(ie) {
    ...
    for (var he = Ft(ie), Ee = ie.incomers().filter(function(xe) {
      return xe.isNode() && t.has(xe);
    }), pe = -1, Se = ie.id(), Re = 0; Re < Ee.length; Re++) {
      var Oe = Ee[Re], Ne = Ft(Oe);
  ...
  if (i && s) {
    ...
    for (a.forEach(function(ye) {
      ...
      var R = A(), L = k(R, B);
      if (L)
        R.outgoers().filter(function(ye) {
          return ye.isNode() && t.has(ye);
        }).forEach(P);
      else if (L === null) {
        Ve("Detected double maximal shift for node `" + R.id() + "`.  Bailing maximal adjustment due to cycle.  Use `options.maximal: true` only on DAGs.");
        break;
      }
    }
  }
  ...
  if (r.avoidOverlap)
    for (var M = 0; M < a.length; M++) {
      var O = a[M], V = O.layoutDimensions(r), G = V.w, N = V.h;
      I = Math.max(I, G, N);
    }
  var F = {}, U = function(ie) {
    if (F[ie.id()])
  ...
  for (var z = 0, q = 0; q < K; q++)
    z = Math.max(p[q].length, z);
  var H = {
    x: l.x1 + l.w / 2,
    y: l.y1 + l.h / 2
  }, Y = a.reduce(function(ye, ie) {
    return function(de) {
      return {
    ...
    K === 1 ? 0 : (
      ...
      o ? (l.h - r.padding * 2 - Y.h) / (K - 1) : (l.h - r.padding * 2 - Y.h) / (K + 1)
    ),
    I
  ), ce = p.reduce(function(ye, ie) {
    return Math.max(ye, ie.length);
  }, 0), Ae = function(ie) {
    var de = Ft(ie), he = de.depth, Ee = de.index;
    if (r.circle) {
      var pe = Math.min(l.w / 2 / K, l.h / 2 / K);
      pe = Math.max(pe, I);
      var Se = pe * he + pe - (K > 0 && p[0].length <= 3 ? pe / 2 : 0), Re = 2 * Math.PI / p[he].length * Ee;
      return he === 0 && p[0].length === 1 && (Se = 1), {
        x: H.x + Se * Math.cos(Re),
        y: H.y + Se * Math.sin(Re)
      };
    } else {
      var Oe = p[he].length, Ne = Math.max(
        ...
        Oe === 1 ? 0 : (
          ...
          o ? (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) - 1) : (l.w - r.padding * 2 - Y.w) / ((r.grid ? ce : Oe) + 1)
        ),
        I
      ), ze = {
        x: H.x + (Ee + 1 - (Oe + 1) / 2) * Ne,
        y: H.y + (he + 1 - (K + 1) / 2) * te
      };
      return ze;
    }
  ...
  Object.keys(Ce).indexOf(r.direction) === -1 && $e("Invalid direction '".concat(r.direction, "' specified for breadthfirst layout. Valid values are: ").concat(Object.keys(Ce).join(", ")));
  var we = function(ie) {
...
nf.prototype.run = function() {
  ...
  if (ae(e.radius) ? v = e.radius : i.length <= 1 ? v = 0 : v = Math.min(s.h, s.w) / 2 - f, i.length > 1 && e.avoidOverlap) {
    f *= 1.75;
    var p = Math.cos(u) - Math.cos(0), m = Math.sin(u) - Math.sin(0), b = Math.sqrt(f * f / (p * p + m * m));
    v = Math.max(b, v);
  }
  var w = function(C, x) {
    var T = e.startAngle + x * u * (n ? 1 : -1), k = v * Math.cos(T), D = v * Math.sin(T), B = {
      x: o.x + k,
      y: o.y + D
    };
    return B;
...
sf.prototype.run = function() {
  ...
  for (var K = {}, j = 0; j < p.length; j++)
    for (var re = p[j], ne = re.dTheta, J = re.r, z = 0; z < re.length; z++) {
      var q = re[z], H = e.startAngle + (t ? 1 : -1) * ne * z, Y = {
        x: o.x + J * Math.cos(H),
        y: o.y + J * Math.sin(H)
      };
      K[q.node.id()] = Y;
...
Kn.prototype.run = function() {
  ...
  var n = Yr(), i = function() {
    ...
    return !(t.stopped || c >= r.numIter || (Fp(a, r), a.temperature = a.temperature * r.coolingFactor, a.temperature < r.minTemp));
  }, o = function() {
...
var Lp = function(e, t, a) {
  ...
  for (var v = 0; v < o.nodeSize; v++) {
    ...
    g.isLocked = d.locked(), g.id = d.data("id"), g.parentId = d.data("parent"), g.cmptId = u[d.id()], g.children = [], g.positionX = d.position("x"), g.positionY = d.position("y"), g.offsetX = 0, g.offsetY = 0, g.height = y.w, g.width = y.h, g.maxX = g.positionX + g.width / 2, g.minX = g.positionX - g.width / 2, g.maxY = g.positionY + g.height / 2, g.minY = g.positionY - g.height / 2, g.padLeft = parseFloat(d.style("padding")), g.padRight = parseFloat(d.style("padding")), g.padTop = parseFloat(d.style("padding")), g.padBottom = parseFloat(d.style("padding")), g.nodeRepulsion = Ue(a.nodeRepulsion) ? a.nodeRepulsion(d) : a.nodeRepulsion, o.layoutNodes.push(g), o.idToIndex[g.id] = v;
  }
  ...
  for (var v = 0; v < o.edgeSize; v++) {
    ...
    var A = Ue(a.idealEdgeLength) ? a.idealEdgeLength(B) : a.idealEdgeLength, R = Ue(a.edgeElasticity) ? a.edgeElasticity(B) : a.edgeElasticity, L = o.idToIndex[P.sourceId], I = o.idToIndex[P.targetId], M = o.indexToGraph[L], O = o.indexToGraph[I];
    if (M != O) {
      for (var V = Ip(P.sourceId, P.targetId, o), G = o.graphSet[V], N = 0, g = o.layoutNodes[L]; G.indexOf(g.id) === -1; )
  ...
  for (var s = 0, o = 0; o < i.length; o++) {
    ...
    if (v.length !== 0) {
      var f = n.indexToGraph[n.idToIndex[v[0]]], c = of(e, t, f, n);
      if (c.count !== 0)
        if (c.count === 1) {
          if (s++, s === 2)
            break;
  ...
  return t.boundingBox && (a.forEach(function(s) {
    ...
    if (t.boundingBox) {
      var u = i.w === 0 ? 0.5 : (l.positionX - i.x1) / i.w, v = i.h === 0 ? 0.5 : (l.positionY - i.y1) / i.h;
      return {
        x: n.x1 + u * n.w,
        y: n.y1 + v * n.h
      };
  ...
  var n = a.layout, i = a.eles.nodes(), s = uf(e, a, i);
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    if (v > 0)
      ...
      var y = Dn(e, o, l), g = Dn(t, -1 * o, -1 * l), p = g.x - y.x, m = g.y - y.y, b = p * p + m * m, c = Math.sqrt(b), f = (e.nodeRepulsion + t.nodeRepulsion) / b, h = f * p / c, d = f * m / c;
  ...
  for (var a = 0; a < e.edgeSize; a++) {
    ...
    if (!(u === 0 && v === 0)) {
      var f = Dn(s, u, v), c = Dn(l, -1 * u, -1 * v), h = c.x - f.x, d = c.y - f.y, y = Math.sqrt(h * h + d * d), g = Math.pow(n.idealLength - y, 2) / n.elasticity;
      if (y !== 0)
        var p = g * h / y, m = g * d / y;
      else
        var p = 0, m = 0;
  ...
  if (t.gravity !== 0)
    for (var a = 1, n = 0; n < e.graphSet.length; n++) {
      ...
      for (var f = 0; f < s; f++) {
        ...
        if (!c.isLocked) {
          var h = o - c.positionX, d = l - c.positionY, y = Math.sqrt(h * h + d * d);
          if (y > a) {
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      ...
      n.positionX += i.x, n.positionY += i.y, n.offsetX = 0, n.offsetY = 0, n.minX = n.positionX - n.width, n.maxX = n.positionX + n.width, n.minY = n.positionY - n.height, n.maxY = n.positionY + n.height, lf(n, e);
    }
  }
  for (var a = 0; a < e.nodeSize; a++) {
    var n = e.layoutNodes[a];
  ...
  for (var h = 0, d = 0, y = 0, g = 0, p = Math.sqrt(u) * e.clientWidth / e.clientHeight, i = 0; i < n.length; i++) {
    var v = n[i];
    if (v) {
      for (var f = 0; f < v.length; f++) {
        var c = v[f];
...
vf.prototype.run = function() {
  ...
  if (i.h === 0 || i.w === 0)
    ...
    var s = n.size(), o = Math.sqrt(s * i.h / i.w), l = Math.round(o), u = Math.round(i.w / i.h * o), v = function(Q) {
      if (Q == null)
        return Math.min(l, u);
      var K = Math.min(l, u);
      K == l ? l = Q : u = Q;
...
ff.prototype.run = function() {
  var r = this.options, e = r.eles, t = e.nodes(), a = Ue(r.positions);
  function n(i) {
    if (r.positions == null)
...
go.registerArrowShapes = function() {
  var r = this.arrowShapes = {}, e = this, t = function(u, v, f, c, h, d, y) {
    var g = h.x - f / 2 - y, p = h.x + f / 2 + y, m = h.y - f / 2 - y, b = h.y + f / 2 + y, w = g <= u && u <= p && m <= v && v <= b;
    return w;
  }, a = function(u, v, f, c, h) {
    var d = u * Math.cos(c) - v * Math.sin(c), y = u * Math.sin(c) + v * Math.cos(c), g = d * f, p = y * f, m = g + h.x, b = p + h.y;
    return {
      x: m,
      y: b
    };
    ...
    ge(v) && (v = r[v]), r[u] = be({
      ...
      collide: function(c, h, d, y, g, p) {
        var m = i(n(this.points, d + 2 * p, y, g)), b = Sr(c, h, m);
        return b;
      },
      roughCollide: t,
  ...
  o("none", {
    ...
    collide: function(u, v, f, c, h, d, y) {
      var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.pointsTee, f + 2 * y, c, h)), m = Sr(u, v, g) || Sr(u, v, p);
      return m;
    },
    draw: function(u, v, f, c, h) {
    ...
    collide: function(u, v, f, c, h, d, y) {
      var g = h, p = Math.pow(g.x - u, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2), m = i(n(this.points, f + 2 * y, c, h));
      return Sr(u, v, m) || p;
    },
    draw: function(u, v, f, c, h) {
    ...
    collide: function(u, v, f, c, h, d, y) {
      var g = i(n(this.points, f + 2 * y, c, h)), p = i(n(this.crossLinePts(f, d), f + 2 * y, c, h)), m = Sr(u, v, g) || Sr(u, v, p);
      return m;
    },
    draw: function(u, v, f, c, h) {
    ...
    radius: 0.15,
    collide: function(u, v, f, c, h, d, y) {
      var g = h, p = Math.pow(g.x - u, 2) + Math.pow(g.y - v, 2) <= Math.pow((f + 2 * y) * this.radius, 2);
      return p;
    },
    draw: function(u, v, f, c, h) {
...
Mt.findContainerClientCoords = function() {
  ...
  }, s = r.clientWidth, o = r.clientHeight, l = n.left + n.right, u = n.top + n.bottom, v = i.left + i.right, f = e.width / (s + v), c = s - l, h = o - u, d = e.left + n.left + i.left, y = e.top + n.top + i.top;
...
Mt.findNearestElements = function(r, e, t, a) {
  var n = this, i = this, s = i.getCachedZSortedEles(), o = [], l = i.cy.zoom(), u = i.cy.hasCompoundNodes(), v = (a ? 24 : 8) / l, f = (a ? 8 : 2) / l, c = (a ? 8 : 2) / l, h = 1 / 0, d, y;
  t && (s = s.interactive);
  function g(x, T) {
    if (x.isNode()) {
      if (y)
  ...
  function m(x) {
    var T = x._private, k = T.rscratch, D = x.pstyle("width").pfValue, B = x.pstyle("arrow-scale").value, P = D / 2 + v, A = P * P, R = P * 2, O = T.source, V = T.target, L;
    ...
    for (var O = O || T.source, V = V || T.target, G = n.getArrowWidth(D, B), N = [{
      name: "source",
      x: k.arrowStartX,
      y: k.arrowStartY,
      ...
      var F = N[M], U = i.arrowShapes[x.pstyle(F.name + "-arrow-shape").value], Q = x.pstyle("width").pfValue;
      if (U.roughCollide(r, e, G, F.angle, {
        x: F.x,
        y: F.y
      }, Q, v) && U.collide(r, e, G, F.angle, {
        x: F.x,
        y: F.y
      }, Q, v))
        return g(x), !0;
  ...
  function w(x, T) {
    ...
    if (!(!R || !A)) {
      var L = b(k.rscratch, "labelX", T), I = b(k.rscratch, "labelY", T), M = b(k.rscratch, "labelAngle", T), O = x.pstyle(B + "text-margin-x").pfValue, V = x.pstyle(B + "text-margin-y").pfValue, G = P.x1 - D - O, N = P.x2 + D - O, F = P.y1 - D - V, U = P.y2 + D - V;
      if (M) {
        var Q = Math.cos(M), K = Math.sin(M), j = function(Y, te) {
          return Y = Y - L, te = te - I, {
            x: Y * Q - te * K + L,
            y: Y * K + te * Q + I
          };
        }, re = j(G, F), ne = j(G, U), J = j(N, F), z = j(N, U), q = [
...
Mt.getAllInBox = function(r, e, t, a) {
  ...
  function g(Y, te) {
    var ce = Y._private, Ae = s, Ce = "";
    Y.boundingBox();
    var we = ce.labelBounds.main;
    if (!we)
      return null;
    var ye = y(ce.rscratch, "labelX", te), ie = y(ce.rscratch, "labelY", te), de = y(ce.rscratch, "labelAngle", te), he = Y.pstyle(Ce + "text-margin-x").pfValue, Ee = Y.pstyle(Ce + "text-margin-y").pfValue, pe = we.x1 - Ae - he, Se = we.x2 + Ae - he, Re = we.y1 - Ae - Ee, Oe = we.y2 + Ae - Ee;
    if (de) {
      var Ne = Math.cos(de), ze = Math.sin(de), xe = function(X, S) {
        return X = X - ye, S = S - ie, {
          x: X * Ne - S * ze + ye,
          y: X * ze + S * Ne + ie
        };
      };
  ...
  for (var m = 0; m < n.length; m++) {
    ...
    if (b.isNode()) {
      ...
      if (O === "none")
        continue;
      if (O === "contain") {
        if (M.startX != null && M.startY != null && !nt(c, M.startX, M.startY) || M.endX != null && M.endY != null && !nt(c, M.endX, M.endY))
          continue;
        ...
        var F = !1;
        if (M.startX != null && M.startY != null && M.endX != null && M.endY != null && (nt(c, M.startX, M.startY) || nt(c, M.endX, M.endY)))
          o.push(L), F = !0;
        ...
        if (!F) {
          ...
          if ((!K || K.length < 2) && M.edgeType === "straight" && M.startX != null && M.startY != null && M.endX != null && M.endY != null && (K = [{
            x: M.startX,
            y: M.startY
          }, {
            x: M.endX,
...
Bn.calculateArrowAngles = function(r) {
  var e = r._private.rscratch, t = e.edgeType === "haystack", a = e.edgeType === "bezier", n = e.edgeType === "multibezier", i = e.edgeType === "segments", s = e.edgeType === "compound", o = e.edgeType === "self", l, u, v, f, c, h, p, m;
  if (t ? (v = e.haystackPts[0], f = e.haystackPts[1], c = e.haystackPts[2], h = e.haystackPts[3]) : (v = e.arrowStartX, f = e.arrowStartY, c = e.arrowEndX, h = e.arrowEndY), p = e.midX, m = e.midY, i)
    ...
    var d = e.allpts, y = sr(d[0], d[2], d[4], 0.1), g = sr(d[1], d[3], d[5], 0.1);
    l = v - y, u = f - g;
  } else
    l = v - p, u = f - m;
  ...
  if (t && (p = (v + c) / 2, m = (f + h) / 2), l = c - v, u = h - f, i) {
    ...
    if (E.length / 2 % 2 === 0) {
      ...
      C = sr(d[D], d[B], d[P], 0), x = sr(d[D + 1], d[B + 1], d[P + 1], 0), T = sr(d[D], d[B], d[P], 1e-4), k = sr(d[D + 1], d[B + 1], d[P + 1], 1e-4);
    } else {
      var B = d.length / 2 - 1, D = B - 2, P = B + 2;
      C = sr(d[D], d[B], d[P], 0.4999), x = sr(d[D + 1], d[B + 1], d[P + 1], 0.4999), T = sr(d[D], d[B], d[P], 0.5), k = sr(d[D + 1], d[B + 1], d[P + 1], 0.5);
    }
    l = T - C, u = k - x;
  }
  ...
  if (e.midsrcArrowAngle = Ya(l, u), i)
    ...
    var d = e.allpts, R = d.length, y = sr(d[R - 6], d[R - 4], d[R - 2], 0.9), g = sr(d[R - 5], d[R - 3], d[R - 1], 0.9);
    l = c - y, u = h - g;
  } else
    l = c - p, u = h - m;
...
var Vs, qs, Vr = {}, Pr = {}, Pl, Al, St, gn, Ur, wt, Ct, zr, Vt, an, hf, gf, _s, Gs, Rl, Ml = function(e, t, a) {
...
var Ma = 0.01, ey = Math.sqrt(2 * Ma), yr = {};
yr.findMidptPtsEtc = function(r, e) {
  ...
  switch (v) {
    ...
    case "endpoints": {
      if (l) {
        var f = this.manualEndptToPx(r.source()[0], s), c = Je(f, 2), h = c[0], d = c[1], y = this.manualEndptToPx(r.target()[0], o), g = Je(y, 2), p = g[0], m = g[1], b = {
          x1: h,
          y1: d,
          x2: p,
          y2: m
...
yr.findHaystackPoints = function(r) {
  for (var e = 0; e < r.length; e++) {
    ...
    var s = a.source, o = a.target, l = s.position(), u = o.position(), v = s.width(), f = o.width(), c = s.height(), h = o.height(), d = t.pstyle("haystack-radius").value, y = d / 2;
    n.haystackPts = n.allpts = [n.source.x * v * y + l.x, n.source.y * c * y + l.y, n.target.x * f * y + u.x, n.target.y * h * y + u.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = !0, this.storeEdgeProjections(t), this.calculateArrowAngles(t), this.recalculateEdgeLabelProjections(t), this.calculateLabelAngles(t);
  }
};
yr.findSegmentsPoints = function(r, e) {
  ...
  for (var v = 0; v < o; v++) {
    ...
    t.segpts.push(m.x + p.x * c, m.y + p.y * c), t.radii.push(i.pfValue[v] !== void 0 ? i.pfValue[v] : l), t.isArcRadius.push((s.pfValue[v] !== void 0 ? s.pfValue[v] : u) === "arc-radius");
  }
};
yr.findLoopPoints = function(r, e, t, a) {
  ...
  var c = t, h = f;
  a && (c = 0, h = l);
  var d = u - Math.PI / 2, y = d - v / 2, g = d + v / 2, p = u + "_" + v;
...
yr.findCompoundLoopPoints = function(r, e, t, a) {
  ...
  n.edgeType = "compound";
  var i = e.srcPos, s = e.tgtPos, o = e.srcW, l = e.srcH, u = e.tgtW, v = e.tgtH, f = r.pstyle("control-point-step-size").pfValue, c = r.pstyle("control-point-distances"), h = c ? c.pfValue[0] : void 0, d = t, y = f;
  a && (d = 0, y = h);
  var g = 50, p = {
    x: i.x - o / 2,
    y: i.y - l / 2
...
yr.findBezierPoints = function(r, e, t, a, n) {
  ...
  for (var h = 0; h < u; h++) {
    var d = (0.5 - e.eles.length / 2 + t) * s * (n ? -1 : 1), y = void 0, g = to(d);
...
yr.findTaxiPoints = function(r, e) {
  ...
  }, K = Q(N), j = Q(Math.abs(M) - Math.abs(N)), re = K || j;
  if (re && !G)
    if (I) {
      var ne = Math.abs(O) <= c / 2, J = Math.abs(D) <= h / 2;
      if (ne) {
        var z = (v.x1 + v.x2) / 2, q = v.y1, H = v.y2;
        t.segpts = [z, q, z, H];
      } else if (J) {
      ...
      var Ae = Math.abs(O) <= f / 2, Ce = Math.abs(B) <= d / 2;
      if (Ae) {
        var we = (v.y1 + v.y2) / 2, ye = v.x1, ie = v.x2;
        t.segpts = [ye, we, ie, we];
      } else if (Ce) {
        var de = (v.x1 + v.x2) / 2, he = v.y1, Ee = v.y2;
        t.segpts = [de, he, de, Ee];
      } else
        t.segpts = [v.x2, v.y1];
    }
  else if (I) {
    var pe = v.y1 + N + (g ? c / 2 * V : 0), Se = v.x1, Re = v.x2;
    t.segpts = [Se, pe, Re, pe];
  } else {
    var Oe = v.x1 + N + (g ? f / 2 * V : 0), Ne = v.y1, ze = v.y2;
    t.segpts = [Oe, Ne, Oe, ze];
  }
  if (t.isRound) {
    var xe = r.pstyle("taxi-radius").value, ue = r.pstyle("radius-type").value[0] === "arc-radius";
  ...
  if (t.edgeType === "bezier") {
    ...
    if (p || m || k) {
      ...
      var M = {
        ...
        x: t.ctrlpts[0] - n.x,
        y: t.ctrlpts[1] - n.y
      }, O = Math.sqrt(M.x * M.x + M.y * M.y), V = {
        // normalised delta
        x: M.x / O,
        y: M.y / O
      }, G = Math.max(i, s), N = {
        // *2 radius guarantees outside shape
        x: t.ctrlpts[0] + V.x * 2 * G,
        y: t.ctrlpts[1] + V.y * 2 * G
      }, F = v.intersectLine(n.x, n.y, o, l, N.x, N.y, 0, c, d);
      k ? (t.ctrlpts[0] = t.ctrlpts[0] + V.x * (E - T), t.ctrlpts[1] = t.ctrlpts[1] + V.y * (E - T)) : (t.ctrlpts[0] = F[0] + V.x * E, t.ctrlpts[1] = F[1] + V.y * E);
    }
...
yr.checkForInvalidEdgeWarning = function(r) {
  ...
  e.nodesOverlap || ae(e.startX) && ae(e.startY) && ae(e.endX) && ae(e.endY) ? e.loggedErr = !1 : e.loggedErr || (e.loggedErr = !0, Ve("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
yr.findEdgeControlPoints = function(r) {
  var e = this;
  if (!(!r || r.length === 0)) {
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Xr(), s = function(k, D) {
      ...
      if (!(v.removed() || !v.takesUpSpace())) {
        ...
        var h = c === "unbundled-bezier" || at(c, "segments") || c === "straight" || c === "straight-triangle" || at(c, "taxi"), d = c === "unbundled-bezier" || c === "bezier", y = f.source, g = f.target, p = y.poolIndex(), m = g.poolIndex(), b = [p, m].sort(), w = s(b, h), E = i.get(w);
        E == null && (E = {
          eles: []
        }, o.push({
          pairId: b,
    ...
    for (var C = function() {
      ...
      if (!A.hasUnbundled) {
        ...
        eo(A.eles), L.forEach(function(ue) {
      ...
      for (var H = 0; H < A.eles.length; H++) {
        var Y = A.eles[H], te = Y[0]._private.rscratch, ce = Y.pstyle("curve-style").value, Ae = ce === "unbundled-bezier" || at(ce, "segments") || at(ce, "taxi"), Ce = !M.same(Y.source());
        if (!A.calculatedIntersection && M !== O && (A.hasBezier || A.hasUnbundled)) {
          A.calculatedIntersection = !0;
          var we = j.intersectLine(G.x, G.y, F, U, N.x, N.y, 0, ne, q), ye = A.srcIntn = we, ie = re.intersectLine(N.x, N.y, Q, K, G.x, G.y, 0, J, z), de = A.tgtIntn = ie, he = A.intersectionPts = {
            x1: we[0],
            x2: ie[0],
            y1: we[1],
            y2: ie[1]
            ...
            y1: G.y,
            y2: N.y
          }, pe = ie[1] - we[1], Se = ie[0] - we[0], Re = Math.sqrt(Se * Se + pe * pe);
          ...
          A.nodesOverlap = !ae(Re) || re.checkPoint(we[0], we[1], 0, Q, K, N.x, N.y, J, z) || j.checkPoint(ie[0], ie[1], 0, F, U, G.x, G.y, ne, q), A.vectorNormInverse = ze, R = {
...
Ga.findEndpoints = function(r) {
  var e, t, a, n, i = this, s, o = r.source()[0], l = r.target()[0], u = o.position(), v = l.position(), f = r.pstyle("target-arrow-shape").value, c = r.pstyle("source-arrow-shape").value, h = r.pstyle("target-distance-from-node").pfValue, d = r.pstyle("source-distance-from-node").pfValue, y = o._private.rscratch, g = l._private.rscratch, p = r.pstyle("curve-style").value, m = r._private.rscratch, b = m.edgeType, w = at(p, "taxi"), E = b === "self" || b === "compound", C = b === "bezier" || b === "multibezier" || E, x = b !== "bezier", T = b === "straight" || b === "segments", k = b === "segments", D = C || x || T, B = E || w, P = r.pstyle("source-endpoint"), A = B ? "outside-to-node" : P.value, R = o.pstyle("corner-radius").value === "auto" ? "auto" : o.pstyle("corner-radius").pfValue, L = r.pstyle("target-endpoint"), I = B ? "outside-to-node" : L.value, M = l.pstyle("corner-radius").value === "auto" ? "auto" : l.pstyle("corner-radius").pfValue;
  m.srcManEndpt = P, m.tgtManEndpt = L;
  var O, V, G, N, F = (e = (L == null || (t = L.pfValue) === null || t === void 0 ? void 0 : t.length) === 2 ? L.pfValue : null) !== null && e !== void 0 ? e : [0, 0], U = (a = (P == null || (n = P.pfValue) === null || n === void 0 ? void 0 : n.length) === 2 ? P.pfValue : null) !== null && a !== void 0 ? a : [0, 0];
  if (C) {
    var Q = [m.ctrlpts[0], m.ctrlpts[1]], K = x ? [m.ctrlpts[m.ctrlpts.length - 2], m.ctrlpts[m.ctrlpts.length - 1]] : Q;
    O = K, V = Q;
  } else if (T) {
    var j = k ? m.segpts.slice(0, 2) : [v.x + F[0], v.y + F[1]], re = k ? m.segpts.slice(m.segpts.length - 2) : [u.x + U[0], u.y + U[1]];
    O = re, V = j;
  }
  if (I === "inside-to-node")
    s = [v.x, v.y];
    ...
    s = m.tgtIntn;
  else if (I === "outside-to-node" || I === "outside-to-node-or-label" ? G = O : (I === "outside-to-line" || I === "outside-to-line-or-label") && (G = [u.x, u.y]), s = i.nodeShapes[this.getNodeShape(l)].intersectLine(v.x, v.y, l.outerWidth(), l.outerHeight(), G[0], G[1], 0, M, g), I === "outside-to-node-or-label" || I === "outside-to-line-or-label") {
    var ne = l._private.rscratch, J = ne.labelWidth, z = ne.labelHeight, q = ne.labelX, H = ne.labelY, Y = J / 2, te = z / 2, ce = l.pstyle("text-valign").value;
    ...
    if (Ce.length > 0) {
      var we = u, ye = Et(we, Wt(s)), ie = Et(we, Wt(Ce)), de = ye;
  ...
  var Ee = Za(s, O, i.arrowShapes[f].spacing(r) + h), pe = Za(s, O, i.arrowShapes[f].gap(r) + h);
  if (m.endX = pe[0], m.endY = pe[1], m.arrowEndX = Ee[0], m.arrowEndY = Ee[1], A === "inside-to-node")
    ...
    s = m.srcIntn;
  else if (A === "outside-to-node" || A === "outside-to-node-or-label" ? N = V : (A === "outside-to-line" || A === "outside-to-line-or-label") && (N = [v.x, v.y]), s = i.nodeShapes[this.getNodeShape(o)].intersectLine(u.x, u.y, o.outerWidth(), o.outerHeight(), N[0], N[1], 0, R, y), A === "outside-to-node-or-label" || A === "outside-to-line-or-label") {
    var Se = o._private.rscratch, Re = Se.labelWidth, Oe = Se.labelHeight, Ne = Se.labelX, ze = Se.labelY, xe = Re / 2, ue = Oe / 2, X = o.pstyle("text-valign").value;
    ...
    if (_.length > 0) {
      var W = v, $ = Et(W, Wt(s)), Z = Et(W, Wt(_)), oe = $;
  ...
  var ve = Za(s, V, i.arrowShapes[c].spacing(r) + d), le = Za(s, V, i.arrowShapes[c].gap(r) + d);
  m.startX = le[0], m.startY = le[1], m.arrowStartX = ve[0], m.arrowStartY = ve[1], D && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? m.badLine = !0 : m.badLine = !1);
};
...
var mf = function(e, t) {
  ...
  var i = ka(0, n - 1e-3, 1), s = ka(0, n + 1e-3, 1), o = Kt(e, t, a, i), l = Kt(e, t, a, s);
  return bf(o, l);
};
  ...
  if (i.mid || i.source || i.target) {
    ...
    var l = function() {
      ...
      function m(x, T, k, D, B) {
        var P = Bt(T, k), A = x.segments[x.segments.length - 1], R = {
          p0: T,
          p1: k,
          t0: D,
          t1: B,
      ...
      if (i[f]) {
        ...
        switch (a.edgeType) {
          ...
          case "segments":
          case "haystack": {
            for (var A = 0, R, L, I, M, O = a.allpts.length, V = 0; V + 3 < O && (h ? (I = {
              x: a.allpts[V],
              y: a.allpts[V + 1]
            }, M = {
              x: a.allpts[V + 2],
...
Gr.applyPrefixedLabelDimensions = function(r, e) {
  var t = r._private, a = this.getLabelText(r, e), n = Dt(a, r._private.labelDimsKey);
...
Gr.getLabelText = function(r, e) {
  var t = r._private, a = e ? e + "-" : "", n = r.pstyle(a + "label").strValue, i = r.pstyle("text-transform").value, s = function(U, Q) {
...
`), f = r.pstyle("text-max-width").pfValue, c = r.pstyle("text-overflow-wrap").value, h = c === "anywhere", d = [], y = /[\s\u200b]+|$/g, g = 0; g < v.length; g++) {
      ...
      if (b > f) {
        var E = p.matchAll(y), C = "", x = 0, T = kr(E), k;
        try {
          for (T.s(); !(k = T.n()).done; ) {
...
`)), s("labelWrapKey", l);
    ...
    var I = r.pstyle("text-max-width").pfValue, M = "", O = "…", V = !1;
...
wf.getNodeShape = function(r) {
  ...
  if (t === "cutrectangle" && (r.width() < Ll || r.height() < Ll))
    return Il || (Ve("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Il = !0), "rectangle";
  if (r.isParent())
...
Yn.getCachedZSortedEles = function(r) {
  if (r || !this.cachedZSortedEles) {
    ...
    e.sort(ef), e.interactive = e.filter(function(t) {
...
ia.binder = function(r) {
  var e = this, t = e.cy.window(), a = r === t || r === t.document || r === t.document.body || hc(r);
...
ia.load = function() {
  var r = this, e = r.cy.window(), t = function(S) {
    ...
    _.inDragLayer && (S.forEach(u), S.neighborhood().stdFilter(function($) {
      return !W || $.isEdge();
    }).forEach(u)), _.addToList && S.forEach(function($) {
      h($, _);
    }), d(S, _), m(S, {
      inDragLayer: _.inDragLayer
    }), r.updateCachedGrabbedEles();
  }, g = y, p = function(S) {
    S && (r.getCachedZSortedEles().forEach(function(_) {
      l(_), v(_), c(_);
    }), r.updateCachedGrabbedEles());
  }, m = function(S, _) {
    if (!(_.inDragLayer == null && _.addToList == null) && S.cy().hasCompoundNodes()) {
      ...
      if (!W.same(S)) {
        var $ = W.descendants().spawnSelf().merge(W).unmerge(S).unmerge(S.descendants()), Z = $.connectedEdges();
        _.inDragLayer && (Z.forEach(u), $.forEach(u)), _.addToList && $.forEach(function(oe) {
          h(oe, _);
        });
      }
    }
  ...
  w ? (r.removeObserver = new MutationObserver(function(X) {
    for (var S = 0; S < X.length; S++) {
      var _ = X[S], W = _.removedNodes;
      if (W)
        for (var $ = 0; $ < W.length; $++) {
          var Z = W[$];
          if (Z === r.container) {
  ...
  x(r.container, function(X) {
    r.registerBinding(X, "transitionend", T), r.registerBinding(X, "animationend", T), r.registerBinding(X, "scroll", T);
  ...
  var k = function() {
    ...
    for (var _ = r.findContainerClientCoords(), W = _[0], $ = _[1], Z = _[2], oe = _[3], ee = S.touches ? S.touches : [S], ve = !1, le = 0; le < ee.length; le++) {
      var me = ee[le];
  ...
  r.registerBinding(r.container, "mousedown", function(S) {
    if (D(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
      ...
      var _ = r.cy, W = [S.clientX, S.clientY], $ = r.projectIntoViewport(W[0], W[1]), Z = r.selection, oe = r.findNearestElements($[0], $[1], !0, !1), ee = oe[0], ve = r.dragData.possibleDragElements;
      ...
      if (S.which == 3) {
        ...
        ee ? (ee.activate(), ee.emit(De), r.hoverData.down = ee) : _.emit(De), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = !1;
      } else if (S.which == 1) {
        ee && ee.activate();
        {
          if (ee != null && r.nodeIsGrabbable(ee)) {
            ...
            if (f(ee), !ee.selected())
              ve = r.dragData.possibleDragElements = _.collection(), g(ee, {
                addToList: ve
              ...
              y(fe, {
                addToList: ve
              }), ee.emit(le("grabon")), fe.forEach(Te);
            }
            r.redrawHint("eles", !0), r.redrawHint("drag", !0);
          }
          r.hoverData.down = ee, r.hoverData.downs = oe, r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime();
        }
        n(ee, ["mousedown", "tapstart", "vmousedown"], S, {
          x: $[0],
          y: $[1]
        }), ee == null ? (Z[4] = 1, r.data.bgActivePosistion = {
          x: $[0],
          y: $[1]
        }, r.redrawHint("select", !0), r.redraw()) : ee.pannable() && (Z[4] = 1), me();
      }
      Z[0] = Z[2] = $[0], Z[1] = Z[3] = $[1];
    }
  }, !1);
  var B = a(r.container);
  r.registerBinding([e, B], "mousemove", function(S) {
    var _ = r.hoverData.capture;
    if (!(!_ && !D(S))) {
      var W = !1, $ = r.cy, Z = $.zoom(), oe = [S.clientX, S.clientY], ee = r.projectIntoViewport(oe[0], oe[1]), ve = r.hoverData.mdownPos, le = r.hoverData.mdownGPos, me = r.selection, De = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (De = r.findNearestElement(ee[0], ee[1], !0, !1));
      var Te = r.hoverData.last, fe = r.hoverData.down, Pe = [ee[0] - me[2], ee[1] - me[3]], Be = r.dragData.possibleDragElements, je;
      if (le) {
        var Ke = oe[0] - le[0], mr = Ke * Ke, Ye = oe[1] - le[1], ir = Ye * Ye, er = mr + ir;
      ...
      W = !0, n(De, ["mousemove", "vmousemove", "tapdrag"], S, {
        x: ee[0],
        y: ee[1]
      });
      var Ze = function(Br) {
        ...
        r.data.bgActivePosistion = void 0, r.hoverData.selecting || $.emit(Ze("boxstart")), me[4] = 1, r.hoverData.selecting = !0, r.redrawHint("select", !0), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (je) {
          var $r = Ze("cxtdrag");
          fe ? fe.emit($r) : $.emit($r), r.hoverData.cxtDragged = !0, (!r.hoverData.cxtOver || De !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(Ze("cxtdragout")), r.hoverData.cxtOver = De, De && De.emit(Ze("cxtdragover")));
        }
        ...
        if (je) {
          if (!r.hoverData.dragging && $.boxSelectionEnabled() && (lr || !$.panningEnabled() || !$.userPanningEnabled()))
            ...
            bt && (r.hoverData.dragging = !0, r.hoverData.justStartedPan = !0, me[4] = 0, r.data.bgActivePosistion = Wt(ve), r.redrawHint("select", !0), r.redraw());
          }
          fe && fe.pannable() && fe.active() && fe.unactivate();
        }
      } else {
        if (fe && fe.pannable() && fe.active() && fe.unactivate(), (!fe || !fe.grabbed()) && De != Te && (Te && n(Te, ["mouseout", "tapdragout"], S, {
          x: ee[0],
          y: ee[1]
          ...
          if (je) {
            if ($.boxSelectionEnabled() && lr)
              fe && fe.grabbed() && (p(Be), fe.emit(Ze("freeon")), Be.emit(Ze("free")), r.dragData.didDrag && (fe.emit(Ze("dragfreeon")), Be.emit(Ze("dragfree")))), Wr();
            else if (fe && fe.grabbed() && r.nodeIsDraggable(fe)) {
              var Er = !r.dragData.didDrag;
              Er && r.redrawHint("eles", !0), r.dragData.didDrag = !0, r.hoverData.draggingEles || y(Be, {
                inDragLayer: !0
              });
              var hr = {
                x: 0,
              ...
              r.hoverData.draggingEles = !0, Be.silentShift(hr).emit(Ze("position")).emit(Ze("drag")), r.redrawHint("drag", !0), r.redraw();
            }
          } else
            jr();
        W = !0;
  ...
  r.registerBinding(e, "mouseup", function(S) {
    if (!(r.hoverData.which === 1 && S.which !== 1 && r.hoverData.capture)) {
      ...
      if (_) {
        ...
        var W = r.cy, $ = r.projectIntoViewport(S.clientX, S.clientY), Z = r.selection, oe = r.findNearestElement($[0], $[1], !0, !1), ee = r.dragData.possibleDragElements, ve = r.hoverData.down, le = i(S);
        ...
        if (r.hoverData.which === 3) {
          ...
          if (n(oe, ["mouseup", "tapend", "vmouseup"], S, {
            x: $[0],
            y: $[1]
          ...
          !r.hoverData.isOverThresholdDrag && (n(ve, ["click", "tap", "vclick"], S, {
            x: $[0],
            y: $[1]
          }), A = !1, S.timeStamp - R <= W.multiClickDebounceTime() ? (P && clearTimeout(P), A = !0, R = null, n(ve, ["dblclick", "dbltap", "vdblclick"], S, {
            x: $[0],
            y: $[1]
          })) : (P = setTimeout(function() {
            A || n(ve, ["oneclick", "onetap", "voneclick"], S, {
              x: $[0],
              y: $[1]
            });
          }, W.multiClickDebounceTime()), R = S.timeStamp)), ve == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(S) && (W.$(t).unselect(["tapunselect"]), ee.length > 0 && r.redrawHint("eles", !0), r.dragData.possibleDragElements = ee = W.collection()), oe == ve && !r.dragData.didDrag && !r.hoverData.selecting && oe != null && oe._private.selectable && (r.hoverData.dragging || (W.selectionType() === "additive" || le ? oe.selected() ? oe.unselect(["tapunselect"]) : oe.select(["tapselect"]) : le || (W.$(t).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"]))), r.redrawHint("eles", !0)), r.hoverData.selecting) {
            ...
            W.selectionType() === "additive" || le || W.$(t).unmerge(fe).unselect(), fe.emit(me("box")).stdFilter(Pe).select().emit(me("boxselect")), r.redraw();
          }
          if (r.hoverData.dragging && (r.hoverData.dragging = !1, r.redrawHint("select", !0), r.redrawHint("eles", !0), r.redraw()), !Z[4]) {
            r.redrawHint("drag", !0), r.redrawHint("eles", !0);
            var Be = ve && ve.grabbed();
            p(ee), Be && (ve.emit(me("freeon")), ee.emit(me("free")), r.dragData.didDrag && (ve.emit(me("dragfreeon")), ee.emit(me("dragfree"))));
          }
        }
        Z[4] = 0, r.hoverData.down = null, r.hoverData.cxtStarted = !1, r.hoverData.draggingEles = !1, r.hoverData.selecting = !1, r.hoverData.isOverThresholdDrag = !1, r.dragData.didDrag = !1, r.hoverData.dragged = !1, r.hoverData.dragDelta = [], r.hoverData.mdownPos = null, r.hoverData.mdownGPos = null, r.hoverData.which = null;
      }
    }
  }, !1);
  var L = [], I = 4, M, O = 1e5, V = function(S, _) {
    for (var W = 0; W < S.length; W++)
      if (S[W] % _ !== 0)
        return !1;
    return !0;
  }, G = function(S) {
    for (var _ = Math.abs(S[0]), W = 1; W < S.length; W++)
      if (Math.abs(S[W]) !== _)
        return !1;
    return !0;
  }, N = function(S) {
    ...
    if (W == null && (S.wheelDeltaY != null ? W = S.wheelDeltaY / 4 : S.wheelDelta != null && (W = S.wheelDelta / 4)), W !== 0) {
      ...
      if (!r.scrollingPage) {
        var ee = r.cy, ve = ee.zoom(), le = ee.pan(), me = r.projectIntoViewport(S.clientX, S.clientY), De = [me[0] * ve + le.x, me[1] * ve + le.y];
        ...
        if (ee.panningEnabled() && ee.userPanningEnabled() && ee.zoomingEnabled() && ee.userZoomingEnabled()) {
          ...
          var Te;
          _ && Math.abs(W) > 5 && (W = to(W) * 5), Te = W / -250, M && (Te /= O, Te *= 3), Te = Te * r.wheelSensitivity;
          var fe = S.deltaMode === 1;
          fe && (Te *= 33);
          var Pe = ee.zoom() * Math.pow(10, Te);
          S.type === "gesturechange" && (Pe = r.gestureStartZoom * S.scale), ee.zoom({
            level: Pe,
            renderedPosition: {
              x: De[0],
              y: De[1]
  ...
  var F, U, Q, K, j, re, ne, J, z, q, H, Y, te, ce = function(S, _, W, $) {
  ...
  r.registerBinding(r.container, "touchstart", Ce = function(S) {
    if (r.hasTouchStarted = !0, !!D(S)) {
      ...
      var _ = r.cy, W = r.touchData.now, $ = r.touchData.earlier;
      if (S.touches[0]) {
      ...
      if (S.touches[1]) {
        ...
        z = ee[0], q = ee[1], H = ee[2], Y = ee[3], F = S.touches[0].clientX - z, U = S.touches[0].clientY - q, Q = S.touches[1].clientX - z, K = S.touches[1].clientY - q, te = 0 <= F && F <= H && 0 <= Q && Q <= H && 0 <= U && U <= Y && 0 <= K && K <= Y;
        var ve = _.pan(), le = _.zoom();
        j = ce(F, U, Q, K), re = Ae(F, U, Q, K), ne = [(F + Q) / 2, (U + K) / 2], J = [(ne[0] - ve.x) / le, (ne[1] - ve.y) / le];
        var me = 200, De = me * me;
        if (re < De && !S.touches[2]) {
          var Te = r.findNearestElement(W[0], W[1], !0, !0), fe = r.findNearestElement(W[2], W[3], !0, !0);
          Te && Te.isNode() ? (Te.activate().emit(oe("cxttapstart")), r.touchData.start = Te) : fe && fe.isNode() ? (fe.activate().emit(oe("cxttapstart")), r.touchData.start = fe) : _.emit(oe("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxt = !0, r.touchData.cxtDragged = !1, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (S.touches[2])
        _.boxSelectionEnabled() && S.preventDefault();
      else if (!S.touches[1]) {
        if (S.touches[0]) {
          ...
          if (Be != null && (Be.activate(), r.touchData.start = Be, r.touchData.starts = Pe, r.nodeIsGrabbable(Be))) {
            var je = r.dragData.touchDragEles = _.collection(), Ke = null;
            r.redrawHint("eles", !0), r.redrawHint("drag", !0), Be.selected() ? (Ke = _.$(function(er) {
              return er.selected() && r.nodeIsGrabbable(er);
            }), y(Ke, {
              addToList: je
            })) : g(Be, {
              addToList: je
            }), f(Be), Be.emit(oe("grabon")), Ke ? Ke.forEach(function(er) {
              er.emit(oe("grab"));
            }) : Be.emit(oe("grab"));
          }
  ...
  r.registerBinding(e, "touchmove", we = function(S) {
    ...
    if (!(!_ && !D(S))) {
      var W = r.selection, $ = r.cy, Z = r.touchData.now, oe = r.touchData.earlier, ee = $.zoom();
      if (S.touches[0]) {
      ...
      if (_ && S.touches[0] && me) {
        for (var Te = [], fe = 0; fe < Z.length; fe++)
          Te[fe] = Z[fe] - oe[fe];
        var Pe = S.touches[0].clientX - me[0], Be = Pe * Pe, je = S.touches[0].clientY - me[1], Ke = je * je, mr = Be + Ke;
        De = mr >= r.touchTapThreshold2;
      }
      if (_ && r.touchData.cxt) {
        S.preventDefault();
        var Ye = S.touches[0].clientX - z, ir = S.touches[0].clientY - q, er = S.touches[1].clientX - z, lr = S.touches[1].clientY - q, jr = Ae(Ye, ir, er, lr), Ze = jr / re, Wr = 150, $r = Wr * Wr, It = 1.5, $a = It * It;
        if (Ze >= $a || jr >= $r) {
      ...
      if (_ && r.touchData.cxt) {
        var bt = le("cxtdrag");
        r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.touchData.start ? r.touchData.start.emit(bt) : $.emit(bt), r.touchData.start && (r.touchData.start._private.grabbed = !1), r.touchData.cxtDragged = !0;
        ...
        S.preventDefault(), r.data.bgActivePosistion = void 0, this.lastThreeTouch = +/* @__PURE__ */ new Date(), r.touchData.selecting || $.emit(le("boxstart")), r.touchData.selecting = !0, r.touchData.didSelect = !0, W[4] = 1, !W || W.length === 0 || W[0] === void 0 ? (W[0] = (Z[0] + Z[2] + Z[4]) / 3, W[1] = (Z[1] + Z[3] + Z[5]) / 3, W[2] = (Z[0] + Z[2] + Z[4]) / 3 + 1, W[3] = (Z[1] + Z[3] + Z[5]) / 3 + 1) : (W[2] = (Z[0] + Z[2] + Z[4]) / 3, W[3] = (Z[1] + Z[3] + Z[5]) / 3), r.redrawHint("select", !0), r.redraw();
        ...
        var Br = r.touchData.start, Ye = S.touches[0].clientX - z, ir = S.touches[0].clientY - q, er = S.touches[1].clientX - z, lr = S.touches[1].clientY - q, wo = ce(Ye, ir, er, lr), Wf = wo / j;
        if (te) {
          var $f = Ye - F, Uf = ir - U, Kf = er - Q, Xf = lr - K, Yf = ($f + Kf) / 2, Zf = (Uf + Xf) / 2, ua = $.zoom(), Zn = ua * Wf, Ua = $.pan(), xo = J[0] * ua + Ua.x, Eo = J[1] * ua + Ua.y, Qf = {
            x: -Zn / ua * (xo - Ua.x - Yf) + xo,
            y: -Zn / ua * (Eo - Ua.y - Zf) + Eo
          };
          if (Br && Br.active()) {
            var hr = r.dragData.touchDragEles;
          ...
          }), $.emit(le("pinchzoom")), j = wo, F = Ye, U = ir, Q = er, K = lr, r.pinching = !0;
        }
        if (S.touches[0]) {
          var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          Z[0] = ve[0], Z[1] = ve[1];
        ...
        if (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(Z[0], Z[1], !0, !0)), _ && Mr != null && S.preventDefault(), _ && Mr != null && r.nodeIsDraggable(Mr))
          if (De) {
            ...
            r.hoverData.draggingEles = !0, hr.silentShift(la).emit(le("position")).emit(le("drag")), r.redrawHint("drag", !0), r.touchData.startPosition[0] == oe[0] && r.touchData.startPosition[1] == oe[1] && r.redrawHint("eles", !0), r.redraw();
          } else {
            var Lr = r.touchData.dragDelta = r.touchData.dragDelta || [];
            Lr.length === 0 ? (Lr.push(Te[0]), Lr.push(Te[1])) : (Lr[0] += Te[0], Lr[1] += Te[1]);
          }
        if (n(Mr || Er, ["touchmove", "tapdrag", "vmousemove"], S, {
          x: Z[0],
          y: Z[1]
        }), (!Mr || !Mr.grabbed()) && Er != Qn && (Qn && Qn.emit(le("tapdragout")), Er && Er.emit(le("tapdragover"))), r.touchData.last = Er, _)
        ...
        if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          ...
          Jf && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Wt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
            x: Te[0] * ee,
            y: Te[1] * ee
          }), $.emit(le("dragpan"))) : De && (r.swipePanning = !0, $.panBy({
            x: Pe * ee,
            y: je * ee
      ...
      for (var fe = 0; fe < Z.length; fe++)
        oe[fe] = Z[fe];
      _ && S.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", !0), r.redraw());
    }
  }, !1);
  var ye;
  ...
  if (r.registerBinding(e, "touchend", ie = function(S) {
    ...
    var Z = r.cy, oe = Z.zoom(), ee = r.touchData.now, ve = r.touchData.earlier;
    if (S.touches[0]) {
    ...
    if (!S.touches[2] && Z.boxSelectionEnabled() && r.touchData.selecting) {
      ...
      $[0] = void 0, $[1] = void 0, $[2] = void 0, $[3] = void 0, $[4] = 0, r.redrawHint("select", !0), Z.emit(me("boxend"));
      var Pe = function($r) {
      ...
      if (!S.touches[0]) {
        if (!S.touches[0]) {
          ...
          if (_ != null) {
            ...
            p(Be), r.redrawHint("drag", !0), r.redrawHint("eles", !0), je && (_.emit(me("freeon")), Be.emit(me("free")), r.dragData.didDrag && (_.emit(me("dragfreeon")), Be.emit(me("dragfree")))), n(_, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: ee[0],
              y: ee[1]
            }), _.unactivate(), r.touchData.start = null;
          } else {
            var Ke = r.findNearestElement(ee[0], ee[1], !0, !0);
            n(Ke, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: ee[0],
              y: ee[1]
            });
          }
          var mr = r.touchData.startPosition[0] - ee[0], Ye = mr * mr, ir = r.touchData.startPosition[1] - ee[1], er = ir * ir, lr = Ye + er, jr = lr * oe * oe;
          r.touchData.singleTouchMoved || (_ || Z.$(":selected").unselect(["tapunselect"]), n(_, ["tap", "vclick"], S, {
            x: ee[0],
            y: ee[1]
          }), de = !1, S.timeStamp - Ee <= Z.multiClickDebounceTime() ? (he && clearTimeout(he), de = !0, Ee = null, n(_, ["dbltap", "vdblclick"], S, {
            x: ee[0],
            y: ee[1]
          })) : (he = setTimeout(function() {
            de || n(_, ["onetap", "voneclick"], S, {
              x: ee[0],
              y: ee[1]
            });
          }, Z.multiClickDebounceTime()), Ee = S.timeStamp)), _ != null && !r.dragData.didDrag && _._private.selectable && jr < r.touchTapThreshold2 && !r.pinching && (Z.selectionType() === "single" ? (Z.$(t).unmerge(_).unselect(["tapunselect"]), _.select(["tapselect"])) : _.selected() ? _.unselect(["tapunselect"]) : _.select(["tapselect"]), r.redrawHint("eles", !0)), r.touchData.singleTouchMoved = !0;
        }
      }
    }
...
Qr.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, l) {
      ...
      var f = l * 2;
      return !!(Zr(e, t, this.points, s, o, n, i - f, [0, -1], a) || Zr(e, t, this.points, s, o, n - f, i, [0, -1], a) || kt(e, t, f, f, s - u + l, o - v + l, a) || kt(e, t, f, f, s + u - l, o - v + l, a) || kt(e, t, f, f, s + u - l, o + v - l, a) || kt(e, t, f, f, s - u + l, o + v - l, a));
    }
  };
};
...
Qr.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    generateBarrelBezierPts: function(e, t, a, n) {
      var i = t / 2, s = e / 2, o = a - s, l = a + s, u = n - i, v = n + i, f = As(e, t), c = f.heightOffset, h = f.widthOffset, d = f.ctrlPtOffsetPct * e, y = {
    ...
    checkPoint: function(e, t, a, n, i, s, o, l) {
      ...
      for (var c = this.generateBarrelBezierPts(n, i, s, o), h = function(T, k, D) {
        var B = D[4], P = D[2], A = D[0], R = D[5], L = D[1], I = Math.min(B, A), M = Math.max(B, A), O = Math.min(R, L), V = Math.max(R, L);
        if (I <= T && T <= M && O <= k && k <= V) {
          var G = _d(B, P, A), N = Ld(G[0], G[1], G[2], T), F = N.filter(function(U) {
            return 0 <= U && U <= 1;
          });
          if (F.length > 0)
            return F[0];
        ...
        if (m != null) {
          var b = p[5], w = p[3], E = p[1], C = sr(b, w, E, m);
...
Qr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, l) {
      var u = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = it(i, s, e, t, u, v, c, f, !1);
...
var ws = 1e3 / 60, Tf = {
    ...
    return function() {
      ...
      if (!a.dequeueingSetup) {
        ...
        var i = Fa(function() {
          ...
          var f = Yr(), c = n.averageRedrawTime, h = n.lastRedrawTime, d = [], y = n.cy.extent(), g = n.getPixelRatio();
          for (u || n.flushRenderedStyleQueue(); ; ) {
            var p = Yr(), m = p - f, b = p - v;
            if (h < ws) {
              var w = ws - (u ? c : 0);
  ...
  function r(e) {
    ...
    ht(this, r), this.idsByKey = new Xr(), this.keyForId = new Xr(), this.cachesByLvl = new Xr(), this.lvls = [], this.getKey = e, this.doesEleInvalidateKey = t;
  }
  return gt(r, [{
    key: "getIdsFor",
    value: function(t) {
...
}(), Nl = 25, nn = 50, pn = -4, Hs = 3, Sf = 7.99, iy = 8, sy = 1024, oy = 1024, uy = 1024, ly = 0.2, vy = 0.8, fy = 10, cy = 0.15, dy = 0.1, hy = 0.9, gy = 0.9, py = 100, yy = 1, Ut = {
  dequeue: "dequeue",
  downscale: "downscale",
...
nr.getElement = function(r, e, t, a, n) {
  ...
  if (h && h.invalidated && (h.invalidated = !1, h.texture.invalidatedWidth -= h.width), h)
    return h;
  var d;
  if (v <= Nl ? d = Nl : v <= nn ? d = nn : d = Math.ceil(v / nn) * nn, v > uy || f > oy)
    return null;
  ...
  }, b = n && n === Ut.dequeue, w = n && n === Ut.highQuality, E = n && n === Ut.downscale, C, x = a + 1; x <= Hs; x++) {
    var T = l.get(r, x);
    if (T) {
      C = T;
      break;
  ...
  return h = {
    ...
    height: v,
    scaledLabelShown: c
  }, g.usedWidth += Math.ceil(f + iy), g.eleCaches.push(h), l.set(r, a, h), i.checkTextureFullness(g), h;
};
...
nr.addTexture = function(r, e) {
  ...
  return a.push(n), n.eleCaches = [], n.height = r, n.width = Math.max(sy, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = t.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
nr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, eo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), lt(n, s), a.push(s), s;
  }
};
...
nr.dequeue = function(r) {
  for (var e = this, t = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < yy && t.size() > 0; s++) {
...
var by = 1, xa = -4, Pn = 2, wy = 3.99, xy = 50, Ey = 50, Cy = 0.15, Ty = 0.1, Sy = 0.9, ky = 0.9, Dy = 1, zl = 250, By = 4e3 * 4e3, Fl = 32767, Py = !0, kf = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = !0, t.lastInvalidationTime = Yr() - 2 * zl, t.skipping = !1, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Fa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, Ey), a.beforeRender(function(s, o) {
...
}, dr = kf.prototype, Vl = 0, Ay = Math.pow(2, 53) - 1;
...
dr.getLayers = function(r, e, t) {
  ...
  var y = function() {
    ...
    var B = D.after;
    y();
    var P = Math.ceil(f.w * u), A = Math.ceil(f.h * u);
    if (P > Fl || A > Fl)
      return null;
    var R = P * A;
    if (R > By)
  ...
  for (var p = null, m = r.length / by, b = !o, w = 0; w < r.length; w++) {
    ...
    if ((!p || p.eles.length >= m || !bv(p.bb, E.boundingBox())) && (p = g({
      insert: !0,
      after: p
    }), !p))
      return null;
...
dr.drawEleInLayer = function(r, e, t, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, t, Py), i.setImgSmoothing(s, !0));
};
...
Hr.drawCachedElementPortion = function(r, e, t, a, n, i, s, o) {
  ...
  if (!(u.w === 0 || u.h === 0)) {
    ...
    if (v != null) {
      ...
      if (f === 0)
        return;
      var c = s(l, e), h = u.x1, d = u.y1, y = u.w, g = u.h, p, m, b, w, E;
      if (c !== 0) {
        ...
        p = h, m = d;
      var T;
      f !== 1 && (T = r.globalAlpha, r.globalAlpha = T * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g), f !== 1 && (r.globalAlpha = T), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || l.setImgSmoothing(r, !1));
    } else
      t.drawElement(r, e);
  }
};
...
Hr.drawCachedElement = function(r, e, t, a, n, i) {
  ...
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || ao(c, a))) {
    ...
    s.drawElementUnderlay(r, e), s.drawCachedElementPortion(r, e, l, t, n, h, Oy, Vy), (!d || !y) && s.drawCachedElementPortion(r, e, u, t, n, h, Ny, xs), d && !y && (s.drawCachedElementPortion(r, e, v, t, n, h, zy, xs), s.drawCachedElementPortion(r, e, f, t, n, h, Fy, xs)), s.drawElementOverlay(r, e);
  }
};
...
Jr.drawEdge = function(r, e, t) {
  ...
  if (!(i && !e.visible()) && !(o.badLine || o.allpts == null || isNaN(o.allpts[0]))) {
    ...
    var u = i ? e.pstyle("opacity").value : 1, v = i ? e.pstyle("line-opacity").value : 1, f = e.pstyle("curve-style").value, c = e.pstyle("line-style").value, h = e.pstyle("width").pfValue, d = e.pstyle("line-cap").value, y = e.pstyle("line-outline-width").value, g = e.pstyle("line-outline-color").value, p = u * v, m = u * v, b = function() {
...
Jr.drawArrowhead = function(r, e, t, a, n, i, s) {
  if (!(isNaN(a) || a == null || isNaN(n) || n == null || isNaN(i) || i == null)) {
    ...
    if (l !== "none") {
      ...
      (s !== 1 || v === "hollow") && (r.globalCompositeOperation = "destination-out", o.colorFillStyle(r, 255, 255, 255, 1), o.colorStrokeStyle(r, 255, 255, 255, 1), o.drawArrowShape(e, r, u, f, l, h, a, n, i), r.globalCompositeOperation = y);
...
Jr.drawArrowShape = function(r, e, t, a, n, i, s, o, l) {
  var u = this, v = this.usePaths() && n !== "triangle-cross", f = !1, c, h = e, d = {
    x: s,
    y: o
  }, y = r.pstyle("arrow-scale").value, g = this.getArrowWidth(a, y), p = u.arrowShapes[n];
  if (v) {
    var m = u.arrowPathCache = u.arrowPathCache || [], b = Dt(n), w = m[b];
...
mo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? D = v(t, "background-width", "pfValue", a) * g : D = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? B = v(t, "background-height", "pfValue", a) * p : B = v(t, "background-height", "pfValue", a)), !(D === 0 || B === 0)) {
    ...
    I === "%" ? A += (g - D) * M : A += M;
    var O = l - p / 2, V = v(t, "background-position-y", "units", a), G = v(t, "background-position-y", "pfValue", a);
    V === "%" ? O += (p - B) * G : O += G;
    var N = v(t, "background-offset-y", "units", a), F = v(t, "background-offset-y", "pfValue", a);
    N === "%" ? O += (p - B) * F : O += F, m.pathCache && (A -= o, O -= l, o = 0, l = 0);
    var U = r.globalAlpha;
    r.globalAlpha = E;
    var Q = i.getImgSmoothing(r), K = !1;
    if (C === "no" && Q ? (i.setImgSmoothing(r, !1), K = !0) : C === "yes" && !Q && (i.setImgSmoothing(r, !0), K = !0), c === "no-repeat")
      w && (r.save(), m.pathCache ? r.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.clip())), i.safeDrawImage(r, e, 0, 0, T, k, A, O, D, B), w && r.restore();
    else {
      var j = r.createPattern(e, c);
      r.fillStyle = j, i.nodeShapes[i.getNodeShape(t)].draw(r, o, l, g, p, x, m), r.translate(A, O), r.fill(), r.translate(-A, -O);
    }
...
function qy(r, e, t, a, n) {
  var i = Math.min(a, n), s = i / 2, o = e + a / 2, l = t + n / 2;
...
Lt.drawText = function(r, e, t) {
  ...
  if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
    ...
    if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
      ...
      var h = t ? t + "-" : "", d = Tr(s, "labelWidth", t), y = Tr(s, "labelHeight", t), g = e.pstyle(h + "text-margin-x").pfValue, p = e.pstyle(h + "text-margin-y").pfValue, m = e.isEdge(), b = e.pstyle("text-halign").value, w = e.pstyle("text-valign").value;
      ...
      if (C > 0 || T > 0 && x > 0) {
        var R = r.fillStyle, L = r.strokeStyle, I = r.lineWidth, M = e.pstyle("text-background-color").value, O = e.pstyle("text-border-color").value, V = e.pstyle("text-border-style").value, G = C > 0, N = T > 0 && x > 0, F = l - k;
        switch (b) {
          case "left":
            F -= d;
            break;
        ...
        var U = u - y - k, Q = d + 2 * k, K = y + 2 * k;
        if (G && (r.fillStyle = "rgba(".concat(M[0], ",").concat(M[1], ",").concat(M[2], ",").concat(C * o, ")")), N && (r.strokeStyle = "rgba(".concat(O[0], ",").concat(O[1], ",").concat(O[2], ",").concat(x * o, ")"), r.lineWidth = T, r.setLineDash))
          switch (V) {
            case "dotted":
              r.setLineDash([1, 1]);
              break;
        ...
        if (B ? (r.beginPath(), Gl(r, F, U, Q, K, A)) : P ? (r.beginPath(), qy(r, F, U, Q, K)) : (r.beginPath(), r.rect(F, U, Q, K)), G && r.fill(), N && r.stroke(), N && V === "double") {
          var j = T / 2;
          r.beginPath(), B ? Gl(r, F + j, U + j, Q - 2 * j, K - 2 * j, A) : r.rect(F + j, U + j, Q - 2 * j, K - 2 * j), r.stroke();
        }
      ...
      if (re > 0 && (r.lineWidth = re), e.pstyle("text-wrap").value === "wrap") {
        var ne = Tr(s, "labelWrapCachedLines", t), J = Tr(s, "labelLineHeight", t), z = d / 2, q = this.getLabelJustification(e);
        switch (q === "auto" || (b === "left" ? q === "left" ? l += -d : q === "center" && (l += -z) : b === "center" ? q === "left" ? l += -z : q === "right" && (l += z) : b === "right" && (q === "center" ? l += z : q === "right" && (l += d))), w) {
          case "top":
            u -= (ne.length - 1) * J;
            break;
          case "center":
        ...
        for (var H = 0; H < ne.length; H++)
          re > 0 && r.strokeText(ne[H], l, u), r.fillText(ne[H], l, u), u += J;
      } else
        re > 0 && r.strokeText(c, l, u), r.fillText(c, l, u);
...
yt.drawNode = function(r, e, t) {
  ...
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    ...
    var B = e.pstyle("background-blacken").value, P = e.pstyle("border-width").pfValue, A = e.pstyle("background-opacity").value * c, R = e.pstyle("border-color").value, L = e.pstyle("border-style").value, I = e.pstyle("border-join").value, M = e.pstyle("border-cap").value, O = e.pstyle("border-position").value, V = e.pstyle("border-dash-pattern").pfValue, G = e.pstyle("border-dash-offset").pfValue, N = e.pstyle("border-opacity").value * c, F = e.pstyle("outline-width").pfValue, U = e.pstyle("outline-color").value, Q = e.pstyle("outline-style").value, K = e.pstyle("outline-opacity").value * c, j = e.pstyle("outline-offset").value, re = e.pstyle("corner-radius").value;
    ...
    var ne = function() {
      ...
      var W = s.nodePathCache = s.nodePathCache || [], $ = cv(S === "polygon" ? S + "," + _.join(",") : S, "" + X, "" + ue, "" + re), Z = W[$], oe, ee = !1;
      return Z != null ? (oe = Z, ee = !0, v.pathCache = oe) : (oe = new Path2D(), W[$] = v.pathCache = oe), {
        path: oe,
        cacheHit: ee
      };
    }, H = e.pstyle("shape").strValue, Y = e.pstyle("shape-polygon-points").pfValue;
    if (h) {
      r.translate(f.x, f.y);
      var te = q(o, l, H, Y);
    ...
    var ce = function() {
      ...
      for (var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, S = u.backgrounding, _ = 0, W = 0; W < E.length; W++) {
      ...
      var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasPie(e) && (s.drawPie(r, e, X), ue && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v)));
    }, we = function() {
      var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
      s.hasStripe(e) && (r.save(), h ? r.clip(v.pathCache) : (s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v), r.clip()), s.drawStripe(r, e, X), r.restore(), ue && (h || s.nodeShapes[s.getNodeShape(e)].draw(r, f.x, f.y, o, l, re, v)));
    }, ye = function() {
      var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, X = (B > 0 ? B : -B) * ue, S = B > 0 ? 0 : 255;
      ...
      if (P > 0) {
        ...
        if (L === "double") {
          ...
          r.globalCompositeOperation = "destination-out", h ? r.stroke(d) : r.stroke(), r.globalCompositeOperation = X;
        }
      ...
      if (F > 0) {
        ...
        var X = s.getNodeShape(e), S = P;
        O === "inside" && (S = 0), O === "outside" && (S *= 2);
        var _ = (o + S + (F + j)) / o, W = (l + S + (F + j)) / l, $ = o * _, Z = l * W, oe = s.nodeShapes[X].points, ee;
        if (h) {
          var ve = q($, Z, X, oe);
          ee = ve.path;
        }
        if (X === "ellipse")
          ...
          var le = 0, me = 0, De = 0;
          X === "round-diamond" ? le = (S + j + F) * 1.4 : X === "round-heptagon" ? (le = (S + j + F) * 1.075, De = -(S / 2 + j + F) / 35) : X === "round-hexagon" ? le = (S + j + F) * 1.12 : X === "round-pentagon" ? (le = (S + j + F) * 1.13, De = -(S / 2 + j + F) / 15) : X === "round-tag" ? (le = (S + j + F) * 1.12, me = (S / 2 + F + j) * 0.07) : X === "round-triangle" && (le = (S + j + F) * (Math.PI / 2), De = -(S + j / 2 + F) / Math.PI), le !== 0 && (_ = (o + le) / o, $ = o * _, ["round-hexagon", "round-tag"].includes(X) || (W = (l + le) / l, Z = l * W)), re = re === "auto" ? Ev($, Z) : re;
          for (var Te = $ / 2, fe = Z / 2, Pe = re + (S + F + j) / 2, Be = new Array(oe.length / 2), je = new Array(oe.length / 2), Ke = 0; Ke < oe.length / 2; Ke++)
            Be[Ke] = {
              x: ue.x + me + Te * oe[Ke * 2],
              y: ue.y + De + fe * oe[Ke * 2 + 1]
            };
          var mr, Ye, ir, er, lr = Be.length;
          ...
          re = re === "auto" ? vt($, Z) : re, s.drawRoundRectanglePath(ee || r, ue.x, ue.y, $, Z, re + (S + F + j) / 2);
        else if (["cutrectangle", "cut-rectangle"].includes(X))
          re = re === "auto" ? no() : re, s.drawCutRectanglePath(ee || r, ue.x, ue.y, $, Z, null, re + (S + F + j) / 4);
        else if (["bottomroundrectangle", "bottom-round-rectangle"].includes(X))
          re = re === "auto" ? vt($, Z) : re, s.drawBottomRoundRectanglePath(ee || r, ue.x, ue.y, $, Z, re + (S + F + j) / 2);
        else if (X === "barrel")
    ...
    if (Se) {
      var Re = e.pstyle("ghost-offset-x").pfValue, Oe = e.pstyle("ghost-offset-y").pfValue, Ne = e.pstyle("ghost-opacity").value, ze = Ne * c;
      r.translate(Re, Oe), z(), de(), ne(Ne * A), ce(), Ae(ze, !0), J(Ne * N), ie(), Ce(B !== 0 || P !== 0), we(B !== 0 || P !== 0), Ae(ze, !1), ye(ze), r.translate(-Re, -Oe);
    }
    h && r.translate(-f.x, -f.y), Ee(), h && r.translate(f.x, f.y), z(), de(), ne(), ce(), Ae(c, !0), J(), ie(), Ce(B !== 0 || P !== 0), we(B !== 0 || P !== 0), Ae(c, !1), ye(), h && r.translate(-f.x, -f.y), pe(), he(), t && r.translate(p.x1, p.y1);
  }
};
var Pf = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
yt.drawPie = function(r, e, t, a) {
  ...
  var n = e.cy().style(), i = e.pstyle("pie-size"), s = e.pstyle("pie-hole"), o = e.pstyle("pie-start-angle").pfValue, l = a.x, u = a.y, v = e.width(), f = e.height(), c = Math.min(v, f) / 2, h, d = 0, y = this.usePaths();
  if (y && (l = 0, u = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c))
    for (var g = 1; g <= n.pieBackgroundN; g++) {
      ...
      p === 0 || d >= 1 || d + w > 1 || (h === 0 ? (r.beginPath(), r.moveTo(l, u), r.arc(l, u, c, E, x), r.closePath()) : (r.beginPath(), r.arc(l, u, c, E, x), r.arc(l, u, h, x, E, !0), r.closePath()), this.colorFillStyle(r, m[0], m[1], m[2], b), r.fill(), d += w);
    }
};
yt.drawStripe = function(r, e, t, a) {
  ...
  for (var y = 1; y <= n.stripeBackgroundN; y++) {
    ...
    b + u > 1 && (b = 1 - u), !(g === 0 || u >= 1 || u + b > 1) && (r.beginPath(), r.rect(i, s + d * u, h, d * b), r.closePath(), this.colorFillStyle(r, p[0], p[1], p[2], m), r.fill(), u += b);
  }
  r.restore();
};
var xr = {}, _y = 100;
...
xr.createGradientStyleFor = function(r, e, t, a, n) {
  ...
  if (a === "radial-gradient")
    if (t.isEdge()) {
      var u = t.sourceEndpoint(), v = t.targetEndpoint(), f = t.midpoint(), c = Bt(u, f), h = Bt(v, f);
...
xr.render = function(r) {
  ...
  function B(J, z, q, H, Y) {
    ...
    J.globalCompositeOperation = "destination-out", e.colorFillStyle(J, 255, 255, 255, e.motionBlurTransparency), J.fillRect(z, q, H, Y), J.globalCompositeOperation = te;
  }
  function P(J, z) {
    var q, H, Y, te;
    !e.clearingMotionBlur && (J === u.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] || J === u.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG]) ? (q = {
      x: E.x * h,
      y: E.y * h
    }, H = b * h, Y = e.canvasWidth * h, te = e.canvasHeight * h) : (q = C, H = w, Y = e.canvasWidth, te = e.canvasHeight), J.setTransform(1, 0, 0, 1, 0, 0), z === "motionBlur" ? B(J, 0, 0, Y, te) : !a && (z === void 0 || z) && J.clearRect(0, 0, Y, te), n || (J.translate(q.x, q.y), J.scale(H, H)), o && J.translate(o.x, o.y), s && J.scale(s, s);
  }
  if (f || (e.textureDrawLastFrame = !1), f) {
    ...
    var R = u.contexts[e.NODE], L = e.textureCache.texture, x = e.textureCache.viewport;
    ...
    var b = t.zoom();
    P(R, !1), R.clearRect(x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l), R.drawImage(L, x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l);
  ...
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = !0), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = !0), v[e.NODE] || n || i || N[e.NODE]) {
    var F = c && !N[e.NODE] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : u.contexts[e.NODE]), U = c && !F ? "motionBlur" : void 0;
    P(R, U), G ? e.drawCachedNodes(R, D.nondrag, l, O) : e.drawLayeredElements(R, D.nondrag, l, O), e.debug && e.drawDebugPoints(R, D.nondrag), !n && !c && (v[e.NODE] = !1);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var F = c && !N[e.DRAG] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
    P(R, c && !F ? "motionBlur" : void 0), G ? e.drawCachedNodes(R, D.drag, l, O) : e.drawCachedElements(R, D.drag, l, O), e.debug && e.drawDebugPoints(R, D.drag), !n && !c && (v[e.DRAG] = !1);
  }
  if (this.drawSelectionRectangle(r, P), c && h !== 1) {
    var Q = u.contexts[e.NODE], K = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_NODE], j = u.contexts[e.DRAG], re = e.data.bufferCanvases[e.MOTIONBLUR_BUFFER_DRAG], ne = function(z, q, H) {
      z.setTransform(1, 0, 0, 1, 0, 0), H || !p ? z.clearRect(0, 0, e.canvasWidth, e.canvasHeight) : B(z, 0, 0, e.canvasWidth, e.canvasHeight);
      var Y = h;
      z.drawImage(
        q,
        // img
    ...
    (v[e.NODE] || N[e.NODE]) && (ne(Q, K, N[e.NODE]), v[e.NODE] = !1), (v[e.DRAG] || N[e.DRAG]) && (ne(j, re, N[e.DRAG]), v[e.DRAG] = !1);
  }
...
function Gy(r, e, t) {
  var a = Hl(r, r.VERTEX_SHADER, e), n = Hl(r, r.FRAGMENT_SHADER, t), i = r.createProgram();
...
function Qy(r, e, t, a) {
  var n = Af(r, e), i = Je(n, 2), s = i[0], o = i[1], l = Rf(r, o, a), u = r.createBuffer();
...
function Fr(r, e, t, a) {
  var n = Af(r, t), i = Je(n, 3), s = i[0], o = i[1], l = i[2], u = Rf(r, o, e * s), v = s * l, f = r.createBuffer();
...
function Es() {
  var r = new Wl(9);
  return Wl != Float32Array && (r[1] = 0, r[2] = 0, r[3] = 0, r[5] = 0, r[6] = 0, r[7] = 0), r[0] = 1, r[4] = 1, r[8] = 1, r;
}
function $l(r) {
  return r[0] = 1, r[1] = 0, r[2] = 0, r[3] = 0, r[4] = 1, r[5] = 0, r[6] = 0, r[7] = 0, r[8] = 1, r;
}
function em(r, e, t) {
  var a = e[0], n = e[1], i = e[2], s = e[3], o = e[4], l = e[5], u = e[6], v = e[7], f = e[8], c = t[0], h = t[1], d = t[2], y = t[3], g = t[4], p = t[5], m = t[6], b = t[7], w = t[8];
  return r[0] = c * a + h * s + d * u, r[1] = c * n + h * o + d * v, r[2] = c * i + h * l + d * f, r[3] = y * a + g * s + p * u, r[4] = y * n + g * o + p * v, r[5] = y * i + g * l + p * f, r[6] = m * a + b * s + w * u, r[7] = m * n + b * o + w * v, r[8] = m * i + b * l + w * f, r;
}
function yn(r, e, t) {
...
var tm = /* @__PURE__ */ function() {
  function r(e, t, a, n) {
    ht(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = !0, this.locked = !1, this.texture = null, this.needsBuffer = !0, this.freePointer = {
      x: 0,
      row: 0
  ...
  return gt(r, [{
    ...
    value: function(t, a, n) {
      ...
      var s = this.texSize, o = this.texRows, l = this.texHeight, u = this.getScale(a), v = u.scale, f = u.texW, c = u.texH, h = function(b, w) {
        if (n && w) {
          var E = w.context, C = b.x, x = b.row, T = C, k = l * x;
        ...
        {
          var T = i.freePointer.x, k = i.freePointer.row * l, D = E;
        ...
        {
          var B = E, P = (i.freePointer.row + 1) * l, A = C;
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = Yy(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = !1, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
  ...
  function r(e, t, a, n) {
    ht(this, r), this.r = e, this.texSize = t, this.texRows = a, this.createTextureCanvas = n, this.atlases = [], this.styleKeyToAtlas = /* @__PURE__ */ new Map(), this.markedKeys = /* @__PURE__ */ new Set();
  }
  return gt(r, [{
    key: "getKeys",
    value: function() {
    ...
    value: function() {
      ...
      try {
        var u = function() {
          var f = l.value, c = f.getKeys(), h = nm(a, c);
          if (h.size === 0)
          ...
          try {
            for (d.s(); !(y = d.n()).done; ) {
              var g = y.value;
              if (!h.has(g)) {
                var p = f.getOffsets(g), m = Je(p, 2), b = m[0], w = m[1];
                s.canFit({
                  w: b.w + w.w,
                  h: b.h
    ...
    value: function(t, a, n) {
      var i = a.getOffsets(t), s = Je(i, 2), o = s[0], l = s[1];
      if (l.w === 0)
...
var im = /* @__PURE__ */ function() {
  function r(e, t) {
    ht(this, r), this.r = e, this.globalOptions = t, this.atlasSize = t.webglTexSize, this.maxAtlasesPerBatch = t.webglTexPerBatch, this.renderTypes = /* @__PURE__ */ new Map(), this.collections = /* @__PURE__ */ new Map(), this.typeAndIdToKey = /* @__PURE__ */ new Map();
  }
  return gt(r, [{
    key: "getAtlasSize",
    value: function() {
    ...
    value: function(t, a) {
      var n = this.globalOptions, i = n.webglTexSize, s = n.createTextureCanvas, o = a.texRows, l = this._cacheScratchCanvas(s), u = new am(this.r, i, o, l);
              ...
              var m = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    B !== void 0 && !Ky(T, B) && (f = !0, a.typeAndIdToKey.delete(D), B.forEach(function(P) {
                      return C.markKeyForGC(P);
                    }));
                  }
                }
    ...
    value: function(t, a) {
      ...
      return o.map(function(l) {
        var u = i.getBoundingBox(t, l), v = n.getOrCreateAtlas(t, a, u, l), f = v.getOffsets(l), c = Je(f, 2), h = c[0], d = c[1];
        return {
          atlas: v,
          tex: h,
          tex1: h,
    ...
    value: function() {
      ...
      try {
        for (a.s(); !(n = a.n()).done; ) {
          var i = Je(n.value, 2), s = i[0], o = i[1], l = o.getCounts(), u = l.keyCount, v = l.atlasCount;
          t.push({
            type: s,
            keyCount: u,
            atlasCount: v
  ...
  function r(e) {
    ht(this, r), this.globalOptions = e, this.atlasSize = e.webglTexSize, this.maxAtlasesPerBatch = e.webglTexPerBatch, this.batchAtlases = [];
  }
  return gt(r, [{
...
}, Cs = 0, Kl = 1, Xl = 2, Ts = 3, _t = 4, sn = 5, ga = 6, pa = 7, fm = /* @__PURE__ */ function() {
  function r(e, t, a) {
    ht(this, r), this.r = e, this.gl = t, this.maxInstances = a.webglBatchSize, this.atlasSize = a.webglTexSize, this.bgColor = a.bgColor, this.debug = a.webglDebug, this.batchDebugInfo = [], a.enableWrapping = !0, a.createTextureCanvas = Hy, this.atlasManager = new im(e, a), this.batchManager = new sm(a), this.simpleShapeOptions = /* @__PURE__ */ new Map(), this.program = this._createShaderProgram(Ea.SCREEN), this.pickingProgram = this._createShaderProgram(Ea.PICKING), this.vao = this._createVAO();
  }
  return gt(r, [{
    key: "addAtlasCollection",
    value: function(t, a) {
    ...
    */
    ...
    value: function(t, a, n) {
      ...
      if (this._isVisible(t, i)) {
        ...
        qt(a, c);
        var h = t.pstyle(s.color).value, d = t.pstyle(s.opacity).value, y = this.colorBuffer.getView(l);
        xt(h, d, y);
        var g = this.lineWidthBuffer.getView(l);
        if (g[0] = 0, g[1] = 0, s.border) {
          var p = t.pstyle("border-width").value;
          if (p > 0) {
            var m = t.pstyle("border-color").value, b = t.pstyle("border-opacity").value, w = this.borderColorBuffer.getView(l);
            xt(m, b, w);
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, Wy(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, !1, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
var Ss = function(e, t) {
  ...
  return function(a, n) {
    ...
    if (typeof n == "string") {
      var s = n.indexOf("_");
      if (s > 0) {
        var o = Number(n.substring(s + 1)), l = Lf(a, t), u = i.h / l.length, v = u * o, f = i.y1 + v;
        return {
          x1: i.x1,
          w: i.w,
          y1: f,
...
function mm(r) {
  ...
  e.save(), If(r, e), e.strokeStyle = "rgba(0, 0, 0, 0.3)", e.beginPath(), e.moveTo(-1e3, 0), e.lineTo(1e3, 0), e.stroke(), e.beginPath(), e.moveTo(0, -1e3), e.lineTo(0, 1e3), e.stroke(), e.restore();
}
function bm(r) {
  var e = function(n, i, s) {
    for (var o = n.atlasManager.getAtlasCollection(i), l = r.data.contexts[r.NODE], u = o.atlases, v = 0; v < u.length; v++) {
      ...
      if (c) {
        ...
        l.save(), l.scale(p, p), l.drawImage(c, y, g), l.strokeStyle = "black", l.rect(y, g, h, d), l.stroke(), l.restore();
      }
    }
  }, t = 0;
...
function wm(r, e, t, a, n) {
  ...
  {
    var c = $y(r, v, f, e, t), h = Je(c, 2), d = h[0], y = h[1], g = 6;
    i = d - g / 2, s = y - g / 2, o = g, l = g;
  }
  if (o === 0 || l === 0)
    return [];
  var p = r.data.contexts[r.WEBGL];
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), Of(r, null, Ea.PICKING), r.pickingFrameBuffer.needsDraw = !1);
  ...
  for (var w = /* @__PURE__ */ new Set(), E = 0; E < m; E++) {
    var C = b.slice(E * 4, E * 4 + 4), x = Xy(C) - 1;
    x >= 0 && w.add(x);
  }
  return w;
}
function xm(r, e, t) {
  var a = wm(r, e, t), n = r.getCachedZSortedEles(), i, s, o = kr(a), l;
  try {
    for (o.s(); !(l = o.n()).done; ) {
      var u = l.value, v = n[u];
...
function Of(r, e, t) {
  ...
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && ym(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    var o = pm(r), l = r.getCachedZSortedEles();
    if (i = l.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < l.length; f++)
        Ds(r, f, l[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (mm(r), bm(r)), r.data.canvasNeedsRedraw[r.NODE] = !1, r.data.canvasNeedsRedraw[r.DRAG] = !1;
  }
  if (r.webglDebug) {
...
mt.drawRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, l = i === "auto" ? vt(a, n) : Math.min(i, o, s);
...
mt.drawBottomRoundRectanglePath = function(r, e, t, a, n, i) {
  var s = a / 2, o = n / 2, l = i === "auto" ? vt(a, n) : i;
...
var Yl = Math.sin(0), Zl = Math.cos(0), $s = {}, Us = {}, Nf = Math.PI / 40;
for (var Gt = 0 * Math.PI; Gt < 2 * Math.PI; Gt += Nf)
  $s[Gt] = Math.sin(Gt), Us[Gt] = Math.cos(Gt);
mt.drawEllipsePath = function(r, e, t, a, n) {
  if (r.beginPath && r.beginPath(), r.ellipse)
    ...
    for (var i, s, o = a / 2, l = n / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Nf)
      i = e - o * $s[u] * Yl + o * Us[u] * Zl, s = t + l * Us[u] * Yl + l * $s[u] * Zl, u === 0 ? r.moveTo(i, s) : r.lineTo(i, s);
  r.closePath();
};
var Wa = {};
...
Wa.bufferCanvasImage = function(r) {
  var e = this.cy, t = e.mutableElements(), a = t.boundingBox(), n = this.findContainerClientCoords(), i = r.full ? Math.ceil(a.w) : n[2], s = r.full ? Math.ceil(a.h) : n[3], o = ae(r.maxWidth) || ae(r.maxHeight), l = this.getPixelRatio(), u = 1;
  if (r.scale !== void 0)
    i *= r.scale, s *= r.scale, u = r.scale;
  else if (o) {
    var v = 1 / 0, f = 1 / 0;
    ae(r.maxWidth) && (v = u * r.maxWidth / i), ae(r.maxHeight) && (f = u * r.maxHeight / s), u = Math.min(v, f), i *= u, s *= u;
  }
  o || (i *= l, s *= l, u *= l);
...
function Vf(r) {
  ...
  for (var u = 0; u < ke.CANVAS_LAYERS; u++) {
    var v = e.data.canvases[u] = a.createElement("canvas"), f = ke.CANVAS_TYPES[u];
    e.data.contexts[u] = v.getContext(f), e.data.contexts[u] || $e("Could not create canvas of type " + f), Object.keys(l).forEach(function(J) {
      v.style[J] = l[J];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + u), v.style.zIndex = String(ke.CANVAS_LAYERS - u), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[u] = !1;
  }
  ...
  var c = wr(), h = function(z) {
    ...
    var Y = z ? z + "-" : "";
    return {
      x: q.x + H.pstyle(Y + "text-margin-x").pfValue,
      y: q.y + H.pstyle(Y + "text-margin-y").pfValue
    };
  }, L = function(z, q, H) {
  ...
  e.onUpdateEleCalcs(function(z, q) {
    U.invalidateElements(q), Q.invalidateElements(q), K.invalidateElements(q), j.invalidateElements(q), re.invalidateElements(q);
  ...
  U.onDequeue(ne), Q.onDequeue(ne), K.onDequeue(ne), j.onDequeue(ne), r.webgl && e.initWebgl(r, {
    getStyleKey: g,
    getLabelKey: p,
    getSourceLabelKey: m,
    getTargetLabelKey: b,
...
function Gf(r, e, t) {
  ...
  if (r === "core") {
    ...
    for (var i = function(T) {
      this.options = T, t.call(this, T), Le(this._private) || (this._private = {}), this._private.cy = T.cy, this._private.listeners = [], this.createEmitter();
    ...
    var h = Hf("renderer", "base"), d = h.prototype, y = t, g = t.prototype, p = function() {
...
var Ks = function() {
  ...
  if (arguments.length === 5)
    return Dm.apply(null, arguments);
