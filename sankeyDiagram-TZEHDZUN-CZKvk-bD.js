import { _ as p, I as _t, J as xt, s as vt, h as bt, j as wt, i as St, k as lt, Q as Lt, l as Q, ad as Et, P as At, y as Tt } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { C as Mt } from "./embed-entry-BQjeO8mI.js";
function Nt(t) {
...
var K = at, J = [], tt = [], Z = /* @__PURE__ */ new Map(), Zt = /* @__PURE__ */ p(() => {
  ...
  let _;
  h === "sandbox" && (_ = Q("#i" + e));
  const s = h === "sandbox" ? Q(_.nodes()[0].contentDocument.body) : Q("body"), o = h === "sandbox" ? s.select(`[id="${e}"]`) : Q(`[id="${e}"]`), l = (d == null ? void 0 : d.width) ?? m.width, x = (d == null ? void 0 : d.height) ?? m.width, v = (d == null ? void 0 : d.useMaxWidth) ?? m.useMaxWidth, y = (d == null ? void 0 : d.nodeAlignment) ?? m.nodeAlignment, b = (d == null ? void 0 : d.prefix) ?? m.prefix, M = (d == null ? void 0 : d.suffix) ?? m.suffix, T = (d == null ? void 0 : d.showValues) ?? m.showValues, N = a.db.getGraph(), C = ae[y];
