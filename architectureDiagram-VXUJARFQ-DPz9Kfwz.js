import { _ as dt, a1 as Ze, ad as ke, m as Re, j as qe, i as Je, I as Qe, J as Ke, h as je, s as _e, P as tr, Y as er, Z as rr, $ as ir, k as ye, ap as Ee, aI as ve, q as ar, l as nr, O as or, aJ as sr, aK as hr } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { p as lr } from "./chunk-4BX2VUAB-Dry3wvbl.js";
import { p as fr } from "./treemap-KMMF4GRG-CEx6UpjY.js";
import { c as Se } from "./cytoscape.esm-ZmItrg9y.js";
import { A as me, v as cr } from "./embed-entry-BQjeO8mI.js";
        ...
        function(A) {
          ...
          function(A, P, N) {
            ...
            o.prototype.getNodes = function() {
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, d = h.MAX_VALUE, v = -h.MAX_VALUE, L, S, C, G, K, X = this.nodes, J = X.length, O = 0; O < J; O++) {
                var rt = X[O];
              ...
              for (var l = h.MAX_VALUE, T = -h.MAX_VALUE, d = h.MAX_VALUE, v = -h.MAX_VALUE, L, S, C, G, K = c.length, X = 0; X < K; X++) {
                var J = c[X];
                L = J.getLeft(), S = J.getRight(), C = J.getTop(), G = J.getBottom(), l > L && (l = L), T < S && (T = S), d > C && (d = C), v < G && (v = G);
              }
          ...
          function(A, P, N) {
            ...
            h.calcSeparationAmount = function(a, r, e, f) {
              ...
              var o = a.getX(), s = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), d = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), S = r.getX(), C = r.getY(), G = r.getRight(), K = r.getX(), X = r.getBottom(), J = r.getRight(), O = r.getWidthHalf(), rt = r.getHeightHalf(), n = !1, m = !1;
              if (f === g) {
                if (i > t)
                ...
                if (-p === y ? f > g ? (e[0] = l, e[1] = T, n = !0) : (e[0] = c, e[1] = s, n = !0) : p === y && (f > g ? (e[0] = o, e[1] = s, n = !0) : (e[0] = d, e[1] = T, n = !0)), -E === y ? g > f ? (e[2] = K, e[3] = X, m = !0) : (e[2] = G, e[3] = C, m = !0) : E === y && (g > f ? (e[2] = S, e[3] = C, m = !0) : (e[2] = J, e[3] = X, m = !0)), n && m)
                  return !1;
              ...
              var i = a.x, g = a.y, t = r.x, o = r.y, s = e.x, c = e.y, l = f.x, T = f.y, d = void 0, v = void 0, L = void 0, S = void 0, C = void 0, G = void 0, K = void 0, X = void 0, J = void 0;
              return L = o - g, C = i - t, K = t * g - i * o, S = T - c, G = s - l, X = l * c - s * T, J = L * G - S * C, J === 0 ? null : (d = (C * X - G * K) / J, v = (S * K - L * X) / J, new u(d, v));
            ...
            u.svd = function(h) {
                ...
                if (t < g) {
                  ...
                  if (r[t] = -r[t], /* @__PURE__ */ function(Tt, Ct) {
                    ...
                    for (var X = t + 1; X < this.n; X++)
                      for (var J = -r[X] / r[t + 1], O = t + 1; O < this.m; O++)
                        h[O][X] += J * e[O];
                  }
              ...
              for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (q++, It) {
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(r[n - 2])), Math.abs(this.s[q])), Math.abs(r[q])), Vt = this.s[n - 1] / Yt, b = this.s[n - 2] / Yt, U = r[n - 2] / Yt, B = this.s[q] / Yt, Q = r[q] / Yt, Z = ((b + Vt) * (b - Vt) + U * U) / 2, at = Vt * U * (Vt * U), ct = 0;
                      /* @__PURE__ */ (function(Tt, Ct) {
                        return Tt || Ct;
                      })(Z !== 0, at !== 0) && (ct = Math.sqrt(Z * Z + at), Z < 0 && (ct = -ct), ct = at / (Z + ct));
                      for (var nt = (B + Vt) * (B - Vt) + ct, tt = B * Q, j = q; j < n - 1; j++) {
        ...
        (() => {
          var P = {
            ...
            765: (
              /***/
              (a, r, e) => {
                var f = e(551).FDLayout, i = e(578), g = e(880), t = e(991), o = e(767), s = e(806), c = e(902), l = e(551).FDLayoutConstants, T = e(551).LayoutConstants, d = e(551).Point, v = e(551).PointD, L = e(551).DimensionD, S = e(551).Layout, C = e(551).Integer, G = e(551).IGeometry, K = e(551).LGraph, X = e(551).Transform, J = e(551).LinkedList;
                function O() {
                ...
                s.handleConstraints = function(c) {
                  ...
                  var X = function(U, B) {
                    ...
                    return U.forEach(function(Z) {
                      B += v[d.get(Z)], Q += L[d.get(Z)];
                    }), { x: B / U.size, y: Q / U.size };
                  }, O = function(U, B, Q, Z, at) {
                    function ct(lt, ot) {
                    ...
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (ut.push(ot), Q || (B == "horizontal" ? tt.set(ot, d.has(ot) ? v[d.get(ot)] : Z.get(ot)) : tt.set(ot, d.has(ot) ? L[d.get(ot)] : Z.get(ot)))) : tt.set(ot, Number.NEGATIVE_INFINITY), Q && j.set(ot, /* @__PURE__ */ new Set([ot]));
                    }), Q && at.forEach(function(lt) {
                      var ot = [];
                    ...
                    for (var Mt = function() {
                      ...
                      Lt.forEach(function(ft) {
                        ...
                        nt.set(ft.id, nt.get(ft.id) - 1), nt.get(ft.id) == 0 && ut.push(ft.id), Q && j.set(ft.id, ct(j.get(ot), j.get(ft.id)));
                      });
                    }; ut.length != 0; )
                      Mt();
                    if (Q) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        var he = (Lt + st) / 2 - (ft + Xt) / 2, Jt = !0, jt = !1, _t = void 0;
                        try {
                          for (var Qt = lt[Symbol.iterator](), oe; !(Jt = (oe = Qt.next()).done); Jt = !0) {
                            var te = oe.value;
                    ...
                    var B = 0, Q = 0, Z = 0, at = 0;
                    if (U.forEach(function(j) {
                      j.left ? v[d.get(j.left)] - v[d.get(j.right)] >= 0 ? B++ : Q++ : L[d.get(j.top)] - L[d.get(j.bottom)] >= 0 ? Z++ : at++;
                    }), B > Q && Z > at)
                    ...
                    var B = [], Q = new g(), Z = /* @__PURE__ */ new Set(), at = 0;
                    return U.forEach(function(ct, nt) {
                      if (!Z.has(nt)) {
                        B[at] = [];
                        var tt = nt;
                        for (Q.push(tt), Z.add(tt), B[at].push(tt); Q.length != 0; ) {
                          tt = Q.shift();
                          var j = U.get(tt);
                          j.forEach(function(ut) {
                            Z.has(ut.id) || (Q.push(ut.id), Z.add(ut.id), B[at].push(ut.id));
                          });
                        }
                        at++;
                      }
                      ...
                      (function() {
                        ...
                        if (l.alignmentConstraint.vertical) {
                          for (var U = l.alignmentConstraint.vertical, B = function(tt) {
                            ...
                            ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = J(j).x, U[tt].forEach(function(pt) {
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var Z = l.alignmentConstraint.horizontal, at = function(tt) {
                            ...
                            ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = J(j).y, Z[tt].forEach(function(pt) {
                  ...
                  if (i.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        var B = { x: v[d.get(b.nodeId)], y: L[d.get(b.nodeId)] }, Q = b.position, Z = X(Q, B);
                        Et.x += Z.x, Et.y += Z.y;
                    ...
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Dt = l.alignmentConstraint.vertical, Rt = function(U) {
                          ...
                          var Q = new Set([].concat(f(B)).filter(function(at) {
                            return F.has(at);
                          })), Z = void 0;
                          Q.size > 0 ? Z = v[d.get(Q.values().next().value)] : Z = J(B).x, B.forEach(function(at) {
                      ...
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(U) {
                          ...
                          Q.size > 0 ? Z = L[d.get(Q.values().next().value)] : Z = J(B).y, B.forEach(function(at) {
                    ...
                    l.relativePlacementConstraint && function() {
                      var b = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                        ...
                        if (l.alignmentConstraint.vertical)
                          for (var tt = l.alignmentConstraint.vertical, j = function(yt) {
                            B.set("dummy" + yt, []), tt[yt].forEach(function(wt) {
                              b.set(wt, "dummy" + yt), B.get("dummy" + yt).push(wt), F.has(wt) && ct.add("dummy" + yt);
                            }), Z.set("dummy" + yt, v[d.get(tt[yt][0])]);
                          }, ut = 0; ut < tt.length; ut++)
                            j(ut);
                        if (l.alignmentConstraint.horizontal)
                          for (var Mt = l.alignmentConstraint.horizontal, pt = function(yt) {
                            Q.set("dummy" + yt, []), Mt[yt].forEach(function(wt) {
                              U.set(wt, "dummy" + yt), Q.get("dummy" + yt).push(wt), F.has(wt) && nt.add("dummy" + yt);
                      ...
                      var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt) {
                        W.get(yt).forEach(function(wt) {
                          ...
                          wt.direction == "horizontal" ? (kt = b.get(yt) ? b.get(yt) : yt, b.get(wt.id) ? Bt = { id: b.get(wt.id), gap: wt.gap, direction: wt.direction } : Bt = wt, lt.has(kt) ? lt.get(kt).push(Bt) : lt.set(kt, [Bt]), lt.has(Bt.id) || lt.set(Bt.id, [])) : (kt = U.get(yt) ? U.get(yt) : yt, U.get(wt.id) ? Bt = { id: U.get(wt.id), gap: wt.gap, direction: wt.direction } : Bt = wt, ot.has(kt) ? ot.get(kt).push(Bt) : ot.set(kt, [Bt]), ot.has(Bt.id) || ot.set(Bt.id, []));
                        });
                      }, ft = !0, st = !1, Xt = void 0;
                      try {
                      ...
                      var bt = m(lt), zt = m(ot), St = n(bt), Zt = n(zt), Kt = p(lt), he = p(ot), Jt = [], jt = [];
                      St.forEach(function(Gt, yt) {
                        Jt[yt] = [], Gt.forEach(function(wt) {
                          Kt.get(wt).length == 0 && Jt[yt].push(wt);
                        });
                      ...
                      var _t = O(lt, "horizontal", ct, Z, Jt), Qt = O(ot, "vertical", nt, at, jt), oe = function(yt) {
                      ...
                      var Be = function(yt) {
                        Q.get(yt) ? Q.get(yt).forEach(function(wt) {
                          L[d.get(wt)] = Qt.get(yt);
                        }) : L[d.get(yt)] = Qt.get(yt);
                      }, ce = !0, Ce = !1, Ae = void 0;
                      try {
                        for (var ge = Qt.keys()[Symbol.iterator](), Me; !(ce = (Me = ge.next()).done); ce = !0) {
                          var fe = Me.value;
                          Be(fe);
                        }
                      } catch (Gt) {
          ...
          548: (
            ...
            (a, r, e) => {
              ...
              g.getTopMostNodes = function(t) {
                ...
                var l = new i(), T = /* @__PURE__ */ new Set(), d = [], v = void 0, L = void 0, S = void 0, C = !1, G = 1, K = [], X = [], J = function() {
                  var rt = t.collection();
                  X.push(rt);
                  ...
                  if (s.quality == "draft") {
                    ...
                    try {
                      for (var C = o.nodeIndexes[Symbol.iterator](), G; !(v = (G = C.next()).done); v = !0) {
                        var K = G.value, X = f(K, 2), J = X[0], O = X[1], rt = s.cy.getElementById(J);
                        if (rt) {
                ...
                for (var l = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, d = Number.MAX_SAFE_INTEGER, v = Number.MIN_SAFE_INTEGER, L = void 0, S = void 0, C = void 0, G = void 0, K = t.descendants().not(":parent"), X = K.length, J = 0; J < X; J++) {
                  var O = K[J];
          ...
          816: (
            ...
            (a, r, e) => {
              var f = e(548), i = e(140).CoSELayout, g = e(140).CoSENode, t = e(140).layoutBase.PointD, o = e(140).layoutBase.DimensionD, s = e(140).layoutBase.LayoutConstants, c = e(140).layoutBase.FDLayoutConstants, l = e(140).CoSEConstants, T = function(v, L) {
                var S = v.cy, C = v.eles, G = C.nodes(), K = C.edges(), X = void 0, J = void 0, O = void 0, rt = {};
                v.randomize && (X = L.nodeIndexes, J = L.xCoords, O = L.yCoords);
                var n = function(x) {
                  ...
                  for (var et = k.length, z = 0; z < et; z++) {
                    ...
                    if (w.outerWidth() != null && w.outerHeight() != null)
                      if (Y.randomize)
                        if (!w.isParent())
                          $ = x.add(new g(V.graphManager, new t(J[X.get(w.id())] - _.w / 2, O[X.get(w.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                        else {
                          var ht = f.calcBoundingBox(w, J, O, X);
                          w.intersection(p).length == 0 ? $ = x.add(new g(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(ht.width, ht.height))) : $ = x.add(new g(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(parseFloat(_.w), parseFloat(_.h))));
                        }
                      else
                        $ = x.add(new g(V.graphManager, new t(w.position("x") - _.w / 2, w.position("y") - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                    else
                      $ = x.add(new g(this.graphManager));
                    if ($.id = w.data("id"), $.nodeRepulsion = m(Y.nodeRepulsion, w), $.paddingLeft = parseInt(w.css("padding")), $.paddingTop = parseInt(w.css("padding")), $.paddingRight = parseInt(w.css("padding")), $.paddingBottom = parseInt(w.css("padding")), Y.nodeDimensionsIncludeLabels && ($.labelWidth = w.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).w, $.labelHeight = w.boundingBox({ includeLabels: !0, includeNodes: !1, includeOverlays: !1 }).h, $.labelPosVertical = w.css("text-valign"), $.labelPosHorizontal = w.css("text-halign")), rt[w.data("id")] = $, isNaN($.rect.x) && ($.rect.x = 0), isNaN($.rect.y) && ($.rect.y = 0), H != null && H.length > 0) {
                      var q = void 0;
                  ...
                  for (var Y = 0, et = 0, z = 0; z < V.length; z++) {
                    var w = V[z], H = rt[w.data("source")], $ = rt[w.data("target")];
            ...
            (a, r, e) => {
              ...
              var g = e(658), t = e(548), o = e(657), s = o.spectralLayout, c = e(816), l = c.coseLayout, T = Object.freeze({
                ...
                return f(v, [{
                  key: "run",
                  value: function() {
                    var S = this, C = this.options, G = C.cy, K = C.eles, X = [], J = [], O = void 0, rt = [];
          ...
          657: (
            ...
            (a, r, e) => {
              var f = e(548), i = e(140).layoutBase.Matrix, g = e(140).layoutBase.SVD, t = function(s) {
                var c = s.cy, l = s.eles, T = l.nodes(), d = l.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), C = [], G = [], K = [], X = [], J = [], O = [], rt = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, R = s.samplingType, M = s.nodeSeparation, F = void 0, W = function() {
                  for (var U = 0, B = 0, Q = !1; B < F; ) {
                    U = Math.floor(Math.random() * m), Q = !1;
                    for (var Z = 0; Z < B; Z++)
                      if (X[Z] == U) {
                        Q = !0;
                        break;
                  ...
                  if (Q) {
                    for (var ot = 0; ot < m; ot++)
                      O[ot][B] < J[ot] && (J[ot] = O[ot][B]);
                    for (var Lt = 0; Lt < m; Lt++)
                      J[Lt] > ut && (ut = J[Lt], Mt = Lt);
                  }
                  return Mt;
                }, k = function(U) {
                  var B = void 0;
                  ...
                  for (var U = g.svd(rt), B = U.S, Q = U.U, Z = U.V, at = B[0] * B[0] * B[0], ct = [], nt = 0; nt < F; nt++) {
                    ct[nt] = [];
                    for (var tt = 0; tt < F; tt++)
                      ct[nt][tt] = 0, nt == tt && (ct[nt][tt] = B[nt] / (B[nt] * B[nt] + at / (B[nt] * B[nt])));
                  }
                  n = i.multMat(i.multMat(Z, ct), i.transpose(Q));
                }, Y = function() {
                  for (var U = void 0, B = void 0, Q = [], Z = [], at = [], ct = [], nt = 0; nt < m; nt++)
                    Q[nt] = Math.random(), Z[nt] = Math.random();
                  Q = i.normalize(Q), Z = i.normalize(Z);
                  for (var tt = E, j = E, ut = void 0; ; ) {
                    for (var Mt = 0; Mt < m; Mt++)
                      at[Mt] = Q[Mt];
                    if (Q = i.multGamma(i.multL(i.multGamma(at), O, n)), U = i.dotProduct(at, Q), Q = i.normalize(Q), tt = i.dotProduct(at, Q), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1)
                      break;
                    j = tt;
                  }
                ...
                d.forEach(function(b) {
                  ...
                  var B = 0, Q = U.nodes(":childless")[0].connectedEdges().length;
                  U.nodes(":childless").forEach(function(Z, at) {
                    Z.connectedEdges().length < Q && (Q = Z.connectedEdges().length, B = at);
                ...
                var Nt = function(U) {
                  var B = L.get(U), Q = void 0;
                  v.get(U).forEach(function(Z) {
                    c.getElementById(Z).isParent() ? Q = S.get(Z) : Q = Z, C[B].push(Q), C[L.get(Q)].push(U);
                  });
                }, vt = !0, it = !1, gt = void 0;
                try {
...
var De = {
  ...
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = qe, this.getAccTitle = Je, this.setDiagramTitle = Qe, this.getDiagramTitle = Ke, this.getAccDescription = je, this.setAccDescription = _e, this.clear();
  }
  clear() {
  ...
  await Promise.all(
    D.edges().map(async (r) => {
      ...
      if (g && (Wt(f) ? T += f === "L" ? -G : G : d += f === "T" ? -G : G + 18), c && (Wt(o) ? S += o === "L" ? -G : G : C += o === "T" ? -G : G + 18), !g && ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" && (Wt(f) ? T += f === "L" ? u : -u : d += f === "T" ? u : -u), !c && ((X = A.getNode(t)) == null ? void 0 : X.type) === "junction" && (Wt(o) ? S += o === "L" ? u : -u : C += o === "T" ? u : -u), r[0]._private.rscratch) {
        const J = I.insert("g");
        if (J.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `).attr("class", "edge").attr("id", or(e, t, { prefix: "L" })), i) {
          const O = Wt(f) ? se[f](T, h) : T - a, rt = qt(f) ? se[f](d, h) : d - a;
          J.insert("polygon").attr("points", xe[f](h)).attr("transform", `translate(${O},${rt})`).attr("class", "arrow");
        }
        if (s) {
          const O = Wt(o) ? se[o](S, h) : S - a, rt = qt(o) ? se[o](C, h) : C - a;
          J.insert("polygon").attr("points", xe[o](h)).attr("transform", `translate(${O},${rt})`).attr("class", "arrow");
        }
        if (l) {
...
var Sr = /* @__PURE__ */ dt(async (I, D, A, P) => {
  ...
  await Dr(i, o, N), await xr(t, o, N), Xe(N, o), ke(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Fr = { draw: Sr }, Xr = {
  parser: Ge,
  get db() {
    return new Pe();
