import { v, r as g } from "./embed-entry-BQjeO8mI.js";
import { au as b, av as O } from "./mermaid-VLURNSYL-C7dSNHug.js";
function V(t, e) {
...
var D = Object.create, n = Object.defineProperty, j = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, S = Object.getPrototypeOf, M = Object.prototype.hasOwnProperty, A = (t, e, r) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, E = (t, e) => {
  for (var r in e)
...
class d extends c.Component {
  ...
  load(e) {
    ...
    this.player && this.stop(), (0, y.getSDK)(x, C, N).then((p) => {
...
const T = /* @__PURE__ */ v(f), B = /* @__PURE__ */ V({
  __proto__: null,
  default: T
}, [f]);
export {
