import { a1 as g, r as v } from "./embed-entry-Bpg_TWAa.js";
import { w as b, x as O } from "./page-CxVhG5Fj.js";
function V(t, e) {
...
var D = Object.create, n = Object.defineProperty, w = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, S = Object.getPrototypeOf, M = Object.prototype.hasOwnProperty, A = (t, e, r) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, E = (t, e) => {
  for (var r in e)
  ...
  t
)), x = (t) => h(n({}, "__esModule", { value: !0 }), t), s = (t, e, r) => (A(t, typeof e != "symbol" ? e + "" : e, r), r), _ = {};
E(_, {
  default: () => d
});
var f = x(_), c = L(v), y = b, P = O;
const R = "https://play.vidyard.com/embed/v4.js", C = "VidyardV4", N = "onVidyardAPI";
class d extends c.Component {
  ...
  load(e) {
    ...
    this.player && this.stop(), (0, y.getSDK)(R, C, N).then((p) => {
