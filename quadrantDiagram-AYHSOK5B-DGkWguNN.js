import { _ as o, s as _e, h as Ae, J as ie, I as ke, i as Fe, j as Pe, k as wt, m as At, l as zt, n as ve, P as Ce, $ as D, a3 as Le, q as Ee } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { n as ee } from "./embed-entry-BQjeO8mI.js";
var Vt = function() {
  var t = /* @__PURE__ */ o(function(j, r, l, g) {
    ...
    parse: /* @__PURE__ */ o(function(r) {
      var l = this, g = [0], f = [], _ = [null], e = [], pt = this.table, s = "", mt = 0, Jt = 0, qe = 2, Zt = 1, me = e.slice.call(arguments, 1), E = Object.create(this.lexer), K = { yy: {} };
      ...
      function $t() {
        var B;
        return B = f.pop() || E.lex() || Zt, typeof B != "number" && (B instanceof Array && (f = B, B = f.pop()), B = l.symbols_[B] || B), B;
      }
      o($t, "lex");
      for (var w, J, N, Et, lt = {}, bt, M, te, St; ; ) {
        if (J = g[g.length - 1], this.defaultActions[J] ? N = this.defaultActions[J] : ((w === null || typeof w > "u") && (w = $t()), N = pt[J] && pt[J][w]), typeof N > "u" || !N.length || !N[0]) {
          var Dt = "";
          St = [];
          for (bt in pt[J])
...
` + E.showPosition() + `
Expecting ` + St.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Dt = "Parse error on line " + (mt + 1) + ": Unexpected " + (w == Zt ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Dt, {
            text: E.match,
        ...
        switch (N[0]) {
          case 1:
            g.push(w), _.push(E.yytext), e.push(E.yylloc), g.push(N[1]), w = null, Jt = E.yyleng, s = E.yytext, mt = E.yylineno, Lt = E.yylloc;
            break;
          case 2:
