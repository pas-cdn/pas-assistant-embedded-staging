import { _ as X, aw as F, ax as Y, ay as _, az as H, m as i, k as V, aA as q, aB as z, al as U, aq as $, am as P, ak as K, aC as Q, aD as W, aE as Z } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { i as x, G as B } from "./graph-B4TybZj5.js";
import { l as I } from "./layout-7KSm4f9O.js";
import { c as L } from "./clone-GqhWPzLj.js";
import { m as A } from "./min-BCXVVCvd.js";
function p(e) {
  var t = {
    options: {
...
Parent cluster`,
      ...
      if (i.info("(Insert) Node XXX" + d + ": " + JSON.stringify(t.node(d))), s != null && s.clusterNode) {
        ...
        t.children(d).length > 0 ? (i.trace(
          ...
          "Graph:",
          t
        ), i.trace(D(s.id, t)), f.set(s.id, { id: D(s.id, t), node: s })) : (i.trace("Node - the non recursive path XAX", d, g, t.node(d), r), await U(g, t.node(d), { config: a, dir: r }));
    })
  ...
  let E = 0, { subGraphTitleTotalMargin: y } = $(a);
