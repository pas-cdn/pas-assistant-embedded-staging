import { _ as Y, S as te, C as re, a as ne, b as Ae, c as Re, E as It, d as _t, e as kt, f as At, r as we, g as K, h as v, i as de, j as xe, k as W, l as Te, m as Ke, n as Ne, o as Rt, q as wt, T as Tt, s as Kt, t as ue, v as Nt, w as jt, x as Dt, M as Mt } from "./mermaid-VLURNSYL-D1hVl34T.js";
import { y as An, z as Rn } from "./mermaid-VLURNSYL-D1hVl34T.js";
import { j as b, R as je, r as s, n as Ot } from "./embed-entry-C5E7XbaE.js";
...
function Oe({
  ...
  return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
    /* @__PURE__ */ b.jsx("style", { children: `
        ...
        ` }),
    /* @__PURE__ */ b.jsx("div", { className: "usage-banner", children: /* @__PURE__ */ b.jsxs("div", { className: "banner-content", children: [
      /* @__PURE__ */ b.jsx("div", { className: "banner-message", children: n }),
      o?.primary && /* @__PURE__ */ b.jsx("button", { className: "btn-primary", onClick: o.primary.onClick, children: o.primary.label }),
      r && /* @__PURE__ */ b.jsx("button", { className: "close-btn", onClick: r, title: "Close", children: "×" })
    ] }) })
  ] });
}
var $e = (e) => {
  ...
  render() {
    ...
    if (this.state.hasError) {
      if (this.state.error instanceof ne)
        return /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
          this.props.children,
          this.props.showUsageBanner && /* @__PURE__ */ b.jsx(
            Oe,
            {
...
function Vt({ children: e }) {
  ...
  return /* @__PURE__ */ b.jsx(Le.Provider, { value: r.current, children: e });
}
function Qt({ children: e }) {
  ...
  const E = s.useMemo(() => e, [e]), [k, C] = s.useState([]);
...
var Pe = (e, n) => e.reduce((r, o) => {
  if (o.id !== n) {
    const t = K(v({}, o), { children: Pe(o.children, n) });
    r.push(t);
  }
  return r;
}, []), Ue = (e, n, r) => r ? e.map((o) => o.id === r ? K(v({}, o), { children: [...o.children, n] }) : o.children.length ? K(v({}, o), { children: Ue(o.children, n, r) }) : o) : [...e, n], ze = (e, n) => n === 0 ? (e + 1).toString() : n === 1 ? String.fromCharCode(65 + e) : n === 2 ? String.fromCharCode(97 + e) : "-", Be = (e, n = "", r = 0) => {
...
function rn({
  ...
  if (i) {
    const E = i.stateRenderId === t, k = E && c && (!i.runId || i.runId === "pending");
    return {
      canRender: E,
      action: E ? "existing" : "block",
  ...
  const p = c ?? "pending", f = Object.entries(e).find(
    ([, E]) => {
      var k;
      return E.stateRenderId === t && ((k = E.runId) != null ? k : "pending") === p && xe(Ie(E.stateSnapshot)) === xe(Ie(r));
    }
  ), g = f?.[1], x = f?.[0];
...
function sn({
  ...
  var x, E, k, C, y, I;
  const m = p ? (x = [...p].reverse().find((w) => w.role === "assistant")) == null ? void 0 : x.id : void 0, _ = t !== void 0 ? g.byStateRenderAndRun[`${t}::latest`] : void 0, h = p ? p.findIndex((w) => w.id === e) : -1, j = h >= 0 && p ? (E = p[h]) == null ? void 0 : E.role : void 0;
  let R;
  if (h > 0 && p) {
  ...
  let S = B ?? g.byMessageId[e];
  S === void 0 && A && g.byStateRenderAndRun[A] !== void 0 && (S = g.byStateRenderAndRun[A]), S === void 0 && t && R && g.byStateRenderAndRun[`${t}::pending:${R}`] !== void 0 && (S = g.byStateRenderAndRun[`${t}::pending:${R}`]), S === void 0 && !o && t && j !== "assistant" && (l !== void 0 || i && Object.keys(i).length > 0) && (S = g.byStateRenderAndRun[`${t}::latest`]);
  const U = f?.locked ? (y = f.stateSnapshot) != null ? y : S : M ? D : (I = f?.stateSnapshot) != null ? I : S;
  return { snapshot: D, hasSnapshotKeys: M, cachedSnapshot: S, allowEmptySnapshot: P, snapshotForClaim: U };
}
...
function an({
  ...
  if (s.useEffect(() => () => {
    ...
    if (O?.stateSnapshot && Object.keys(O.stateSnapshot).length > 0) {
      const G = v({}, (A = C[Q]) != null ? A : {}), se = `${O.stateRenderId}::${(S = O.runId) != null ? S : "pending"}`;
      G[se] = O.stateSnapshot, G[`${O.stateRenderId}::latest`] = O.stateSnapshot, C[Q] = G;
      const Z = v({}, (U = C[H]) != null ? U : {});
      Z[r.id] = {
  ...
  if (P.action === "block")
    return { canRender: !1 };
  if (P.updateRunId && i.current[r.id] && (i.current[r.id].runId = P.updateRunId), P.nextClaim && (i.current[r.id] = P.nextClaim), P.lockOthers && Object.entries(i.current).forEach(([A, S]) => {
    A !== r.id && S.stateRenderId === n && (S.locked = !0);
  }), R && !R.locked && l?.length) {
    const A = l.findIndex((S) => S.id === r.id);
  ...
  if ($ && (t || L || D) && (!i.current[r.id].locked || B)) {
    if (!i.current[r.id].locked || B) {
      ...
      const A = v({}, (g = C[Q]) != null ? g : {}), S = `${n}::${h}`;
      A[S] = $, A[`${n}::latest`] = $, C[Q] = A;
      const U = v({}, (x = C[H]) != null ? x : {});
    ...
    const S = v({}, (E = C[Q]) != null ? E : {}), U = `${n}::${h}`;
    S[U] = M, S[`${n}::latest`] = M, C[Q] = S;
    const w = v({}, (k = C[H]) != null ? k : {});
...
function un(e, n) {
  ...
  const x = s.useCallback(
    ...
    [c, p, e]
  ), E = s.useMemo(() => x(t.id), [x, t.id]), k = E?.[0], C = E?.[1], y = K(v({}, t), {
...
function In(e) {
  ...
  const t = q(o.showDevConsole), c = q(o.enableInspector), l = o.publicApiKey || o.publicLicenseKey, i = s.useMemo(() => [{ render: dn }], []);
  return /* @__PURE__ */ b.jsx(Tt, { enabled: t, children: /* @__PURE__ */ b.jsx(zt, { publicApiKey: l, showUsageBanner: t, children: /* @__PURE__ */ b.jsx(pn, { threadId: o.threadId, children: /* @__PURE__ */ b.jsx(
    Kt,
    K(v({}, o), {
      showDevConsole: c,
      renderCustomMessages: i,
      useSingleEndpoint: !0,
      children: /* @__PURE__ */ b.jsx(bn, K(v({}, o), { children: r }))
    })
  ) }) }) });
}
function vn() {
...
function bn(e) {
  ...
  const c = t.publicLicenseKey || t.publicApiKey, l = t.runtimeUrl || Lt, [i, p] = s.useState({}), [f, g] = s.useState(/* @__PURE__ */ new Map()), x = s.useRef({
    actions: {},
    coAgentStateRenders: {}
  }), { addElement: E, removeElement: k, printTree: C, getAllElements: y } = Xt(), [I, m] = s.useState(!1), [_, h] = s.useState(""), [j, R] = s.useState({}), [$, L] = s.useState({}), [D, M] = s.useState([]), {
    addElement: P,
    removeElement: V,
    allElements: B
  } = Zt(), A = s.useCallback((a, u) => {
    p((d) => K(v({}, d), {
      [a]: u
    }));
  }, []), S = s.useCallback((a) => {
...
${T}`;
    ...
    [k]
  ), G = s.useCallback(() => y(), [y]), se = s.useCallback(
  ...
  s.useMemo(() => {
    const a = Object.values(j || {}).reduce((u, d) => d.status === "authenticated" && d.authHeaders ? v(v({}, u), Object.entries(d.authHeaders).reduce(
      (T, [N, z]) => K(v({}, T), {
        [N.startsWith("X-Custom-") ? N : `X-Custom-${N}`]: z
      }),
      {}
    )) : u, {});
    return v(v(v({}, F.headers || {}), F.publicApiKey ? { [Me]: F.publicApiKey } : {}), a);
  }, [F.headers, F.publicApiKey, j]);
  const [oe, he] = s.useState({}), Ge = s.useCallback((a) => {
    he((u) => v(v({}, u), a));
  }, []), Xe = s.useCallback((a) => {
    he((u) => {
      const d = u, { [a]: T } = d;
  ...
  const Je = s.useCallback(
    ...
    [F.publicApiKey]
  ), [qe, ee] = s.useState({}), Ze = s.useCallback(
    (a, u) => {
      ee((d) => K(v({}, d), { [a]: u }));
    },
    [ee]
    ...
    [ee]
  ), [tt, Sn] = s.useState([]), [nt, ge] = s.useState({}), ae = s.useRef({}), rt = s.useCallback(
    (a) => {
  ...
  const [st, ce] = s.useState(ve);
  s.useEffect(() => {
    t.agent ? ce({
      agentName: t.agent
    }) : ce(null);
  }, [t.agent]);
  const { threadId: be, setThreadId: ot } = hn(), it = s.useCallback(
    (a) => {
      if (t.threadId)
    ...
    [t.threadId]
  ), [at, ct] = s.useState(null), lt = s.useRef(null), me = q(t.showDevConsole), [ut, Ce] = s.useState({}), dt = s.useCallback((a) => {
    Ce((u) => {
      var d;
      return a == null || !a.id ? u : K(v({}, u), {
        [a.id]: v(v({}, (d = u[a.id]) != null ? d : {}), a)
      });
    });
  }, []), pt = s.useCallback((a) => {
    Ce((u) => {
  ...
  }, []), [ht, Ee] = s.useState({}), ft = s.useCallback((a) => {
    Ee((u) => {
    ...
    (a, u, d) => {
      Ee((T) => {
        ...
        return K(v({}, T), {
          [a]: N.map(
            (z) => z.eventId === u ? K(v({}, z), { event: K(v({}, z.event), { response: d }) }) : z
          )
        });
      });
    },
    []
  ), vt = s.useMemo(() => o, [o]), [X, Se] = s.useState(null), bt = s.useMemo(() => {
    var a;
  ...
  }, []), yt = s.useMemo(() => () => /* @__PURE__ */ b.jsx(b.Fragment, { children: Array.from(f.entries()).map(([a, u]) => {
    const d = u.component;
    return /* @__PURE__ */ b.jsx(d, { action: u.action }, a);
  }) }), [f]);
  return /* @__PURE__ */ b.jsx(
    Nt,
    {
      ...
      children: /* @__PURE__ */ b.jsxs(
        jt.Provider,
        {
          value: {
            ...
            setAction: A,
            removeAction: S,
            setRegisteredActions: St,
            removeRegisteredAction: xt,
            getContextString: U,
            addContext: w,
            removeContext: O,
            getAllContext: G,
            getDocumentsContext: Z,
            addDocumentContext: Qe,
            removeDocumentContext: Ye,
            copilotApiConfig: F,
            isLoading: I,
            setIsLoading: m,
            chatSuggestionConfiguration: qe,
            addChatSuggestionConfiguration: Ze,
            ...
            setInternalErrorHandler: Ge,
            removeInternalErrorHandler: Xe
          },
          children: [
            /* @__PURE__ */ b.jsx(gn, {}),
            /* @__PURE__ */ b.jsx(vn, {}),
            /* @__PURE__ */ b.jsxs(cn, { children: [
              /* @__PURE__ */ b.jsx(Vt, { children: /* @__PURE__ */ b.jsxs(Qt, { children: [
                vt,
                /* @__PURE__ */ b.jsx(yt, {})
              ] }) }),
              X && me && /* @__PURE__ */ b.jsx(
