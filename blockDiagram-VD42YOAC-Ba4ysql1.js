import { g as de } from "./chunk-FMBD7UC4-DiZrDO7E.js";
import { _ as d, Z as st, l as R, n as ge, m, P as ue, S as pe, k as z, an as fe, a9 as xe, ao as G, ap as Ht, aq as ye, H as et, y as be, ar as we, as as yt, q as bt, at as me } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { c as Le } from "./clone-GqhWPzLj.js";
import { G as Se } from "./graph-B4TybZj5.js";
import { c as ve } from "./channel-s2nKIf05.js";
import { q as Ee, u as _e } from "./embed-entry-BQjeO8mI.js";
var wt = function() {
...
wt.parser = wt;
var ke = wt, V = /* @__PURE__ */ new Map(), Et = [], mt = /* @__PURE__ */ new Map(), It = "color", Bt = "fill", De = "bgFill", Kt = ",", Ne = z(), ot = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ d((e) => be.sanitizeText(e, Ne), "sanitizeText"), Ce = /* @__PURE__ */ d(function(e, t = "") {
  let a = ot.get(e);
...
var Ot = 0, Re = /* @__PURE__ */ d(() => (Ot++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Ot), "generateId"), ze = /* @__PURE__ */ d((e) => {
  ...
  const a = ve, i = a(e, "r"), l = a(e, "g"), s = a(e, "b");
  return pe(i, l, s, t);
  ...
  ${de()}
`, "getStyles"), Ve = je, Ze = /* @__PURE__ */ d((e, t, a, i) => {
  t.forEach((l) => {
    sr[l](e, a, i);
  });
  ...
  cross: rr,
  barb: ar
}, ir = Ze, Pt, Yt, B = ((Yt = (Pt = z()) == null ? void 0 : Pt.block) == null ? void 0 : Yt.padding) ?? 8;
function Zt(e, t) {
...
function kt(e, t) {
  ...
  e.children.length > 0) {
    ...
    for (const c of e.children) {
      ...
      if (!c.size)
        continue;
      const { width: f, height: A } = c.size, { px: O, py: X } = Zt(a, p);
...
var lr = /* @__PURE__ */ d(async (e, t, a, i) => {
  ...
  const a = z(), i = G(a.flowchart.htmlLabels), l = t.labelType === "markdown" ? Ht(
    e,
    t.label,
    {
      style: t.labelStyle,
...
var dr = /* @__PURE__ */ d((e, t) => {
  ...
  const i = z(), { subGraphTitleTotalMargin: l } = ye(i);
  if (e.label) {
    const s = St[e.id];
    let r = e.x, n = e.y;
    if (a) {
  ...
  const { x: L, y: E } = fe(a), D = Ee().x(L).y(E).curve(b);
  let v;
  switch (a.thickness) {
    case "normal":
...
var Lr = /* @__PURE__ */ d((e, t) => {
  ...
  const l = z();
  let s;
  const r = t.useHtmlLabels || G(l.flowchart.htmlLabels);
...
var vr = /* @__PURE__ */ d(async (e, t) => {
  ...
  const { shapeSvg: a, bbox: i } = await F(e, t, void 0, !0), l = 2, s = i.height + 2 * t.padding, r = s / l, n = i.width + 2 * r + t.padding, o = xr(t.directions, i, t), u = Z(a, n, s, o);
  return u.attr("style", t.style), I(t, u), t.intersect = function(h) {
    return C.polygon(t, o, h);
  }, a;
  ...
  return Z(a, l, s, r).attr("style", t.style), t.width = l + s, t.height = s, t.intersect = function(o) {
...
function Nt(e, t, a = !1) {
  ...
  const o = me((i == null ? void 0 : i.styles) ?? []), u = i.label, h = i.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return {
...
}, "getClasses"), Zr = /* @__PURE__ */ d(async function(e, t, a, i) {
