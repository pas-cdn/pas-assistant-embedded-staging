import { v as U, r as I } from "./embed-entry-BQjeO8mI.js";
import { au as L, av as M } from "./mermaid-VLURNSYL-C7dSNHug.js";
function Y(a, e) {
...
var k = Object.create, u = Object.defineProperty, N = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, V = Object.getPrototypeOf, B = Object.prototype.hasOwnProperty, x = (a, e, t) => e in a ? u(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t, K = (a, e) => {
  ...
  a
)), H = (a) => T(u({}, "__esModule", { value: !0 }), a), s = (a, e, t) => (x(a, typeof e != "symbol" ? e + "" : e, t), t), w = {};
K(w, {
  default: () => O
});
var S = H(w), m = F(I), p = L, D = M;
const G = "https://www.youtube.com/iframe_api", v = "YT", z = "onYouTubeIframeAPIReady", f = /[?&](?:list|channel)=([a-zA-Z0-9_-]+)/, b = /user\/([a-zA-Z0-9_-]+)\/?/, Q = /youtube-nocookie\.com/, Z = "https://www.youtube-nocookie.com";
class O extends m.Component {
  constructor() {
    super(...arguments), s(this, "callPlayer", p.callPlayer), s(this, "parsePlaylist", (e) => {
      ...
      const { data: t } = e, { onPlay: o, onPause: r, onBuffer: n, onBufferEnd: P, onEnded: _, onReady: g, loop: y, config: { playerVars: l, onUnstarted: d } } = this.props, { UNSTARTED: h, PLAYING: c, PAUSED: i, BUFFERING: E, ENDED: A, CUED: C } = window[v].PlayerState;
  ...
  load(e, t) {
    ...
    (0, p.getSDK)(G, v, z, (c) => c.loaded).then((c) => {
...
const J = /* @__PURE__ */ U(S), W = /* @__PURE__ */ Y({
  __proto__: null,
  default: J
}, [S]);
export {
