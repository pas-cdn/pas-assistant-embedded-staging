import { s as R, a as W, S as N } from "./chunk-DI55MBZ5-DhI0l8Je.js";
import { _ as f, k as t, l as H, m as S, n as P, y as z, a9 as _, H as U } from "./mermaid-VLURNSYL-C7dSNHug.js";
import { G as C } from "./graph-B4TybZj5.js";
import { l as F } from "./layout-7KSm4f9O.js";
import { q as O, u as J } from "./embed-entry-BQjeO8mI.js";
var X = /* @__PURE__ */ f((e) => e.append("circle").attr("class", "start-state").attr("r", t().state.sizeUnit).attr("cx", t().state.padding + t().state.sizeUnit).attr("cy", t().state.padding + t().state.sizeUnit), "drawStartState"), D = /* @__PURE__ */ f((e) => e.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", t().state.textHeight).attr("class", "divider").attr("x2", t().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider"), Y = /* @__PURE__ */ f((e, i) => {
  ...
  const n = i.points, l = O().x(function(s) {
    return s.x;
  }).y(function(s) {
    return s.y;
  }).curve(J), x = e.append("path").attr("d", l(n)).attr("id", "edge" + A).attr("class", "transition");
  let a = "";
  if (t().state.arrowMarkerAbsolute && (a = _(!0)), x.attr(
    "marker-end",
    "url(" + a + "#" + c(N.relationType.DEPENDENCY) + "End)"
  ), d.title !== void 0) {
    const s = e.append("g").attr("class", "stateLabel"), { x: w, y: p } = U.calcLabelPosition(i.points), o = z.getRows(d.title);
    let g = 0;
    const B = [];
    let m = 0, E = 0;
  ...
  }), F(a), S.debug("Graph after layout", a.nodes());
  const m = i.node();
