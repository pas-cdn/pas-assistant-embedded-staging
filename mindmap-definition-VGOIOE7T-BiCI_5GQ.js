import { g as ae } from "./chunk-55IACEB6-CTiYwyPT.js";
import { s as oe } from "./chunk-QN33PNHL-CPotuwg0.js";
import { _ as c, m as C, F as ce, G as le, $ as V, k as W, q as B, ai as he, aj as ge, ae as de, af as ue, ag as pe } from "./mermaid-VLURNSYL-C7dSNHug.js";
var X = function() {
  var r = /* @__PURE__ */ c(function(x, s, t, a) {
    ...
    parse: /* @__PURE__ */ c(function(s) {
      ...
      c(Z, "lex");
      for (var b, T, k, H, O = {}, F, D, ee, U; ; ) {
        if (T = a[a.length - 1], this.defaultActions[T] ? k = this.defaultActions[T] : ((b === null || typeof b > "u") && (b = Z()), k = w[T] && w[T][b]), typeof k > "u" || !k.length || !k[0]) {
          var z = "";
          U = [];
          for (F in w[T])
...
` + f.showPosition() + `
Expecting ` + U.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : z = "Parse error on line " + (M + 1) + ": Unexpected " + (b == Q ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(z, {
            text: f.match,
        ...
        switch (k[0]) {
          case 1:
            a.push(b), d.push(f.yytext), n.push(f.yylloc), a.push(k[1]), b = null, K = f.yyleng, g = f.yytext, M = f.yylineno, $ = f.yylloc;
            break;
          case 2:
            if (D = this.productions_[k[1]][1], O.$ = d[d.length - D], O._$ = {
              ...
              return H;
            D && (a = a.slice(0, -1 * D * 2), d = d.slice(0, -1 * D), n = n.slice(0, -1 * D)), a.push(this.productions_[k[1]][0]), d.push(O.$), n.push(O._$), ee = w[a[a.length - 2]][a[a.length - 1]], a.push(ee);
            break;
          case 3:
            return !0;
        }
...
var fe = X, L = {
  ...
  decorateNode(e) {
    if (!e)
      return;
    const i = W(), l = this.nodes[this.nodes.length - 1];
   ...
   */
  getData() {
    const e = this.getMindmap(), i = W(), p = he().layout !== void 0, h = i;
