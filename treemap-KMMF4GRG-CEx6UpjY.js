...
var Wd = (t, e, n) => e in t ? Vd(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var pt = (t, e, n) => Wd(t, typeof e != "symbol" ? e + "" : e, n);
import { m as st, f as zd, d as qd } from "./min-BCXVVCvd.js";
import { b as Yd, l as Xd, d as Jd, m as Zd, r as Po, n as Es } from "./_baseUniq-BU3V84HH.js";
import { bz as Qd } from "./mermaid-VLURNSYL-C7dSNHug.js";
function eh(t, e) {
  return Yd(st(t, e));
}
function th(t, e) {
  return t && t.length ? Xd(t, Jd(e)) : [];
}
function le(t) {
...
class te {
  ...
  join(e = ",") {
    ...
    let r = "", i, s = !1;
    do
      i = n.next(), i.done || (s && (r += e), r += rh(i.value)), s = !0;
    while (!i.done);
    return r;
  }
  indexOf(e, n = 0) {
...
function ta(t) {
  return new Ka(t, (e) => yr(e) ? e.content : [], { includeRoot: !0 });
}
function sh(t, e) {
  for (; t.container; )
...
function Mo(t, e) {
  return yc(t) && e.includes(t.tokenType.name);
}
function ch(t, e = !0) {
  for (; t.container; ) {
    const n = t.container;
...
const Dr = "AbstractRule", Fr = "AbstractType", $s = "Condition", Do = "TypeDefinition", xs = "ValueLiteral", On = "AbstractElement";
function fh(t) {
  return F.isInstance(t, On);
}
const Gr = "ArrayLiteral", Ur = "ArrayType", Ln = "BooleanLiteral";
function dh(t) {
...
const Br = "Grammar", Ss = "GrammarImport", Dn = "InferredType";
function Rc(t) {
...
const Is = "NamedArgument", Gn = "Negation";
function mh(t) {
  return F.isInstance(t, Gn);
}
const jr = "NumberLiteral", Kr = "Parameter", Un = "ParameterReference";
function gh(t) {
...
const Hr = "ReferenceType", ai = "ReturnType";
function yh(t) {
...
const Vr = "StringLiteral", zt = "TerminalRule";
function Ft(t) {
  return F.isInstance(t, zt);
}
const Kn = "Type";
function Ec(t) {
  return F.isInstance(t, Kn);
}
const ks = "TypeAttribute", Wr = "UnionType", Hn = "Action";
function zi(t) {
...
class Sc extends gc {
  getAllTypes() {
    return [On, Dr, Fr, Hn, Vn, Gr, Ur, Wn, Ln, zn, $s, Pn, qn, Mn, Yn, Br, Ss, Xn, Dn, Fn, Jn, Is, Zn, Gn, jr, Kr, Un, Bn, Hr, Qn, ai, er, jn, Vr, tr, nr, zt, rr, Kn, ks, Do, Wr, ir, sr, xs, ar];
  }
  computeIsSubtype(e, n) {
    switch (e) {
      ...
      case jr:
      case Vr:
        return this.isSubtype(xs, n);
      case Ur:
      case Hr:
      case jn:
      case Wr:
        return this.isSubtype(Do, n);
      case Ln:
        return this.isSubtype($s, n) || this.isSubtype(xs, n);
      case Pn:
      case Mn:
      case Gn:
      case Un:
        return this.isSubtype($s, n);
      case Dn:
      case Fn:
      case Kn:
        return this.isSubtype(Fr, n);
      case Bn:
        return this.isSubtype(Dr, n) || this.isSubtype(Fr, n);
      case zt:
...
function Ir(t, e) {
  ...
  return new Ka(t, (n) => Wa(n, e));
}
function Yt(t, e) {
  if (!t)
    throw new Error("Root node must be an AstNode.");
  return new Ka(t, (n) => Wa(n, e), { includeRoot: !0 });
}
function Fo(t, e) {
  var n;
  if (!e)
...
function wh(t, e) {
  ...
  for (const i of n.properties)
    i.defaultValue !== void 0 && r[i.name] === void 0 && (r[i.name] = kc(i.defaultValue));
}
function kc(t) {
  return Array.isArray(t) ? [...t.map(kc)] : t;
}
function N(t) {
...
class Cc {
  ...
  atom() {
    ...
    if (e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), Wt(e))
...
`:
  ...
  characterClass() {
    ...
    for (this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), n = !0); this.isClassAtom(); ) {
      ...
      if (r.type, Go(r) && this.isRangeDash()) {
        this.consumeChar("-");
...
`:
  ...
  isDigit() {
    return zr.test(this.peekChar(0));
  }
  isClassAtom(e = 0) {
...
function Mh(t) {
  try {
    return typeof t == "string" && (t = new RegExp(t)), t = t.toString(), ws.reset(t), ws.visit(Lh.pattern(t)), ws.multiline;
  } catch {
    return !1;
  }
}
...
function ia(t) {
  ...
  return Dh.some((n) => e.test(n));
}
function Xi(t) {
  return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
}
function Fh(t) {
  return Array.prototype.map.call(t, (e) => /\w/.test(e) ? `[${e.toLowerCase()}${e.toUpperCase()}]` : Xi(e)).join("");
}
function Gh(t, e) {
  const n = Uh(t), r = e.match(n);
...
function jh(t) {
  return t.rules.filter((e) => Ft(e) && e.hidden);
}
function wc(t, e) {
  const n = /* @__PURE__ */ new Set(), r = Bh(t);
  if (!r)
    return new Set(t.rules);
  const i = [r].concat(jh(t));
  for (const a of i)
    Nc(a, n, e);
  const s = /* @__PURE__ */ new Set();
  for (const a of t.rules)
    (n.has(a.name) || Ft(a) && a.hidden) && s.add(a);
  return s;
}
function Nc(t, e, n) {
  e.add(t.name), Ir(t).forEach((r) => {
    if (Ot(r) || n) {
      const i = r.rule.ref;
      i && !e.has(i.name) && Nc(i, e, n);
    }
  });
}
function Kh(t) {
  if (t.terminal)
    return t.terminal;
  if (t.type.ref) {
    const e = bc(t.type.ref);
    return e == null ? void 0 : e.terminal;
  }
}
function Hh(t) {
  return t.hidden && !ia(Xa(t));
}
function Vh(t, e) {
  return !t || !e ? [] : za(t, e, t.astNode, !0);
}
function _c(t, e, n) {
  if (!t || !e)
    return;
  const r = za(t, e, t.astNode, !0);
  if (r.length !== 0)
    return n !== void 0 ? n = Math.max(0, Math.min(n, r.length - 1)) : n = 0, r[n];
}
function za(t, e, n, r) {
  if (!r) {
    const i = qi(t.grammarSource, _t);
    if (i && i.feature === e)
      return [t];
  }
  return yr(t) && t.astNode === n ? t.content.flatMap((i) => za(i, e, n, !1)) : [];
}
function Wh(t, e, n) {
  if (!t)
    return;
  const r = zh(t, e, t == null ? void 0 : t.astNode);
  if (r.length !== 0)
    return n !== void 0 ? n = Math.max(0, Math.min(n, r.length - 1)) : n = 0, r[n];
}
function zh(t, e, n) {
  if (t.astNode !== n)
    return [];
  if (bt(t.grammarSource) && t.grammarSource.value === e)
    return [t];
  const r = ta(t).iterator();
  let i;
  const s = [];
  do
    if (i = r.next(), !i.done) {
      const a = i.value;
      a.astNode === n ? bt(a.grammarSource) && a.grammarSource.value === e && s.push(a) : r.prune();
    }
  while (!i.done);
  return s;
}
...
function bc(t) {
  let e = t;
  return Rc(e) && (zi(e.$container) ? e = e.$container.$container : _e(e.$container) ? e = e.$container : Sr(e.$container)), Oc(t, e, /* @__PURE__ */ new Map());
}
function Oc(t, e, n) {
  var r;
  function i(s, a) {
    let o;
    return qi(s, _t) || (o = Oc(a, a, n)), n.set(t, o), o;
  }
  if (n.has(t))
    return n.get(t);
  n.set(t, void 0);
  for (const s of Ir(e)) {
    if (_t(s) && s.feature.toLowerCase() === "name")
      return n.set(t, s), s;
    if (Ot(s) && _e(s.rule.ref))
      return i(s, s.rule.ref);
    if (Th(s) && (!((r = s.typeRef) === null || r === void 0) && r.ref))
      return i(s, s.typeRef.ref);
  }
}
function Lc(t) {
  return Pc(t, /* @__PURE__ */ new Set());
}
function Pc(t, e) {
  if (e.has(t))
    return !0;
  ...
  for (const n of Ir(t))
    if (Ot(n)) {
      if (!n.rule.ref || _e(n.rule.ref) && !Pc(n.rule.ref, e))
        return !1;
    } else {
      if (_t(n))
        return !1;
...
function Ya(t) {
  var e;
  if (_e(t))
    return Lc(t) ? t.name : (e = qa(t)) !== null && e !== void 0 ? e : t.name;
  if (Ac(t) || Ec(t) || yh(t))
    return t.name;
  if (zi(t)) {
    const n = Yh(t);
...
function Yh(t) {
  ...
  if (!((e = t.type) === null || e === void 0) && e.ref)
    return Ya(t.type.ref);
}
function Xh(t) {
  var e, n, r;
  return Ft(t) ? (n = (e = t.type) === null || e === void 0 ? void 0 : e.name) !== null && n !== void 0 ? n : "string" : (r = qa(t)) !== null && r !== void 0 ? r : t.name;
}
function Xa(t) {
  const e = {
    s: !1,
...
function Qh(t) {
  return at(`${Ja}*?${Sn(t.terminal)}`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead
  });
}
function ep(t) {
  return at(`(?!${Sn(t.terminal)})${Ja}*?`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead
  });
}
function tp(t) {
  return t.right ? at(`[${Ns(t.left)}-${Ns(t.right)}]`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    wrap: !1
  }) : at(Ns(t.left), {
...
function np(t) {
  ...
  for (const r of n.rules)
    Ft(r) && Hh(r) && Mh(Xa(r)) && e.push(r.name);
  return {
    multilineCommentRules: e,
    nameRegexp: lh
  };
}
var Mc = typeof global == "object" && global && global.Object === Object && global, rp = typeof self == "object" && self && self.Object === Object && self, Ye = Mc || rp || Function("return this")(), be = Ye.Symbol, Dc = Object.prototype, ip = Dc.hasOwnProperty, sp = Dc.toString, Nn = be ? be.toStringTag : void 0;
function ap(t) {
  var e = ip.call(t, Nn), n = t[Nn];
  try {
    t[Nn] = void 0;
    var r = !0;
  } catch {
...
var cp = "[object Null]", fp = "[object Undefined]", Bo = be ? be.toStringTag : void 0;
function At(t) {
  return t == null ? t === void 0 ? fp : cp : Bo && Bo in Object(t) ? ap(t) : up(t);
}
function Be(t) {
  return t != null && typeof t == "object";
}
var dp = "[object Symbol]";
function Ji(t) {
  return typeof t == "symbol" || Be(t) && At(t) == dp;
}
function Zi(t, e) {
...
var P = Array.isArray, jo = be ? be.prototype : void 0, Ko = jo ? jo.toString : void 0;
function Fc(t) {
  if (typeof t == "string")
    return t;
  if (P(t))
...
var hp = /\s/;
function pp(t) {
  for (var e = t.length; e-- && hp.test(t.charAt(e)); )
    ;
  return e;
}
var mp = /^\s+/;
function gp(t) {
  return t && t.slice(0, pp(t) + 1).replace(mp, "");
}
function Oe(t) {
  var e = typeof t;
  return t != null && (e == "object" || e == "function");
}
var Ho = NaN, yp = /^[-+]0x[0-9a-f]+$/i, Tp = /^0b[01]+$/i, vp = /^0o[0-7]+$/i, Rp = parseInt;
function Ap(t) {
  if (typeof t == "number")
    return t;
  if (Ji(t))
  ...
  t = gp(t);
  var n = Tp.test(t);
  return n || vp.test(t) ? Rp(t.slice(2), n ? 2 : 8) : yp.test(t) ? Ho : +t;
}
var Vo = 1 / 0, Ep = 17976931348623157e292;
function $p(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = Ap(t), t === Vo || t === -Vo) {
...
var xp = "[object AsyncFunction]", Sp = "[object Function]", Ip = "[object GeneratorFunction]", kp = "[object Proxy]";
function ct(t) {
  if (!Oe(t))
    return !1;
  var e = At(t);
  return e == Sp || e == Ip || e == xp || e == kp;
}
var _s = Ye["__core-js_shared__"], Wo = function() {
...
var wp = Function.prototype, Np = wp.toString;
function Gt(t) {
  if (t != null) {
    try {
      return Np.call(t);
...
var _p = /[\\^$.*+?()[\]{}|]/g, bp = /^\[object .+?Constructor\]$/, Op = Function.prototype, Lp = Object.prototype, Pp = Op.toString, Mp = Lp.hasOwnProperty, Dp = RegExp(
  "^" + Pp.call(Mp).replace(_p, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Fp(t) {
  if (!Oe(t) || Cp(t))
    return !1;
...
function Ut(t, e) {
  var n = Gp(t, e);
  return Fp(n) ? n : void 0;
}
var sa = Ut(Ye, "WeakMap"), zo = Object.create, Up = /* @__PURE__ */ function() {
  function t() {
  }
  return function(e) {
    if (!Oe(e))
...
function Za(t, e, n) {
  return e === e ? Jp(t, e, n) : Uc(t, Xp, n);
}
function Bc(t, e) {
  var n = t == null ? 0 : t.length;
  return !!n && Za(t, e, 0) > -1;
}
var Zp = 9007199254740991, Qp = /^(?:0|[1-9]\d*)$/;
function es(t, e) {
  var n = typeof t;
  return e = e ?? Zp, !!e && (n == "number" || n != "symbol" && Qp.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
function Qa(t, e, n) {
...
function ts(t, e, n) {
  var r = t[e];
  (!(tm.call(t, e) && kr(r, n)) || n === void 0 && !(e in t)) && Qa(t, e, n);
}
function Cr(t, e, n, r) {
  var i = !n;
  n || (n = {});
  for (var s = -1, a = e.length; ++s < a; ) {
    var o = e[s], l = void 0;
    l === void 0 && (l = t[o]), i ? Qa(n, o, l) : ts(n, o, l);
  }
  return n;
}
var qo = Math.max;
function nm(t, e, n) {
  return e = qo(e === void 0 ? t.length - 1 : e, 0), function() {
    for (var r = arguments, i = -1, s = qo(r.length - e, 0), a = Array(s); ++i < s; )
      a[i] = r[e + i];
    i = -1;
    for (var o = Array(e + 1); ++i < e; )
      o[i] = r[i];
    return o[e] = n(a), Bp(t, this, o);
  };
}
function eo(t, e) {
  return Yp(nm(t, e, gn), t + "");
}
...
function Xe(t) {
  return t != null && to(t.length) && !ct(t);
}
function jc(t, e, n) {
  if (!Oe(n))
    return !1;
  var r = typeof e;
  return (r == "number" ? Xe(n) && es(e, n.length) : r == "string" && e in n) ? kr(n[e], t) : !1;
}
function im(t) {
  return eo(function(e, n) {
    var r = -1, i = n.length, s = i > 1 ? n[i - 1] : void 0, a = i > 2 ? n[2] : void 0;
    for (s = t.length > 3 && typeof s == "function" ? (i--, s) : void 0, a && jc(n[0], n[1], a) && (s = i < 3 ? void 0 : s, i = 1), e = Object(e); ++r < i; ) {
      var o = n[r];
      o && t(e, o, r, s);
    }
    return e;
...
var Kc = Object.prototype, lm = Kc.hasOwnProperty, um = Kc.propertyIsEnumerable, ns = Yo(/* @__PURE__ */ function() {
  return arguments;
}()) ? Yo : function(t) {
  return Be(t) && lm.call(t, "callee") && !um.call(t, "callee");
};
function cm() {
  return !1;
}
var Hc = typeof exports == "object" && exports && !exports.nodeType && exports, Xo = Hc && typeof module == "object" && module && !module.nodeType && module, fm = Xo && Xo.exports === Hc, Jo = fm ? Ye.Buffer : void 0, dm = Jo ? Jo.isBuffer : void 0, Tr = dm || cm, hm = "[object Arguments]", pm = "[object Array]", mm = "[object Boolean]", gm = "[object Date]", ym = "[object Error]", Tm = "[object Function]", vm = "[object Map]", Rm = "[object Number]", Am = "[object Object]", Em = "[object RegExp]", $m = "[object Set]", xm = "[object String]", Sm = "[object WeakMap]", Im = "[object ArrayBuffer]", km = "[object DataView]", Cm = "[object Float32Array]", wm = "[object Float64Array]", Nm = "[object Int8Array]", _m = "[object Int16Array]", bm = "[object Int32Array]", Om = "[object Uint8Array]", Lm = "[object Uint8ClampedArray]", Pm = "[object Uint16Array]", Mm = "[object Uint32Array]", B = {};
B[Cm] = B[wm] = B[Nm] = B[_m] = B[bm] = B[Om] = B[Lm] = B[Pm] = B[Mm] = !0;
B[hm] = B[pm] = B[Im] = B[mm] = B[km] = B[gm] = B[ym] = B[Tm] = B[vm] = B[Rm] = B[Am] = B[Em] = B[$m] = B[xm] = B[Sm] = !1;
function Dm(t) {
  return Be(t) && to(t.length) && !!B[At(t)];
}
function rs(t) {
  return function(e) {
    return t(e);
...
var Vc = typeof exports == "object" && exports && !exports.nodeType && exports, mr = Vc && typeof module == "object" && module && !module.nodeType && module, Fm = mr && mr.exports === Vc, bs = Fm && Mc.process, gt = function() {
  try {
    var t = mr && mr.require && mr.require("util").types;
    return t || bs && bs.binding && bs.binding("util");
  } catch {
  }
}(), Zo = gt && gt.isTypedArray, no = Zo ? rs(Zo) : Dm, Gm = Object.prototype, Um = Gm.hasOwnProperty;
function Wc(t, e) {
  var n = P(t), r = !n && ns(t), i = !n && !r && Tr(t), s = !n && !r && !i && no(t), a = n || r || i || s, o = a ? am(t.length, String) : [], l = o.length;
  for (var u in t)
    (e || Um.call(t, u)) && !(a && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var Bm = zc(Object.keys, Object), jm = Object.prototype, Km = jm.hasOwnProperty;
function qc(t) {
  if (!wr(t))
    return Bm(t);
  var e = [];
  for (var n in Object(t))
    Km.call(t, n) && n != "constructor" && e.push(n);
  return e;
}
function Le(t) {
  return Xe(t) ? Wc(t) : qc(t);
}
var Hm = Object.prototype, Vm = Hm.hasOwnProperty, $e = im(function(t, e) {
  if (wr(e) || Xe(e)) {
    Cr(e, Le(e), t);
    return;
  }
  for (var n in e)
    Vm.call(e, n) && ts(t, n, e[n]);
});
function Wm(t) {
  var e = [];
  if (t != null)
...
function Ym(t) {
  ...
  var e = wr(t), n = [];
  for (var r in t)
    r == "constructor" && (e || !qm.call(t, r)) || n.push(r);
  return n;
}
function ro(t) {
  return Xe(t) ? Wc(t, !0) : Ym(t);
}
var Xm = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Jm = /^\w*$/;
function io(t, e) {
  if (P(t))
    return !1;
  var n = typeof t;
  return n == "number" || n == "symbol" || n == "boolean" || t == null || Ji(t) ? !0 : Jm.test(t) || !Xm.test(t) || e != null && t in Object(e);
}
var vr = Ut(Object, "create");
function Zm() {
...
function ag(t) {
  var e = this.__data__;
  return vr ? e[t] !== void 0 : sg.call(e, t);
}
var og = "__lodash_hash_undefined__";
function lg(t, e) {
  var n = this.__data__;
  return this.size += this.has(t) ? 0 : 1, n[t] = vr && e === void 0 ? og : e, this;
}
function Lt(t) {
...
Lt.prototype.clear = Zm;
Lt.prototype.delete = Qm;
Lt.prototype.get = rg;
Lt.prototype.has = ag;
Lt.prototype.set = lg;
function ug() {
...
ft.prototype.clear = ug;
ft.prototype.delete = dg;
ft.prototype.get = hg;
ft.prototype.has = pg;
ft.prototype.set = mg;
var Rr = Ut(Ye, "Map");
...
function ss(t, e) {
  var n = t.__data__;
  return yg(e) ? n[typeof e == "string" ? "string" : "hash"] : n.map;
}
function Tg(t) {
...
dt.prototype.clear = gg;
dt.prototype.delete = Tg;
dt.prototype.get = vg;
dt.prototype.has = Rg;
dt.prototype.set = Ag;
...
var Sg = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ig = /\\(\\)?/g, kg = xg(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(Sg, function(n, r, i, s) {
    e.push(i ? s.replace(Ig, "$1") : r || n);
  }), e;
});
function Cg(t) {
  return t == null ? "" : Fc(t);
...
var Qo = be ? be.isConcatSpreadable : void 0;
function Ng(t) {
  return P(t) || ns(t) || !!(Qo && t && t[Qo]);
}
function lo(t, e, n, r, i) {
  var s = -1, a = t.length;
  for (n || (n = Ng), i || (i = []); ++s < a; ) {
    var o = t[s];
    n(o) ? oo(i, o) : r || (i[i.length] = o);
  }
  return i;
}
function Ge(t) {
...
var Yc = zc(Object.getPrototypeOf, Object);
function Xc(t, e, n) {
  var r = -1, i = t.length;
...
function Gg(t, e) {
  return t && Cr(e, ro(e), t);
}
var Jc = typeof exports == "object" && exports && !exports.nodeType && exports, el = Jc && typeof module == "object" && module && !module.nodeType && module, Ug = el && el.exports === Jc, tl = Ug ? Ye.Buffer : void 0, nl = tl ? tl.allocUnsafe : void 0;
function Bg(t, e) {
...
var jg = Object.prototype, Kg = jg.propertyIsEnumerable, rl = Object.getOwnPropertySymbols, co = rl ? function(t) {
  return t == null ? [] : (t = Object(t), uo(rl(t), function(e) {
    return Kg.call(t, e);
  }));
} : Zc;
function Hg(t, e) {
...
var Vg = Object.getOwnPropertySymbols, Qc = Vg ? function(t) {
  for (var e = []; t; )
    oo(e, co(t)), t = Yc(t);
  return e;
} : Zc;
...
var oa = Ut(Ye, "DataView"), la = Ut(Ye, "Promise"), Xt = Ut(Ye, "Set"), il = "[object Map]", qg = "[object Object]", sl = "[object Promise]", al = "[object Set]", ol = "[object WeakMap]", ll = "[object DataView]", Yg = Gt(oa), Xg = Gt(Rr), Jg = Gt(la), Zg = Gt(Xt), Qg = Gt(sa), we = At;
(oa && we(new oa(new ArrayBuffer(1))) != ll || Rr && we(new Rr()) != il || la && we(la.resolve()) != sl || Xt && we(new Xt()) != al || sa && we(new sa()) != ol) && (we = function(t) {
  var e = At(t), n = e == qg ? t.constructor : void 0, r = n ? Gt(n) : "";
  if (r)
    switch (r) {
      case Yg:
        return ll;
...
function ny(t) {
  ...
  return e && typeof t[0] == "string" && ty.call(t, "index") && (n.index = t.index, n.input = t.input), n;
}
var Ii = Ye.Uint8Array;
function ry(t) {
...
var sy = /\w*$/;
function ay(t) {
  var e = new t.constructor(t.source, sy.exec(t));
  return e.lastIndex = t.lastIndex, e;
}
var ul = be ? be.prototype : void 0, cl = ul ? ul.valueOf : void 0;
function oy(t) {
  return cl ? Object(cl.call(t)) : {};
}
function ly(t, e) {
  var n = t.buffer;
  return new t.constructor(n, t.byteOffset, t.length);
}
var uy = "[object Boolean]", cy = "[object Date]", fy = "[object Map]", dy = "[object Number]", hy = "[object RegExp]", py = "[object Set]", my = "[object String]", gy = "[object Symbol]", yy = "[object ArrayBuffer]", Ty = "[object DataView]", vy = "[object Float32Array]", Ry = "[object Float64Array]", Ay = "[object Int8Array]", Ey = "[object Int16Array]", $y = "[object Int32Array]", xy = "[object Uint8Array]", Sy = "[object Uint8ClampedArray]", Iy = "[object Uint16Array]", ky = "[object Uint32Array]";
function Cy(t, e, n) {
  var r = t.constructor;
  switch (e) {
    case yy:
...
function wy(t) {
  return typeof t.constructor == "function" && !wr(t) ? Up(Yc(t)) : {};
}
var Ny = "[object Map]";
function _y(t) {
  return Be(t) && we(t) == Ny;
}
var fl = gt && gt.isMap, by = fl ? rs(fl) : _y, Oy = "[object Set]";
function Ly(t) {
  return Be(t) && we(t) == Oy;
}
var dl = gt && gt.isSet, Py = dl ? rs(dl) : Ly, My = 2, tf = "[object Arguments]", Dy = "[object Array]", Fy = "[object Boolean]", Gy = "[object Date]", Uy = "[object Error]", nf = "[object Function]", By = "[object GeneratorFunction]", jy = "[object Map]", Ky = "[object Number]", rf = "[object Object]", Hy = "[object RegExp]", Vy = "[object Set]", Wy = "[object String]", zy = "[object Symbol]", qy = "[object WeakMap]", Yy = "[object ArrayBuffer]", Xy = "[object DataView]", Jy = "[object Float32Array]", Zy = "[object Float64Array]", Qy = "[object Int8Array]", eT = "[object Int16Array]", tT = "[object Int32Array]", nT = "[object Uint8Array]", rT = "[object Uint8ClampedArray]", iT = "[object Uint16Array]", sT = "[object Uint32Array]", G = {};
G[tf] = G[Dy] = G[Yy] = G[Xy] = G[Fy] = G[Gy] = G[Jy] = G[Zy] = G[Qy] = G[eT] = G[tT] = G[jy] = G[Ky] = G[rf] = G[Hy] = G[Vy] = G[Wy] = G[zy] = G[nT] = G[rT] = G[iT] = G[sT] = !0;
G[Uy] = G[nf] = G[qy] = !1;
function oi(t, e, n, r, i, s) {
  ...
  var l = P(t);
  if (l)
    return a = ny(t), jp(t, a);
  var u = we(t), c = u == nf || u == By;
  if (Tr(t))
    return Bg(t);
  if (u == rf || u == tf || c && !i)
    return a = c ? {} : wy(t), o ? Wg(t, Gg(a, t)) : Hg(t, Fg(a, t));
  if (!G[u])
    return i ? t : {};
  a = Cy(t, u), s || (s = new qe());
  var f = s.get(t);
  if (f)
    return f;
  s.set(t, a), Py(t) ? t.forEach(function(m) {
    a.add(oi(m, e, n, m, t, s));
  }) : by(t) && t.forEach(function(m, g) {
    a.set(g, oi(m, e, n, g, t, s));
  });
  var d = aa, h = l ? void 0 : d(t);
  return Gc(h || t, function(m, g) {
    h && (g = m, m = t[g]), ts(a, g, oi(m, e, n, g, t, s));
  }), a;
}
var aT = 4;
function ie(t) {
...
yn.prototype.add = yn.prototype.push = lT;
yn.prototype.has = uT;
function sf(t, e) {
...
function af(t, e, n, r, i, s) {
  var a = n & cT, o = t.length, l = e.length;
  if (o != l && !(a && l > o))
    return !1;
  var u = s.get(t), c = s.get(e);
  if (u && c)
    return u == e && c == t;
  var f = -1, d = !0, h = n & fT ? new yn() : void 0;
  for (s.set(t, e), s.set(e, t); ++f < o; ) {
    ...
    if (h) {
      if (!sf(e, function(y, E) {
        if (!fo(h, E) && (m === y || i(m, y, n, r, s)))
          return h.push(E);
      })) {
        d = !1;
        break;
...
var hT = 1, pT = 2, mT = "[object Boolean]", gT = "[object Date]", yT = "[object Error]", TT = "[object Map]", vT = "[object Number]", RT = "[object RegExp]", AT = "[object Set]", ET = "[object String]", $T = "[object Symbol]", xT = "[object ArrayBuffer]", ST = "[object DataView]", hl = be ? be.prototype : void 0, Os = hl ? hl.valueOf : void 0;
function IT(t, e, n, r, i, s, a) {
  switch (n) {
    case ST:
    ...
    case xT:
      return !(t.byteLength != e.byteLength || !s(new Ii(t), new Ii(e)));
    case mT:
    case gT:
    case vT:
      return kr(+t, +e);
    ...
    case AT:
      ...
      if (u)
        return u == e;
      r |= pT, a.set(t, e);
      var c = af(o(t), o(e), r, i, s, a);
      return a.delete(t), c;
    case $T:
      if (Os)
        return Os.call(t) == Os.call(e);
  }
  return !1;
}
var kT = 1, CT = Object.prototype, wT = CT.hasOwnProperty;
function NT(t, e, n, r, i, s) {
  var a = n & kT, o = aa(t), l = o.length, u = aa(e), c = u.length;
  if (l != c && !a)
    return !1;
  for (var f = l; f--; ) {
    var d = o[f];
    if (!(a ? d in e : wT.call(e, d)))
      return !1;
  }
  ...
  if (g && !R) {
    ...
    I != M && "constructor" in t && "constructor" in e && !(typeof I == "function" && I instanceof I && typeof M == "function" && M instanceof M) && (g = !1);
  }
  return s.delete(t), s.delete(e), g;
}
var _T = 1, pl = "[object Arguments]", ml = "[object Array]", qr = "[object Object]", bT = Object.prototype, gl = bT.hasOwnProperty;
function OT(t, e, n, r, i, s) {
  var a = P(t), o = P(e), l = a ? ml : we(t), u = o ? ml : we(e);
  l = l == pl ? qr : l, u = u == pl ? qr : u;
  var c = l == qr, f = u == qr, d = l == u;
  if (d && Tr(t)) {
    if (!Tr(e))
      return !1;
    a = !0, c = !1;
  ...
  if (d && !c)
    return s || (s = new qe()), a || no(t) ? af(t, e, n, r, i, s) : IT(t, e, l, n, r, i, s);
  if (!(n & _T)) {
    var h = c && gl.call(t, "__wrapped__"), m = f && gl.call(e, "__wrapped__");
    if (h || m) {
      var g = h ? t.value() : t, R = m ? e.value() : e;
      return s || (s = new qe()), i(g, R, n, r, s);
    }
  }
  return d ? (s || (s = new qe()), NT(t, e, n, r, i, s)) : !1;
}
function po(t, e, n, r, i) {
  return t === e ? !0 : t == null || e == null || !Be(t) && !Be(e) ? t !== t && e !== e : OT(t, e, n, r, po, i);
}
var LT = 1, PT = 2;
function MT(t, e, n, r) {
  var i = n.length, s = i;
  ...
  for (; ++i < s; ) {
    ...
    if (a[2]) {
      ...
      var c = new qe(), f;
      if (!(f === void 0 ? po(u, l, LT | PT, r, c) : f))
        return !1;
    }
  }
  return !0;
...
function FT(t) {
  var e = DT(t);
  return e.length == 1 && e[0][2] ? lf(e[0][0], e[0][1]) : function(n) {
    return n === t || MT(n, t, e);
  };
}
function GT(t, e) {
...
function uf(t, e, n) {
  ...
  return s || ++r != i ? s : (i = t == null ? 0 : t.length, !!i && to(i) && es(a, i) && (P(t) || ns(t)));
}
function UT(t, e) {
  return t != null && uf(t, e, GT);
}
var BT = 1, jT = 2;
function KT(t, e) {
  return io(t) && of(e) ? lf(Nr(t), e) : function(n) {
    var r = wg(n, t);
    return r === void 0 && r === e ? UT(n, t) : po(e, r, BT | jT);
  };
}
function HT(t) {
  return function(e) {
...
function WT(t) {
  return io(t) ? HT(Nr(t)) : VT(t);
}
function Je(t) {
  return typeof t == "function" ? t : t == null ? gn : typeof t == "object" ? P(t) ? KT(t[0], t[1]) : FT(t) : WT(t);
}
function zT(t, e, n, r) {
...
var Bt = JT(XT);
function ZT(t, e, n, r) {
  return Bt(t, function(i, s, a) {
    e(r, i, n(i), a);
  }), r;
}
function QT(t, e) {
  return function(n, r) {
    var i = P(n) ? zT : ZT, s = e ? e() : {};
    return i(n, t, Je(r), s);
  };
}
var cf = Object.prototype, ev = cf.hasOwnProperty, mo = eo(function(t, e) {
  t = Object(t);
  var n = -1, r = e.length, i = r > 2 ? e[2] : void 0;
  for (i && jc(e[0], e[1], i) && (r = 1); ++n < r; )
    for (var s = e[n], a = ro(s), o = -1, l = a.length; ++o < l; ) {
      var u = a[o], c = t[u];
      (c === void 0 || kr(c, cf[u]) && !ev.call(t, u)) && (t[u] = s[u]);
    }
  return t;
});
function yl(t) {
...
var tv = 200;
function nv(t, e, n, r) {
  var i = -1, s = Bc, a = !0, o = t.length, l = [], u = e.length;
  if (!o)
    return l;
  e.length >= tv && (s = fo, a = !1, e = new yn(e));
  e:
    for (; ++i < o; ) {
      var c = t[i], f = c;
      if (c = c !== 0 ? c : 0, a && f === f) {
...
function ee(t, e, n) {
  ...
  return r ? (e = e === void 0 ? 1 : Qi(e), Xc(t, e < 0 ? 0 : e, r)) : [];
}
function Ar(t, e, n) {
  var r = t == null ? 0 : t.length;
  return r ? (e = e === void 0 ? 1 : Qi(e), e = r - e, Xc(t, 0, e < 0 ? 0 : e)) : [];
}
function rv(t) {
...
function lv(t, e, n) {
  ...
  if (!r)
    return -1;
  var i = n == null ? 0 : Qi(n);
  return i < 0 && (i = ov(r + i, 0)), Uc(t, Je(e), i);
}
var vn = av(lv);
function je(t) {
...
var cv = Object.prototype, fv = cv.hasOwnProperty, dv = QT(function(t, e, n) {
  fv.call(t, n) ? t[n].push(e) : Qa(t, n, [e]);
}), hv = Object.prototype, pv = hv.hasOwnProperty;
function mv(t, e) {
  return t != null && pv.call(t, e);
}
function C(t, e) {
  return t != null && uf(t, e, mv);
}
var gv = "[object String]";
function pe(t) {
  return typeof t == "string" || !P(t) && Be(t) && At(t) == gv;
}
function yv(t, e) {
...
function J(t) {
  return t == null ? [] : yv(t, Le(t));
}
var Tv = Math.max;
function de(t, e, n, r) {
  t = Xe(t) ? t : J(t), n = n ? Qi(n) : 0;
  var i = t.length;
  return n < 0 && (n = Tv(i + n, 0)), pe(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && Za(t, e, n) > -1;
}
function Tl(t, e, n) {
  var r = t == null ? 0 : t.length;
  if (!r)
...
var vv = "[object Map]", Rv = "[object Set]", Av = Object.prototype, Ev = Av.hasOwnProperty;
function U(t) {
  if (t == null)
    return !0;
  if (Xe(t) && (P(t) || typeof t == "string" || typeof t.splice == "function" || Tr(t) || no(t) || ns(t)))
    return !t.length;
  var e = we(t);
  if (e == vv || e == Rv)
    return !t.size;
...
var vl = gt && gt.isRegExp, ot = vl ? rs(vl) : xv;
function lt(t) {
  return t === void 0;
}
...
function kv(t, e, n, r) {
  ...
  for (var i = -1, s = e.length, a = s - 1, o = t; o != null && ++i < s; ) {
    ...
    if (i != a) {
      var c = o[l];
      u = void 0, u === void 0 && (u = Oe(c) ? c : es(e[i + 1]) ? [] : {});
    }
    ts(o, l, u), o = o[l];
  }
  return t;
...
function Ke(t, e) {
  if (t == null)
    return {};
  var n = Zi(zg(t), function(r) {
    return [r];
  });
  return e = Je(e), Cv(t, n, function(r, i) {
    return e(r, i[0]);
  });
}
...
function xe(t, e, n) {
  var r = P(t) ? _g : wv, i = arguments.length < 3;
  return r(t, Je(e), n, i, Bt);
}
function ls(t, e) {
  var n = P(t) ? uo : ff;
  return n(t, Iv(Je(e)));
...
var _v = 1 / 0, bv = Xt && 1 / ho(new Xt([, -0]))[1] == _v ? function(t) {
  return new Xt(t);
} : X, Ov = 200;
function Lv(t, e, n) {
  var r = -1, i = Bc, s = t.length, a = !0, o = [], l = o;
  if (s >= Ov) {
    var u = bv(t);
    if (u)
      return ho(u);
...
function Fv(t) {
  return t instanceof me || t instanceof re || t instanceof z || t instanceof Se || t instanceof Ie || t instanceof ge || t instanceof j || t instanceof In;
}
function ki(t, e = []) {
  return t instanceof re || t instanceof z || t instanceof ge ? !0 : t instanceof ye ? df(t.definition, (r) => ki(r, e)) : t instanceof ce && de(e, t) ? !1 : t instanceof Ze ? (t instanceof ce && e.push(t), Ue(t.definition, (r) => ki(r, e))) : !1;
}
function Gv(t) {
...
function Uv(t) {
  ...
  for (; i && a; )
    s = n[r], a = ki(s), e = e.concat(br(s)), r = r + 1, i = n.length > r;
  return go(e);
}
function Bv(t) {
  const e = k(t.definition, (n) => br(n));
  return go(Ge(e));
}
function jv(t) {
...
class Kv extends us {
  ...
  walkProdRef(e, n, r) {
    const i = Vv(e.referencedRule, e.idx) + this.topProd.name, s = n.concat(r), a = new me({ definition: s }), o = br(a);
    this.follows[i] = o;
  }
}
function Hv(t) {
...
const yf = "Complement Sets are not supported for first char optimization", Ci = `Unable to use "first char" lexer optimizations:
`;
function qv(t, e = !1) {
  try {
    const n = cs(t);
    return ca(n.value, {}, n.flags.ignoreCase);
  } catch (n) {
    if (n.message === yf)
      e && hf(`${Ci}	Unable to optimize: < ${t.toString()} >
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.`);
      ...
      e && (r = `
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`), ua(`${Ci}
    ...
    case "Alternative":
      ...
      for (let i = 0; i < r.length; i++) {
              ...
              if (typeof l == "number")
                ...
                if (n === !0)
                  ...
                  for (let c = u.from; c <= u.to && c < lr; c++)
                    Yr(c, e, n);
                  if (u.to >= lr) {
                    const c = u.from >= lr ? u.from : lr, f = u.to, d = yt(c), h = yt(f);
                    for (let m = d; m <= h; m++)
                      e[m] = m;
                  }
                }
        ...
        if (
          ...
          a.type === "Group" && fa(a) === !1 || // If this term is not a group it may only be optional if it has an optional quantifier
          a.type !== "Group" && o === !1
        )
          break;
      }
...
function Yv(t, e) {
  ...
  if (r !== n) {
    const i = yt(r.charCodeAt(0));
    e[i] = i;
  } else {
    const i = n.toLowerCase();
    if (i !== n) {
      const s = yt(i.charCodeAt(0));
      e[s] = s;
    }
  }
}
...
function fa(t) {
  ...
  return e && e.atLeast === 0 ? !0 : t.value ? P(t.value) ? Ue(t.value, fa) : fa(t.value) : !1;
}
class Xv extends Yi {
  constructor(e) {
  ...
  visitSet(e) {
    e.complement ? Al(e, this.targetCharCodes) === void 0 && (this.found = !0) : Al(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}
function yo(t, e) {
  if (e instanceof RegExp) {
    const n = cs(e), r = new Xv(t);
    return r.visit(n), r.found;
  } else
    return vn(e, (n) => de(t, n.charCodeAt(0))) !== void 0;
}
const Pt = "PATTERN", or = "defaultMode", Xr = "modes";
let Tf = typeof new RegExp("(?:)").sticky == "boolean";
function Jv(t, e) {
  e = mo(e, {
    useSticky: Tf,
    debug: !1,
...
`],
  ...
  n("Transform Patterns", () => {
    i = !1, s = k(r, (E) => {
      ...
      if (ot(v)) {
        ...
        I !== "^" && I !== "$" && I !== "." && !v.ignoreCase ? I : I.length === 2 && I[0] === "\\" && // not a meta character
        !de([
          "d",
          "D",
          "s",
        ...
        if (typeof v == "string") {
          if (v.length === 1)
            return v;
          {
            const I = v.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), M = new RegExp(I);
            return e.useSticky ? $l(M) : El(M);
          }
        } else
          throw Error("non exhaustive match");
      }
  ...
  n("misc mapping", () => {
    a = k(r, (E) => E.tokenTypeIdx), o = k(r, (E) => {
      ...
      if (v)
        return P(v) ? k(v, (M) => Tl(r, M)) : [Tl(r, v)];
    }), u = k(r, (E) => E.PUSH_MODE), c = k(r, (E) => C(E, "POP_MODE"));
  });
  let f;
  n("Line Terminator Handling", () => {
    const E = Af(e.lineTerminatorCharacters);
    f = k(r, (v) => !1), e.positionTracking !== "onlyOffset" && (f = k(r, (v) => C(v, "LINE_BREAKS") ? !!v.LINE_BREAKS : Rf(v, E) === !1 && yo(E, v.PATTERN)));
  });
  let d, h, m, g;
  n("Misc Mapping #2", () => {
    d = k(r, vf), h = k(s, yR), m = xe(r, (E, v) => {
      const I = v.GROUP;
      return pe(I) && I !== he.SKIPPED && (E[I] = []), E;
    }, {}), g = k(s, (E, v) => ({
      pattern: s[v],
      longerAlt: l[v],
  ...
  return e.safeMode || n("First Char Optimization", () => {
    y = xe(r, (E, v, I) => {
      if (typeof v.PATTERN == "string") {
        const M = v.PATTERN.charCodeAt(0), se = yt(M);
        Ls(E, se, g[I]);
      } else if (P(v.START_CHARS_HINT)) {
        let M;
        w(v.START_CHARS_HINT, (se) => {
          const Me = typeof se == "string" ? se.charCodeAt(0) : se, Te = yt(Me);
          M !== Te && (M = Te, Ls(E, Te, g[I]));
        });
      } else if (ot(v.PATTERN))
        if (v.PATTERN.unicode)
          R = !1, e.ensureOptimizations && ua(`${Ci}	Unable to analyze < ${v.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
        else {
          const M = qv(v.PATTERN, e.ensureOptimizations);
          U(M) && (R = !1), w(M, (se) => {
            Ls(E, se, g[I]);
          });
        }
      else
        e.ensureOptimizations && ua(`${Ci}	TokenType: <${v.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
function Zv(t, e) {
  ...
  const r = eR(t);
  n = n.concat(r.errors);
  const i = tR(r.valid), s = i.valid;
  return n = n.concat(i.errors), n = n.concat(Qv(s)), n = n.concat(uR(s)), n = n.concat(cR(s, e)), n = n.concat(fR(s)), n;
}
function Qv(t) {
  let e = [];
  const n = Pe(t, (r) => ot(r[Pt]));
  return e = e.concat(rR(n)), e = e.concat(aR(n)), e = e.concat(oR(n)), e = e.concat(lR(n)), e = e.concat(iR(n)), e;
}
function eR(t) {
  const e = Pe(t, (i) => !C(i, Pt)), n = k(e, (i) => ({
...
function rR(t) {
  ...
  const n = Pe(t, (i) => {
    const s = i.PATTERN;
    try {
      const a = cs(s), o = new e();
      return o.visit(a), o.found;
    } catch {
      return nR.test(s.source);
    }
  });
  return k(n, (i) => ({
...
function fR(t) {
  const e = [], n = xe(t, (r, i, s) => {
    const a = i.PATTERN;
    return a === he.NA || (pe(a) ? r.push({ str: a, idx: s, tokenType: i }) : ot(a) && hR(a) && r.push({ str: a.source, idx: s, tokenType: i })), r;
  }, []);
  return w(t, (r, i) => {
    w(n, ({ str: s, idx: a, tokenType: o }) => {
      if (i < a && dR(s, r.PATTERN)) {
...
`,
  ...
  }), C(t, Xr) && C(t, or) && !C(t.modes, t.defaultMode) && r.push({
...
function mR(t, e, n) {
  const r = [];
  let i = !1;
  const s = _r(Ge(J(t.modes))), a = ls(s, (l) => l[Pt] === he.NA), o = Af(n);
  return e && w(a, (l) => {
    const u = Rf(l, o);
    if (u !== !1) {
      const f = {
      ...
      C(l, "LINE_BREAKS") ? l.LINE_BREAKS === !0 && (i = !0) : yo(o, l.PATTERN) && (i = !0);
  }), e && !i && r.push({
...
function ER(t) {
  w(t, (e) => {
    xf(e) || (Ef[xl] = e, e.tokenTypeIdx = xl++), Sl(e) && !P(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Sl(e) || (e.CATEGORIES = []), SR(e) || (e.categoryMatches = []), IR(e) || (e.categoryMatchesMap = {});
  });
}
function $R(t) {
  w(t, (e) => {
    e.categoryMatches = [], w(e.categoryMatchesMap, (n, r) => {
      e.categoryMatches.push(Ef[r].tokenTypeIdx);
    });
  });
}
function xR(t) {
  ...
  constructor(e, n = ur) {
    if (this.lexerDefinition = e, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.trackStartLines = !0, this.trackEndLines = !0, this.hasCustom = !1, this.canModeBeOptimized = {}, this.TRACE_INIT = (i, s) => {
      if (this.traceInitPerf === !0) {
        ...
        const { time: o, value: l } = pf(s), u = o > 10 ? console.warn : console.log;
...
a boolean 2nd argument is no longer supported`);
    ...
    r === !0 ? (this.traceInitMaxIdent = 1 / 0, this.traceInitPerf = !0) : typeof r == "number" && (this.traceInitMaxIdent = r, this.traceInitPerf = !0), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", () => {
      ...
      this.TRACE_INIT("Lexer Config handling", () => {
        if (this.config.lineTerminatorsPattern === ur.lineTerminatorsPattern)
          this.config.lineTerminatorsPattern = TR;
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(pR(i, this.trackStartLines, this.config.lineTerminatorCharacters));
      }), this.TRACE_INIT("performWarningRuntimeChecks", () => {
        this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(mR(i, this.trackStartLines, this.config.lineTerminatorCharacters));
      })), i.modes = i.modes ? i.modes : {}, w(i.modes, (o, l) => {
        i.modes[l] = ls(o, (u) => lt(u));
      });
      const a = Le(i.modes);
      if (w(i.modes, (o, l) => {
        this.TRACE_INIT(`Mode: <${l}> processing`, () => {
          if (this.modes.push(l), this.config.skipValidations === !1 && this.TRACE_INIT("validatePatterns", () => {
            this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Zv(o, a));
...
` + l);
      ...
      w(this.lexerDefinitionWarning, (o) => {
        ...
        if (Tf ? (this.chopInput = gn, this.match = this.matchWithTest) : (this.updateLastIndex = X, this.match = this.matchWithExec), s && (this.handleModes = X), this.trackStartLines === !1 && (this.computeNewColumn = gn), this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = X), /full/i.test(this.config.positionTracking))
...
` + i);
  ...
  tokenizeInternal(e, n) {
    ...
    const x = gR(this.emptyGroups), T = this.trackStartLines, $ = this.config.lineTerminatorsPattern;
    let S = 0, O = [], b = [];
    const _ = [], ve = [];
    Object.freeze(ve);
    let Z;
    ...
    function Ct(ae) {
      const Ce = yt(ae), Vt = b[Ce];
      return Vt === void 0 ? ve : Vt;
    }
    const Hd = (ae) => {
      ...
      ae.tokenType.PUSH_MODE === void 0) {
        ...
        _.pop();
        const Ce = Tn(_);
        O = this.patternIdxToConfig[Ce], b = this.charCodeToPatternIdxToConfig[Ce], S = O.length;
        const Vt = this.canModeBeOptimized[Ce] && this.config.safeMode === !1;
        b && Vt ? Z = Ct : Z = W;
      }
    };
    function bo(ae) {
      _.push(ae), b = this.charCodeToPatternIdxToConfig[ae], O = this.patternIdxToConfig[ae], S = O.length, S = O.length;
      const Ce = this.canModeBeOptimized[ae] && this.config.safeMode === !1;
      b && Ce ? Z = Ct : Z = W;
    }
    bo.call(this, n);
    let De;
    const Oo = this.config.recoveryEnabled;
    for (; I < v; ) {
      l = null;
      const ae = E.charCodeAt(I), Ce = Z(ae), Vt = Ce.length;
      for (r = 0; r < Vt; r++) {
        De = Ce[r];
        const Re = De.pattern;
        u = null;
        const Qe = De.short;
        if (Qe !== !1 ? ae === Qe && (l = Re) : De.isCustom === !0 ? (y = Re.exec(E, I, Me, x), y !== null ? (l = y[0], y.payload !== void 0 && (u = y.payload)) : l = null) : (this.updateLastIndex(Re, I), l = this.match(Re, e, I)), l !== null) {
          if (o = De.longerAlt, o !== void 0) {
            const ht = o.length;
            for (s = 0; s < ht; s++) {
              const et = O[o[s]], wt = et.pattern;
              if (c = null, et.isCustom === !0 ? (y = wt.exec(E, I, Me, x), y !== null ? (a = y[0], y.payload !== void 0 && (c = y.payload)) : a = null) : (this.updateLastIndex(wt, I), a = this.match(wt, e, I)), a && a.length > l.length) {
                l = a, u = c, De = et;
                break;
              }
            }
      ...
      if (l !== null) {
        if (f = l.length, d = De.group, d !== void 0 && (h = De.tokenTypeIdx, m = this.createTokenInstance(l, I, h, De.tokenType, Ve, ke, f), this.handlePayload(m, u), d === !1 ? M = this.addToken(Me, M, m) : x[d].push(m)), e = this.chopInput(e, f), I = I + f, ke = this.computeNewColumn(ke, f), T === !0 && De.canLineTerminator === !0) {
          let Re = 0, Qe, ht;
          $.lastIndex = 0;
          do
            Qe = $.test(l), Qe === !0 && (ht = $.lastIndex - 1, Re++);
          while (Qe === !0);
          Re !== 0 && (Ve = Ve + Re, ke = f - ht, this.updateTokenEndLineColumnLocation(m, d, ht, Re, Ve, ke, f));
        }
        this.handleModes(De, Hd, bo, m);
      } else {
        const Re = I, Qe = Ve, ht = ke;
        let et = Oo === !1;
        for (; et === !1 && I < v; )
          for (e = this.chopInput(e, 1), I++, i = 0; i < S; i++) {
            const wt = O[i], As = wt.pattern, Lo = wt.short;
            if (Lo !== !1 ? E.charCodeAt(I) === Lo && (et = !0) : wt.isCustom === !0 ? et = As.exec(E, I, Me, x) !== null : (this.updateLastIndex(As, I), et = As.exec(e) !== null), et === !0)
              break;
          }
        if (g = I - Re, ke = this.computeNewColumn(ke, g), R = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(E, Re, g, Qe, ht), Te.push({
          offset: Re,
          line: Qe,
          column: ht,
          length: g,
...
function Jt(t) {
  return Sf(t) ? t.LABEL : t.name;
}
function Sf(t) {
  return pe(t.LABEL) && t.LABEL !== "";
}
const CR = "parent", Il = "categories", kl = "label", Cl = "group", wl = "push_mode", Nl = "pop_mode", _l = "longer_alt", bl = "line_breaks", Ol = "start_chars_hint";
function If(t) {
  return wR(t);
}
function wR(t) {
  const e = t.pattern, n = {};
  if (n.name = t.name, lt(e) || (n.PATTERN = e), C(t, CR))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return C(t, Il) && (n.CATEGORIES = t[Il]), Lr([n]), C(t, kl) && (n.LABEL = t[kl]), C(t, Cl) && (n.GROUP = t[Cl]), C(t, Nl) && (n.POP_MODE = t[Nl]), C(t, wl) && (n.PUSH_MODE = t[wl]), C(t, _l) && (n.LONGER_ALT = t[_l]), C(t, bl) && (n.LINE_BREAKS = t[bl]), C(t, Ol) && (n.START_CHARS_HINT = t[Ol]), n;
}
const Tt = If({ name: "EOF", pattern: he.NA });
Lr([Tt]);
function To(t, e, n, r, i, s, a, o) {
  return {
    image: e,
    startOffset: n,
    endOffset: r,
...
const qt = {
  buildMismatchTokenMessage({ expected: t, actual: e, previous: n, ruleName: r }) {
    return `Expecting ${Sf(t) ? `--> ${Jt(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
...
but found: '` + je(e).image + "'";
    if (r)
      return s + r + o;
    {
      const l = xe(t, (d, h) => d.concat(h), []), u = k(l, (d) => `[${k(d, (h) => Jt(h)).join(", ")}]`), f = `one of these possible Token sequences:
${k(u, (d, h) => `  ${h + 1}. ${d}`).join(`
`)}`;
      return s + f + o;
    }
...
and Non-Terminal names start with a lower case letter.`;
  ...
  buildAlternationPrefixAmbiguityError(t) {
    const e = k(t.prefixPath, (i) => Jt(i)).join(", "), n = t.alternation.idx === 0 ? "" : t.alternation.idx;
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
  ...
  buildDuplicateRuleNameError(t) {
    let e;
    return t.topLevelRule instanceof In ? e = t.topLevelRule.name : e = t.topLevelRule, `Duplicate definition, rule: ->${e}<- is already defined in the grammar: ->${t.grammarName}<-`;
  }
};
function _R(t, e) {
  const n = new bR(t, e);
...
class LR extends OR {
  ...
  walkTerminal(e, n, r) {
    if (this.isAtEndOfPath && e.terminalType.name === this.nextTerminalName && e.idx === this.nextTerminalOccurrence && !this.found) {
      ...
      this.possibleTokTypes = br(s), this.found = !0;
    }
  }
}
class fs extends us {
  ...
  for (f.push({
    ...
    if (y === i) {
      ...
      const E = new z({
        ...
        idx: y.idx
      }), v = y.definition.concat([E], ee(h)), I = {
        idx: m,
        def: v,
        ruleStack: g,
        occurrenceStack: R
      ...
      const E = new j({
        ...
        idx: y.idx
      }), I = y.definition.concat([v], ee(h)), M = {
        idx: m,
        def: I,
        ruleStack: g,
        occurrenceStack: R
      ...
      const v = new j({
        ...
        idx: y.idx
      }), M = y.definition.concat([I], ee(h)), se = {
        idx: m,
        def: M,
        ruleStack: g,
        occurrenceStack: R
...
function Ml(t) {
  const { occurrence: e, rule: n, prodType: r, maxLookahead: i } = t, s = vo(r);
  return s === H.ALTERNATION ? ds(e, n, i) : hs(e, n, s, i);
}
function FR(t, e, n, r, i, s) {
  const a = ds(t, e, n), o = _f(a) ? wi : Or;
  return s(a, r, o, i);
}
function GR(t, e, n, r, i, s) {
  const a = hs(t, e, i, n), o = _f(a) ? wi : Or;
  return s(a[0], o, r);
}
function UR(t, e, n, r) {
...
function Nf(t, e) {
  const n = k(t, (a) => ha([a], 1)), r = Dl(n.length), i = k(n, (a) => {
    const o = {};
    return w(a, (l) => {
      const u = Ps(l.partialPath);
      w(u, (c) => {
        o[c] = !0;
      });
    }), o;
  ...
  for (let a = 1; a <= e; a++) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      for (let c = 0; c < u.length; c++) {
        const f = u[c].partialPath, d = u[c].suffixDef, h = Ps(f);
        if (KR(i, h, l) || U(d) || f.length === e) {
          const g = r[l];
          if (pa(g, f) === !1) {
            g.push(f);
...
function ds(t, e, n, r) {
  const i = new wf(t, H.ALTERNATION, r);
  return e.accept(i), Nf(i.result, n);
}
function hs(t, e, n, r) {
  const i = new wf(t, n);
  e.accept(i);
  const s = i.result, o = new jR(e, t, n).startWalking(), l = new me({ definition: s }), u = new me({ definition: o });
  return Nf([l, u], r);
}
function pa(t, e) {
...
function WR(t, e, n, r) {
  const i = Ne(t, (l) => zR(l, n)), s = sA(t, e, n), a = Ne(t, (l) => tA(l, n)), o = Ne(t, (l) => XR(l, t, r, n));
  return i.concat(s, a, o);
}
function zR(t, e) {
  const n = new YR();
  t.accept(n);
  const r = n.allProductions, i = dv(r, qR), s = Ke(i, (o) => o.length > 1);
  return k(J(s), (o) => {
...
function qR(t) {
  return `${We(t)}_#_${t.idx}_#_${bf(t)}`;
}
function bf(t) {
...
function Of(t, e, n, r = []) {
    ...
    return [];
  {
    ...
    const l = os(s, r.concat([t])), u = Ne(l, (c) => {
      const f = ie(r);
      return f.push(c), Of(t, c, n, f);
    });
    return i.concat(u);
  }
}
function fi(t) {
  ...
  if (n instanceof ce)
    ...
    e = Ge(k(n.definition, (s) => fi(s.definition)));
  else if (!(n instanceof j)) throw Error("non exhaustive match");
  const r = ki(n), i = t.length > 1;
  if (r && i) {
    const s = ee(t);
...
function QR(t, e, n) {
  ...
  return i = ls(i, (a) => a.ignoreAmbiguities === !0), Ne(i, (a) => {
    const o = a.idx, l = a.maxLookahead || e, u = ds(o, t, l, a), c = rA(u, a, t, n), f = iA(u, a, t, n);
    return c.concat(f);
  });
}
class eA extends kn {
...
function nA(t, e, n) {
  ...
  return w(t, (i) => {
    ...
    w(a, (o) => {
      const l = vo(o), u = o.maxLookahead || e, c = o.idx, d = hs(c, i, l, u)[0];
      if (U(Ge(d))) {
...
function rA(t, e, n, r) {
  const i = [], s = xe(t, (o, l, u) => (e.definition[u].ignoreAmbiguities === !0 || w(l, (c) => {
    const f = [u];
    w(t, (d, h) => {
      u !== h && pa(d, c) && // ignore (skip) ambiguities with this "other" alternative
      e.definition[h].ignoreAmbiguities !== !0 && f.push(h);
    }), f.length > 1 && !pa(i, c) && (i.push(c), o.push({
      alts: f,
      path: c
    }));
  }), o), []);
...
function aA(t) {
  ...
  return w(t.rules, (r) => {
    n[r.name] = r;
  }), _R(n, e.errMsgProvider);
}
function oA(t) {
  return t = mo(t, {
    errMsgProvider: Nt
  }), WR(t.rules, t.tokenTypes, t.errMsgProvider, t.grammarName);
}
const Lf = "MismatchedTokenException", Pf = "NoViableAltException", Mf = "EarlyExitException", Df = "NotAllInputParsedException", Ff = [
  Lf,
  Pf,
  Mf,
  Df
...
class Gf extends ps {
  constructor(e, n, r) {
    super(e, n), this.previousToken = r, this.name = Lf;
  }
}
class lA extends ps {
  constructor(e, n, r) {
    super(e, n), this.previousToken = r, this.name = Pf;
  }
}
class uA extends ps {
  constructor(e, n) {
    super(e, n), this.name = Df;
  }
}
class cA extends ps {
  constructor(e, n, r) {
    super(e, n), this.previousToken = r, this.name = Mf;
  }
}
const Ms = {}, Uf = "InRuleRecoveryException";
class fA extends Error {
  constructor(e) {
    super(e), this.name = Uf;
  }
}
class dA {
  initRecoverable(e) {
    this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = C(e, "recoveryEnabled") ? e.recoveryEnabled : ut.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = hA);
  }
  getTokenToInsert(e) {
    const n = To(e, "", NaN, NaN, NaN, NaN, NaN, NaN);
  ...
  canRecoverWithSingleTokenInsertion(e, n) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || U(n))
      return !1;
    const r = this.LA(1);
    return vn(n, (s) => this.tokenMatcher(r, s)) !== void 0;
  }
  ...
  getFollowSetFromFollowKey(e) {
    if (e === Ms)
      return [Tt];
    const n = e.ruleName + e.idxInCallingRule + gf + e.inRule;
    return this.resyncFollows[n];
  }
  // It does not make any sense to include a virtual EOF token in the list of resynced tokens
  // as EOF does not really exist and thus does not contain any useful information (line/column numbers)
  addToResyncTokens(e, n) {
    return this.tokenMatcher(e, Tt) || n.push(e), n;
  }
  reSyncTo(e) {
    const n = [];
    let r = this.LA(1);
...
function hA(t, e, n, r, i, s, a) {
  ...
  this.RULE_STACK.length === 1 && f && u === void 0 && (u = Tt, c = 1), !(u === void 0 || c === void 0) && this.shouldInRepetitionRecoveryBeTried(u, c, a) && this.tryInRepetitionRecovery(t, e, n, u);
}
const pA = 4, Et = 8, Bf = 1 << Et, jf = 2 << Et, ma = 3 << Et, ga = 4 << Et, ya = 5 << Et, di = 6 << Et;
function Ds(t, e, n) {
  return n | e | t;
}
class Ao {
  constructor(e) {
    var n;
    this.maxLookahead = (n = e == null ? void 0 : e.maxLookahead) !== null && n !== void 0 ? n : ut.maxLookahead;
  }
  validate(e) {
  ...
  validateNoLeftRecursion(e) {
    return Ne(e, (n) => Of(n, n, Nt));
  }
  validateEmptyOrAlternatives(e) {
    return Ne(e, (n) => ZR(n, Nt));
  }
  validateAmbiguousAlternationAlternatives(e, n) {
    return Ne(e, (r) => QR(r, n, Nt));
  }
  validateSomeNonEmptyLookaheadPath(e, n) {
    return nA(e, n, Nt);
  }
  buildLookaheadForAlternation(e) {
    return FR(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, UR);
  }
  buildLookaheadForOptional(e) {
    return GR(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, vo(e.prodType), BR);
  }
}
class mA {
  initLooksAhead(e) {
    this.dynamicTokensEnabled = C(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : ut.dynamicTokensEnabled, this.maxLookahead = C(e, "maxLookahead") ? e.maxLookahead : ut.maxLookahead, this.lookaheadStrategy = C(e, "lookaheadStrategy") ? e.lookaheadStrategy : new Ao({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
  }
  preComputeLookaheadFunctions(e) {
    w(e, (n) => {
      this.TRACE_INIT(`${n.name} Rule Lookahead`, () => {
        const { alternation: r, repetition: i, option: s, repetitionMandatory: a, repetitionMandatoryWithSeparator: o, repetitionWithSeparator: l } = yA(n);
        w(r, (u) => {
          ...
          this.TRACE_INIT(`${We(u)}${c}`, () => {
            ...
            }), d = Ds(this.fullRuleNameToShort[n.name], Bf, u.idx);
            this.setLaFuncCache(d, f);
          });
        }), w(i, (u) => {
          this.computeLookaheadFunc(n, u.idx, ma, "Repetition", u.maxLookahead, We(u));
        }), w(s, (u) => {
          this.computeLookaheadFunc(n, u.idx, jf, "Option", u.maxLookahead, We(u));
        }), w(a, (u) => {
          this.computeLookaheadFunc(n, u.idx, ga, "RepetitionMandatory", u.maxLookahead, We(u));
        }), w(o, (u) => {
          this.computeLookaheadFunc(n, u.idx, di, "RepetitionMandatoryWithSeparator", u.maxLookahead, We(u));
        }), w(l, (u) => {
          this.computeLookaheadFunc(n, u.idx, ya, "RepetitionWithSeparator", u.maxLookahead, We(u));
        });
      });
    });
  }
  computeLookaheadFunc(e, n, r, i, s, a) {
    this.TRACE_INIT(`${a}${n === 0 ? "" : n}`, () => {
      const o = this.lookaheadStrategy.buildLookaheadForOptional({
        ...
        dynamicTokensEnabled: this.dynamicTokensEnabled,
        prodType: i
      }), l = Ds(this.fullRuleNameToShort[e.name], r, n);
...
const Jr = new gA();
function yA(t) {
  Jr.reset(), t.accept(Jr);
  const e = Jr.dslMethods;
  return Jr.reset(), e;
}
function Fl(t, e) {
...
function $A(t, e, n) {
  ...
  Kf(r, t + "BaseSemanticsWithDefaults");
...
class IA {
  ...
  cstPostTerminal(e, n) {
    ...
    TA(r, n, e), this.setNodeLocationFromToken(r.location, n);
  }
  cstPostNonTerminal(e, n) {
    const r = this.CST_STACK[this.CST_STACK.length - 1];
    vA(r, n, e), this.setNodeLocationFromNode(r.location, e.location);
  }
  getBaseCstVisitorConstructor() {
    if (lt(this.baseCstVisitorConstructor)) {
      const e = EA(this.className, Le(this.gastProductionsCache));
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (lt(this.baseCstVisitorWithDefaultsConstructor)) {
      const e = $A(this.className, Le(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
class CA {
  ...
  RULE(e, n, r = Oi) {
    if (de(this.definedRulesNames, e)) {
      const a = {
        message: Nt.buildDuplicateRuleNameError({
          topLevelRule: e,
  ...
  OVERRIDE_RULE(e, n, r = Oi) {
    const i = JR(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Dv(J(this.gastProductionsCache));
  }
}
class wA {
  initRecognizerEngine(e, n) {
    ...
    else if (C(e, "modes") && Ue(Ge(J(e.modes)), kR)) {
      const s = Ge(J(e.modes)), a = go(s);
    ...
    this.tokenMatcher = i ? wi : Or, Lr(J(this.tokensMap));
  }
  defineRule(e, n, r) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${e}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = C(r, "resyncEnabled") ? r.resyncEnabled : Oi.resyncEnabled, s = C(r, "recoveryValueFunc") ? r.recoveryValueFunc : Oi.recoveryValueFunc, a = this.ruleShortNameIdx << pA + Et;
  ...
  optionInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(jf, n);
  ...
  atLeastOneInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(ga, e);
  ...
  atLeastOneInternalLogic(e, n, r) {
    ...
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, n], i, ga, e, MR);
  }
  ...
  manyInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(ma, e);
  ...
  manySepFirstInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(ya, e);
  ...
  orInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(Bf, n), i = P(e) ? e : e.DEF, a = this.getLaFuncFromCache(r).call(this, i);
    if (a !== void 0)
...
class NA {
  ...
  raiseEarlyExitException(e, n, r) {
    const i = this.getCurrRuleFullName(), s = this.getGAstProductions()[i], o = hs(e, s, n, this.maxLookahead)[0], l = [];
    ...
    throw this.SAVE_ERROR(new cA(u, this.LA(1), this.LA(0)));
  }
  // TODO: consider caching the error message computed information
  raiseNoAltException(e, n) {
    const r = this.getCurrRuleFullName(), i = this.getGAstProductions()[r], s = ds(e, i, this.maxLookahead), a = [];
    ...
    throw this.SAVE_ERROR(new lA(l, this.LA(1), o));
  }
}
class _A {
  initContentAssist() {
  ...
  getNextPossibleTokenTypes(e) {
    ...
    return new LR(i, e).startWalking();
  }
}
const ms = {
...
Object.freeze(ms);
const Ul = !0, Bl = Math.pow(2, Et) - 1, Hf = If({ name: "RECORDING_PHASE_TOKEN", pattern: he.NA });
Lr([Hf]);
const Vf = To(
  Hf,
...
class OA {
  ...
  topLevelRuleRecord(e, n) {
    try {
      const r = new In({ definition: [], name: e });
  ...
  optionInternalRecord(e, n) {
    return _n.call(this, re, e, n);
  }
  atLeastOneInternalRecord(e, n) {
    _n.call(this, Se, n, e);
  }
  atLeastOneSepFirstInternalRecord(e, n) {
    _n.call(this, Ie, n, e, Ul);
  }
  manyInternalRecord(e, n) {
    _n.call(this, z, n, e);
  }
  manySepFirstInternalRecord(e, n) {
    _n.call(this, ge, n, e, Ul);
  }
  orInternalRecord(e, n) {
    return LA.call(this, e, n);
  }
  subruleInternalRecord(e, n, r) {
    if (_i(n), !e || C(e, "ruleName") === !1) {
      const o = new Error(`<SUBRULE${jl(n)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw o.KNOWN_RECORDER_ERROR = !0, o;
    }
    const i = Tn(this.recordingProdStack), s = e.ruleName, a = new ce({
      idx: n,
      nonTerminalName: s,
    ...
    return i.definition.push(a), this.outputCst ? bA : ms;
  }
  consumeInternalRecord(e, n, r) {
    if (_i(n), !xf(e)) {
      const a = new Error(`<CONSUME${jl(n)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw a.KNOWN_RECORDER_ERROR = !0, a;
    }
    const i = Tn(this.recordingProdStack), s = new j({
      idx: n,
      terminalType: e,
      label: r == null ? void 0 : r.LABEL
    });
    return i.definition.push(s), Vf;
  }
}
function _n(t, e, n, r = !1) {
  _i(n);
  const i = Tn(this.recordingProdStack), s = ct(e) ? e : e.DEF, a = new t({ definition: [], idx: n });
  return r && (a.separator = e.SEP), C(e, "MAX_LOOKAHEAD") && (a.maxLookahead = e.MAX_LOOKAHEAD), this.recordingProdStack.push(a), s.call(this), i.definition.push(a), this.recordingProdStack.pop(), ms;
}
function LA(t, e) {
  _i(e);
  const n = Tn(this.recordingProdStack), r = P(t) === !1, i = r === !1 ? t : t.DEF, s = new ye({
    definition: [],
    idx: e,
    ignoreAmbiguities: r && t.IGNORE_AMBIGUITIES === !0
  });
  C(t, "MAX_LOOKAHEAD") && (s.maxLookahead = t.MAX_LOOKAHEAD);
  const a = df(i, (o) => ct(o.GATE));
...
function _i(t) {
  if (t < 0 || t > Bl) {
	...
	Idx value must be a none negative value smaller than ${Bl + 1}`
    );
...
class PA {
  ...
  TRACE_INIT(e, n) {
    if (this.traceInitPerf === !0) {
      ...
      const { time: i, value: s } = pf(n), a = i > 10 ? console.warn : console.log;
...
const bi = To(Tt, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(bi);
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        ...
        const i = Hv(J(this.gastProductionsCache));
      ...
      })), !Pr.DEFER_DEFINITION_ERRORS_HANDLING && !U(this.definitionErrors))
...
Pr.DEFER_DEFINITION_ERRORS_HANDLING = !1;
MA(Pr, [
  dA,
  mA,
  IA,
...
const vt = 1, FA = 2, Wf = 4, zf = 5, Mr = 7, GA = 8, UA = 9, BA = 10, jA = 11, qf = 12;
class Eo {
  constructor(e) {
    this.target = e;
  }
...
function Xf(t, e, n) {
  return n instanceof j ? So(t, e, n.terminalType, n) : n instanceof ce ? eE(t, e, n) : n instanceof ye ? YA(t, e, n) : n instanceof re ? XA(t, e, n) : n instanceof z ? VA(t, e, n) : n instanceof ge ? WA(t, e, n) : n instanceof Se ? zA(t, e, n) : n instanceof Ie ? qA(t, e, n) : jt(t, e, n);
}
function VA(t, e, n) {
  const r = Q(t, e, n, {
    type: zf
...
function WA(t, e, n) {
  ...
  $t(t, r);
  const i = Cn(t, e, r, n, jt(t, e, n)), s = So(t, e, n.separator, n);
  return Zf(t, e, n, i, s);
}
function zA(t, e, n) {
  const r = Q(t, e, n, {
...
function YA(t, e, n) {
  ...
  $t(t, r);
  const i = st(n.definition, (a) => Xf(t, e, a));
  return Cn(t, e, r, n, ...i);
}
function XA(t, e, n) {
  const r = Q(t, e, n, {
...
function jt(t, e, n) {
  const r = Zd(st(n.definition, (i) => Xf(t, e, i)), (i) => i !== void 0);
  return r.length === 1 ? r[0] : r.length === 0 ? void 0 : QA(t, r);
}
function Jf(t, e, n, r, i) {
  ...
  return s.loopback = o, l.loopback = o, t.decisionMap[Rn(e, i ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", n.idx)] = o, Y(a, o), i === void 0 ? (Y(o, s), Y(o, l)) : (Y(o, l), Y(o, i.left), Y(i.right, s)), {
    left: s,
    right: l
  };
}
function Zf(t, e, n, r, i) {
  ...
  return o.loopback = u, l.loopback = u, Y(o, s), Y(o, l), Y(a, u), i !== void 0 ? (Y(u, l), Y(u, i.left), Y(i.right, s)) : Y(u, o), t.decisionMap[Rn(e, i ? "RepetitionWithSeparator" : "Repetition", n.idx)] = o, {
    left: o,
    right: l
  };
}
function JA(t, e, n, r) {
  ...
  return Y(i, s), t.decisionMap[Rn(e, "Option", n.idx)] = i, r;
}
function $t(t, e) {
...
function Cn(t, e, n, r, ...i) {
  ...
  return t.decisionMap[Rn(e, ZA(r), r.idx)] = n, a;
}
function ZA(t) {
  if (t instanceof ye)
    return "Alternation";
...
function QA(t, e) {
  ...
  for (let s = 0; s < n - 1; s++) {
    ...
    const l = o instanceof xo, u = o, c = e[s + 1].left;
    a.left.type === vt && a.right.type === vt && o !== void 0 && (l && u.followState === a.right || o.target === a.right) ? (l ? u.followState = c : o.target = c, nE(t, a.right)) : Y(a.right, c);
  }
  const r = e[0], i = e[n - 1];
  return {
    left: r.left,
...
class iE extends Ao {
  ...
  initialize(e) {
    this.atn = KA(e.rules), this.dfas = sE(this.atn);
  }
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: n, rule: r, hasPredicates: i, dynamicTokensEnabled: s } = e, a = this.dfas, o = this.logging, l = Rn(r, "Alternation", n), c = this.atn.decisionMap[l].decision, f = st(Ml({
      maxLookahead: 1,
      occurrence: n,
    ...
    if (Vl(f, !1) && !s) {
      const d = Po(f, (h, m, g) => (Es(m, (R) => {
        R && (h[R.tokenTypeIdx] = g, Es(R.categoryMatches, (y) => {
          h[y] = g;
        }));
      }), h), {});
      return i ? function(h) {
      ...
      const h = new ed(), m = d === void 0 ? 0 : d.length;
      for (let R = 0; R < m; R++) {
        const y = d == null ? void 0 : d[R].GATE;
        h.set(R, y === void 0 || y.call(this));
      }
      const g = Fs.call(this, a, c, h, o);
      return typeof g == "number" ? g : void 0;
    } : function() {
      const d = Fs.call(this, a, c, Hl, o);
      return typeof d == "number" ? d : void 0;
    };
  }
  buildLookaheadForOptional(e) {
    const { prodOccurrence: n, rule: r, prodType: i, dynamicTokensEnabled: s } = e, a = this.dfas, o = this.logging, l = Rn(r, i, n), c = this.atn.decisionMap[l].decision, f = st(Ml({
      maxLookahead: 1,
      occurrence: n,
      prodType: i,
      rule: r
    ...
    if (Vl(f) && f[0][0] && !s) {
      const d = f[0], h = zd(d);
      if (h.length === 1 && Qd(h[0].categoryMatches)) {
        const g = h[0].tokenTypeIdx;
        return function() {
          return this.LA(1).tokenTypeIdx === g;
        };
      } else {
        const m = Po(h, (g, R) => (R !== void 0 && (g[R.tokenTypeIdx] = !0, Es(R.categoryMatches, (y) => {
          g[y] = !0;
        })), g), {});
        return function() {
          const g = this.LA(1);
...
function Fs(t, e, n, r) {
  ...
  let s = i.start;
  if (s === void 0) {
    const o = gE(i.atnStartState);
    s = nd(i, td(o)), i.start = s;
  }
  return aE.apply(this, [i, s, n, r]);
}
function aE(t, e, n, r) {
  let i = e, s = 1;
  const a = [];
  ...
  for (; ; ) {
    let l = dE(i, o);
    if (l === void 0 && (l = oE.apply(this, [t, i, o, s, n, r])), l === Li)
      return fE(a, i, o);
...
function oE(t, e, n, r, i, s) {
  const a = hE(e.configs, n, i);
  if (a.size === 0)
    return Wl(t, e, n, Li), Li;
  let o = td(a);
  const l = mE(a, i);
  if (l !== void 0)
    ...
    const u = qd(a.alts);
    o.isAcceptState = !0, o.prediction = u, o.configs.uniqueAlt = u, lE.apply(this, [t, r, a.alts, s]);
  }
  return o = Wl(t, e, n, o), o;
}
function lE(t, e, n, r) {
  const i = [];
  for (let u = 1; u <= e; u++)
    i.push(this.LA(u).tokenType);
  const s = t.atnStartState, a = s.rule, o = s.production, l = uE({
    topLevelRule: a,
    ambiguityIndices: n,
    production: o,
    prefixPath: i
...
function uE(t) {
  const e = st(t.prefixPath, (i) => Jt(i)).join(", "), n = t.production.idx === 0 ? "" : t.production.idx;
  let r = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${cE(t.production)}${n}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return r = r + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, r;
...
function fE(t, e, n) {
  const r = eh(e.configs.elements, (s) => s.state.transitions), i = th(r.filter((s) => s instanceof $o).map((s) => s.tokenType), (s) => s.tokenTypeIdx);
  return {
    actualToken: n,
...
function hE(t, e, n) {
  ...
  for (const a of t.elements) {
    ...
    for (let l = 0; l < o; l++) {
      const u = a.state.transitions[l], c = pE(u, e);
      c !== void 0 && r.add({
        state: c,
        alt: a.alt,
        stack: a.stack
...
function pE(t, e) {
  if (t instanceof $o && kf(e, t.tokenType))
    return t.target;
}
function mE(t, e) {
  let n;
...
function Wl(t, e, n, r) {
  return r = nd(t, r), e.edges[n.tokenTypeIdx] = r, r;
}
function nd(t, e) {
  if (e === Li)
    return e;
...
function gE(t) {
  const e = new va(), n = t.transitions.length;
  for (let r = 0; r < n; r++) {
    const s = {
...
function Pi(t, e) {
  ...
  for (let i = 0; i < r; i++) {
    const s = n.transitions[i], a = yE(t, s);
    a !== void 0 && Pi(a, e);
  }
}
function yE(t, e) {
...
(function(t) {
  ...
  function n(r) {
    const i = r;
    return p.objectLiteral(i) && L.is(i.range) && Aa.is(i.color);
  }
  t.is = n;
})(Xl || (Xl = {}));
var Jl;
...
(function(t) {
  ...
  function n(r) {
    var i;
    let s = r;
    return p.defined(s) && L.is(s.range) && p.string(s.message) && (p.number(s.severity) || p.undefined(s.severity)) && (p.integer(s.code) || p.string(s.code) || p.undefined(s.code)) && (p.undefined(s.codeDescription) || p.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (p.string(s.source) || p.undefined(s.source)) && (p.undefined(s.relatedInformation) || p.typedArray(s.relatedInformation, Ea.is));
  }
  t.is = n;
})(Fi || (Fi = {}));
var An;
...
(function(t) {
  ...
  function i(s) {
    const a = s;
    return En.is(a) && ($a.is(a.annotationId) || $n.is(a.annotationId));
  }
  t.is = i;
})(ru || (ru = {}));
var xa;
(function(t) {
  ...
  function n(r) {
    let i = r;
    return p.defined(i) && wa.is(i.textDocument) && Array.isArray(i.edits);
  }
  t.is = n;
})(xa || (xa = {}));
var Sa;
(function(t) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "create" && p.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || p.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || p.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || $n.is(i.annotationId));
  }
  t.is = n;
})(Sa || (Sa = {}));
var Ia;
(function(t) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "rename" && p.string(i.oldUri) && p.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || p.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || p.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || $n.is(i.annotationId));
  }
  t.is = n;
})(Ia || (Ia = {}));
var ka;
(function(t) {
  ...
  function n(r) {
    let i = r;
    return i && i.kind === "delete" && p.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || p.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || p.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || $n.is(i.annotationId));
  }
  t.is = n;
})(ka || (ka = {}));
var Ca;
(function(t) {
  function e(n) {
    let r = n;
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => p.string(i.kind) ? Sa.is(i) || Ia.is(i) || ka.is(i) : xa.is(i)));
  }
  t.is = e;
})(Ca || (Ca = {}));
var iu;
...
(function(t) {
  function e(n) {
    const r = n;
    return p.objectLiteral(n) && Na.is(r.kind) && p.string(r.value);
  }
  t.is = e;
})(Er || (Er = {}));
var ou;
...
(function(t) {
  function e(r, i, s) {
    let a = { title: r }, o = !0;
    return typeof i == "string" ? (o = !1, a.kind = i) : An.is(i) ? a.command = i : a.edit = i, o && s !== void 0 && (a.kind = s), a;
  }
  t.create = e;
  function n(r) {
    let i = r;
    return i && p.string(i.title) && (i.diagnostics === void 0 || p.typedArray(i.diagnostics, Fi.is)) && (i.kind === void 0 || p.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || An.is(i.command)) && (i.isPreferred === void 0 || p.boolean(i.isPreferred)) && (i.edit === void 0 || Ca.is(i.edit));
  }
  t.is = n;
})(ku || (ku = {}));
var Cu;
(function(t) {
  ...
  function n(r) {
    let i = r;
    return p.defined(i) && L.is(i.range) && (p.undefined(i.command) || An.is(i.command));
  }
  t.is = n;
})(Cu || (Cu = {}));
var wu;
...
(function(t) {
  ...
  function n(r) {
    const i = r;
    return p.objectLiteral(i) && (i.tooltip === void 0 || p.string(i.tooltip) || Er.is(i.tooltip)) && (i.location === void 0 || Di.is(i.location)) && (i.command === void 0 || An.is(i.command));
  }
  t.is = n;
})(ba || (ba = {}));
var Gu;
(function(t) {
  ...
  function n(r) {
    const i = r;
    return p.objectLiteral(i) && D.is(i.position) && (p.string(i.label) || p.typedArray(i.label, ba.is)) && (i.kind === void 0 || _a.is(i.kind)) && i.textEdits === void 0 || p.typedArray(i.textEdits, En.is) && (i.tooltip === void 0 || p.string(i.tooltip) || Er.is(i.tooltip)) && (i.paddingLeft === void 0 || p.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || p.boolean(i.paddingRight));
  }
  t.is = n;
})(Gu || (Gu = {}));
var Uu;
...
(function(t) {
  function e(n) {
    const r = n;
    return p.objectLiteral(r) && Ra.is(r.uri) && p.string(r.name);
  }
  t.is = e;
})(Wu || (Wu = {}));
var zu;
...
class SE {
  ...
  buildRootNode(e) {
    return this.rootNode = new id(e), this.rootNode.root = this.rootNode, this.nodeStack = [this.rootNode], this.rootNode;
  }
  ...
  buildLeafNode(e, n) {
    const r = new Oa(e.startOffset, e.image.length, na(e), e.tokenType, !n);
  ...
  addHiddenNodes(e) {
    const n = [];
    for (const s of e) {
      const a = new Oa(s.startOffset, s.image.length, na(s), s.tokenType, !0);
...
class ko extends rd {
  constructor() {
    super(...arguments), this.content = new Co(this);
  }
...
class Co extends Array {
  constructor(e) {
    super(), this.parent = e, Object.setPrototypeOf(this, Co.prototype);
  }
  push(...e) {
...
const La = Symbol("Datatype");
function Gs(t) {
  return t.$type === La;
}
const qu = "​", sd = (t) => t.endsWith(qu) ? t : t + qu;
class ad {
  constructor(e) {
    ...
    this.wrapper = new NE(n, Object.assign(Object.assign({}, e.parser.ParserConfig), { skipValidations: r, errorMessageProvider: e.parser.ParserErrorMessageProvider }));
  }
  alternatives(e, n) {
...
class IE extends ad {
  ...
  rule(e, n) {
    const r = this.computeRuleType(e), i = this.wrapper.DEFINE_RULE(sd(e.name), this.startImplementation(r, n).bind(this));
  ...
  startImplementation(e, n) {
    return (r) => {
      ...
      if (i) {
        const a = { $type: e };
        this.stack.push(a), e === La && (a.value = "");
      }
      let s;
      try {
        s = n(r);
  ...
  consume(e, n, r) {
    ...
    if (!this.isRecording() && this.isValidToken(i)) {
      ...
      if (o) {
        const c = bt(r) ? i.image : this.converter.convert(i.image, a);
        this.assign(o.operator, o.feature, c, a, l);
      } else if (Gs(u)) {
        let c = i.image;
        bt(r) || (c = this.converter.convert(c, a).toString()), u.value += c;
      }
    }
  }
  /**
  ...
  construct() {
    ...
    return Ch(e), this.nodeBuilder.construct(e), this.stack.pop(), Gs(e) ? this.converter.convert(e.value, e.$cstNode) : (wh(this.astReflection, e), e);
  }
  getAssignment(e) {
...
class kE {
  buildMismatchTokenMessage(e) {
    return qt.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return qt.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return qt.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return qt.buildEarlyExitMessage(e);
  }
}
class od extends kE {
...
class CE extends ad {
  ...
  rule(e, n) {
    const r = this.wrapper.DEFINE_RULE(sd(e.name), this.startImplementation(n).bind(this));
...
const wE = {
  ...
  skipValidations: !0,
  errorMessageProvider: new od()
};
class NE extends DA {
  constructor(e, n) {
    const r = n && "maxLookahead" in n;
    super(e, Object.assign(Object.assign(Object.assign({}, wE), { lookaheadStrategy: r ? new Ao({ maxLookahead: n.maxLookahead }) : new iE({
...
function _E(t, e) {
  const n = wc(e, !1), r = ne(e.rules).filter(_e).filter((i) => n.has(i));
  for (const i of r) {
    const s = Object.assign(Object.assign({}, t), { consume: 1, optional: 1, subrule: 1, many: 1, or: 1 });
    t.parser.rule(i, Mt(s, i.definition));
  }
}
function Mt(t, e, n = !1) {
  let r;
  if (bt(e))
    ...
    const i = t.consume++;
    r = () => t.parser.consume(i, Tt, e);
  } else
    throw new vc(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return cd(t, n ? void 0 : Bi(e), r, e.cardinality);
}
function bE(t, e) {
  const n = Ya(e);
...
function OE(t, e) {
  const n = e.rule.ref;
  if (_e(n)) {
    const r = t.subrule++, i = n.fragment, s = e.arguments.length > 0 ? LE(n, e.arguments) : () => ({});
    return (a) => t.parser.subrule(r, fd(t, n), i, e, s(a));
  } else if (Ft(n)) {
    const r = t.consume++, i = Pa(t, n.name);
    return () => t.parser.consume(r, i, e);
  } else if (n)
    Sr();
  else
    throw new vc(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function LE(t, e) {
...
function DE(t, e) {
  const n = e.elements.map((r) => Mt(t, r));
...
function ud(t, e, n = e.terminal) {
  if (n)
    if (Ot(n) && _e(n.rule.ref)) {
      const r = n.rule.ref, i = t.subrule++;
      return (s) => t.parser.subrule(i, fd(t, r), !1, e, s);
    } else if (Ot(n) && Ft(n.rule.ref)) {
      const r = t.consume++, i = Pa(t, n.rule.ref.name);
      return () => t.parser.consume(r, i, e);
    } else if (bt(n)) {
      const r = t.consume++, i = Pa(t, n.value);
      return () => t.parser.consume(r, i, e);
    } else
    ...
    const r = bc(e.type.ref), i = r == null ? void 0 : r.terminal;
    if (!i)
      throw new Error("Could not find name assignment for type: " + Ya(e.type.ref));
    return ud(t, e, i);
  }
}
function FE(t, e) {
...
function fd(t, e) {
  const n = GE(t, e), r = t.parser.getRule(n);
  if (!r)
...
function GE(t, e) {
    ...
    return t.ruleNames.get(e);
  {
    ...
    for (; !_e(r); )
      (Va(r) || $c(r) || xc(r)) && (i = r.elements.indexOf(n).toString() + ":" + i), n = r, r = r.$container;
...
function UE(t) {
  const e = t.Grammar, n = t.parser.Lexer, r = new CE(t);
  return ld(e, r, n.definition), r.finalize(), r;
}
function BE(t) {
  const e = jE(t);
  return e.finalize(), e;
...
function jE(t) {
  const e = t.Grammar, n = t.parser.Lexer, r = new IE(t);
  return ld(e, r, n.definition);
}
class dd {
  constructor() {
    this.diagnostics = [];
  ...
  buildTokens(e, n) {
    const r = ne(wc(e, !1)), i = this.buildTerminalTokens(r), s = this.buildKeywordTokens(r, i, n);
    return i.forEach((a) => {
      const o = a.PATTERN;
      typeof o == "object" && o && "test" in o && ia(o) ? s.unshift(a) : s.push(a);
    }), s;
  }
  ...
  buildTerminalTokens(e) {
    return e.filter(Ft).filter((n) => !n.fragment).map((n) => this.buildTerminalToken(n)).toArray();
  }
  buildTerminalToken(e) {
    const n = Xa(e), r = this.requiresCustomPattern(n) ? this.regexPatternFunction(n) : n, i = {
      name: e.name,
      PATTERN: r
    };
    return typeof r == "function" && (i.LINE_BREAKS = !0), e.hidden && (i.GROUP = ia(n) ? he.SKIPPED : "hidden"), i;
  }
  ...
  buildKeywordTokens(e, n, r) {
    return e.filter(_e).flatMap((i) => Ir(i).filter(bt)).distinct((i) => i.value).toArray().sort((i, s) => s.value.length - i.value.length).map((i) => this.buildKeywordToken(i, n, !!(r != null && r.caseInsensitive)));
  }
  ...
  buildKeywordPattern(e, n) {
    return n ? new RegExp(Fh(e.value)) : e.value;
  }
  findLongerAlt(e, n) {
    return n.reduce((r, i) => {
      const s = i == null ? void 0 : i.PATTERN;
      return s != null && s.source && Gh("^" + s.source + "$", e.value) && r.push(i), r;
    }, []);
  }
}
class hd {
  ...
  runConverter(e, n, r) {
    ...
    switch ((i = Xh(e)) === null || i === void 0 ? void 0 : i.toLowerCase()) {
      case "number":
...
oe.array = md;
function zE(t) {
  return md(t) && t.every((e) => pd(e));
}
oe.stringArray = zE;
var xn = {};
Object.defineProperty(xn, "__esModule", { value: !0 });
var gd = xn.Emitter = xn.Event = void 0;
const qE = gs;
var Yu;
(function(t) {
  const e = { dispose() {
...
class ys {
  ...
  get event() {
    return this._event || (this._event = (e, n, r) => {
      this._callbacks || (this._callbacks = new YE()), this._options && this._options.onFirstListenerAdd && this._callbacks.isEmpty() && this._options.onFirstListenerAdd(this), this._callbacks.add(e, n);
      const i = {
        dispose: () => {
          this._callbacks && (this._callbacks.remove(e, n), i.dispose = ys._noop, this._options && this._options.onLastListenerRemove && this._callbacks.isEmpty() && this._options.onLastListenerRemove(this));
        }
      };
...
var wo = $r.CancellationTokenSource = V = $r.CancellationToken = void 0;
const XE = gs, JE = oe, Fa = xn;
var ji;
(function(t) {
  t.None = Object.freeze({
    isCancellationRequested: !1,
    onCancellationRequested: Fa.Event.None
  ...
  function e(n) {
    const r = n;
    return r && (r === t.None || r === t.Cancelled || JE.boolean(r.isCancellationRequested) && !!r.onCancellationRequested);
  }
  t.is = e;
})(ji || (V = $r.CancellationToken = ji = {}));
const ZE = Object.freeze(function(t, e) {
  const n = (0, XE.default)().timer.setTimeout(t.bind(e), 0);
  return { dispose() {
    n.dispose();
  } };
});
class Xu {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? ZE : (this._emitter || (this._emitter = new Fa.Emitter()), this._emitter.event);
  }
  dispose() {
...
class QE {
  get token() {
    return this._token || (this._token = new Xu()), this._token;
  }
  cancel() {
    this._token ? this._token.cancel() : this._token = ji.Cancelled;
  }
  dispose() {
    this._token ? this._token instanceof Xu && this._token.dispose() : this._token = ji.None;
  }
}
wo = $r.CancellationTokenSource = QE;
function e$() {
...
let hi = 0, t$ = 10;
function n$() {
  return hi = performance.now(), new wo();
}
const Ki = Symbol("OperationCancelled");
function Ts(t) {
  return t === Ki;
}
async function Ee(t) {
  ...
  if (e - hi >= t$ && (hi = e, await e$(), hi = performance.now()), t.isCancellationRequested)
    throw Ki;
}
class No {
  constructor() {
...
class xr {
  ...
  update(e, n) {
    for (const r of e)
      if (xr.isIncremental(r)) {
        const i = Td(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
  ...
  getLineOffsets() {
    return this._lineOffsets === void 0 && (this._lineOffsets = Ju(this._content, !0)), this._lineOffsets;
  }
  positionAt(e) {
    e = Math.max(Math.min(e, this._content.length), 0);
  ...
  ensureBeforeEOL(e, n) {
    for (; e > n && yd(this._content.charCodeAt(e - 1)); )
      e--;
    return e;
  }
  get lineCount() {
...
(function(t) {
  ...
  t.update = n;
  function r(i, s) {
    const a = i.getText(), o = Ua(s.map(r$), (c, f) => {
...
function Ju(t, e, n = 0) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    yd(s) && (s === 13 && i + 1 < t.length && t.charCodeAt(i + 1) === 10 && i++, r.push(n + i + 1));
  }
  return r;
}
function yd(t) {
...
(() => {
  ...
  (() => {
    ...
    const s = /^\w[\w\d+.-]*$/, a = /^\//, o = /^\/\//;
    function l(x, T) {
      if (!x.scheme && T) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${x.authority}", path: "${x.path}", query: "${x.query}", fragment: "${x.fragment}"}`);
    ...
    class d {
      constructor(T, $, S, O, b, _ = !1) {
        ...
        typeof T == "object" ? (this.scheme = T.scheme || u, this.authority = T.authority || u, this.path = T.path || u, this.query = T.query || u, this.fragment = T.fragment || u) : (this.scheme = /* @__PURE__ */ function(ve, Z) {
          return ve || Z ? ve : "file";
        }(T, _), this.authority = $ || u, this.path = function(ve, Z) {
          switch (ve) {
            case "https":
            case "http":
            case "file":
          ...
          return Z;
        }(this.scheme, S || u), this.query = O || u, this.fragment = b || u, l(this, _));
      }
      static isUri(T) {
      ...
      with(T) {
        if (!T) return this;
        let { scheme: $, authority: S, path: O, query: b, fragment: _ } = T;
        return $ === void 0 ? $ = this.scheme : $ === null && ($ = u), S === void 0 ? S = this.authority : S === null && (S = u), O === void 0 ? O = this.path : O === null && (O = u), b === void 0 ? b = this.query : b === null && (b = u), _ === void 0 ? _ = this.fragment : _ === null && (_ = u), $ === this.scheme && S === this.authority && O === this.path && b === this.query && _ === this.fragment ? this : new m($, S, O, b, _);
      }
      static parse(T, $ = !1) {
        const S = f.exec(T);
        return S ? new m(S[2] || u, se(S[4] || u), se(S[5] || u), se(S[7] || u), se(S[9] || u), $) : new m(u, u, u, u, u);
      }
      static file(T) {
        let $ = u;
      ...
      static revive(T) {
        if (T) {
          ...
          {
            const $ = new m(T);
            return $._formatted = T.external, $._fsPath = T._sep === h ? T.fsPath : null, $;
          }
        }
        return T;
      }
    ...
    class m extends d {
      constructor() {
        super(...arguments);
        pt(this, "_formatted", null);
        pt(this, "_fsPath", null);
      }
      get fsPath() {
        return this._fsPath || (this._fsPath = E(this)), this._fsPath;
      }
      toString($ = !1) {
        return $ ? v(this, !0) : (this._formatted || (this._formatted = v(this, !1)), this._formatted);
      }
      toJSON() {
        const $ = { $mid: 1 };
        return this._fsPath && ($.fsPath = this._fsPath, $._sep = h), this._formatted && ($.external = this._formatted), this.path && ($.path = this.path), this.scheme && ($.scheme = this.scheme), this.authority && ($.authority = this.authority), this.query && ($.query = this.query), this.fragment && ($.fragment = this.fragment), $;
      }
    }
    ...
    function R(x, T, $) {
      ...
      for (let b = 0; b < x.length; b++) {
        const _ = x.charCodeAt(b);
        if (_ >= 97 && _ <= 122 || _ >= 65 && _ <= 90 || _ >= 48 && _ <= 57 || _ === 45 || _ === 46 || _ === 95 || _ === 126 || T && _ === 47 || $ && _ === 91 || $ && _ === 93 || $ && _ === 58) O !== -1 && (S += encodeURIComponent(x.substring(O, b)), O = -1), S !== void 0 && (S += x.charAt(b));
        else {
          S === void 0 && (S = x.substr(0, b));
          const ve = g[_];
          ve !== void 0 ? (O !== -1 && (S += encodeURIComponent(x.substring(O, b)), O = -1), S += ve) : O === -1 && (O = b);
        }
      }
      return O !== -1 && (S += encodeURIComponent(x.substring(O))), S !== void 0 ? S : x;
    }
    function y(x) {
      let T;
      for (let $ = 0; $ < x.length; $++) {
        const S = x.charCodeAt($);
        S === 35 || S === 63 ? (T === void 0 && (T = x.substr(0, $)), T += g[S]) : T !== void 0 && (T += x[$]);
      }
      return T !== void 0 ? T : x;
    }
    function E(x, T) {
      let $;
      return $ = x.authority && x.path.length > 1 && x.scheme === "file" ? `//${x.authority}${x.path}` : x.path.charCodeAt(0) === 47 && (x.path.charCodeAt(1) >= 65 && x.path.charCodeAt(1) <= 90 || x.path.charCodeAt(1) >= 97 && x.path.charCodeAt(1) <= 122) && x.path.charCodeAt(2) === 58 ? x.path[1].toLowerCase() + x.path.substr(2) : x.path, i && ($ = $.replace(/\//g, "\\")), $;
    }
    function v(x, T) {
      const $ = T ? y : R;
      let S = "", { scheme: O, authority: b, path: _, query: ve, fragment: Z } = x;
      if (O && (S += O, S += ":"), (b || O === "file") && (S += c, S += c), b) {
        let W = b.indexOf("@");
        if (W !== -1) {
          const Ct = b.substr(0, W);
          b = b.substr(W + 1), W = Ct.lastIndexOf(":"), W === -1 ? S += $(Ct, !1, !1) : (S += $(Ct.substr(0, W), !1, !1), S += ":", S += $(Ct.substr(W + 1), !1, !0)), S += "@";
        }
        b = b.toLowerCase(), W = b.lastIndexOf(":"), W === -1 ? S += $(b, !1, !0) : (S += $(b.substr(0, W), !1, !0), S += b.substr(W));
      }
      if (_) {
      ...
      return ve && (S += "?", S += $(ve, !1, !1)), Z && (S += "#", S += T ? Z : R(Z, !1, !1)), S;
    }
    function I(x) {
      try {
        return decodeURIComponent(x);
      } catch {
        return x.length > 3 ? x.substr(0, 3) + I(x.substr(3)) : x;
      }
    }
    const M = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function se(x) {
      return x.match(M) ? x.replace(M, (T) => I(T)) : x;
    }
    var Me = n(470);
    const Te = Me.posix || Me, Ve = "/";
    var ke;
    (function(x) {
      x.joinPath = function(T, ...$) {
        return T.with({ path: Te.join(T.path, ...$) });
...
(function(t) {
  ...
  t.relative = n;
  function r(i) {
    return Dt.parse(i.toString()).toString();
  }
  t.normalize = r;
})(Rt || (Rt = {}));
var K;
...
class i$ {
  ...
  fromTextDocument(e, n, r) {
    return n = n ?? Dt.parse(e.uri), V.is(r) ? this.createAsync(n, e, r) : this.create(n, e, r);
  }
  fromString(e, n, r) {
  ...
  createTextDocumentGetter(e, n) {
    ...
    let i;
    return () => i ?? (i = Ga.create(e.toString(), r.getServices(e).LanguageMetaData.languageId, 0, n ?? ""));
  }
}
class s$ {
  constructor(e) {
...
class a$ {
  ...
  async link(e, n = V.None) {
    for (const r of Yt(e.parseResult.value))
      await Ee(n), Ic(r).forEach((i) => this.doLink(i, e));
  }
  doLink(e, n) {
    var r;
    const i = e.reference;
    ...
    const s = this, a = {
      ...
      get ref() {
        ...
        if (nh(this._nodeDescription)) {
          ...
          this._ref = Us;
          const l = ra(e).$document, u = s.getLinkedNode({ reference: a, container: e, property: n });
  ...
  createLinkingError(e, n) {
    const r = ra(e.container).$document;
...
class u$ {
  ...
  findReferences(e, n) {
    ...
    return n.documentUri && (i = i.filter((s) => Rt.equals(s.sourceUri, n.documentUri))), r.push(...i), ne(r);
  }
  getReferenceToSelf(e) {
    const n = this.nameProvider.getNameNode(e);
    if (n) {
      const r = mt(e), i = this.nodeLocator.getAstNodePath(e);
      return {
        sourceUri: r.uri,
        sourcePath: i,
        targetUri: r.uri,
...
class Hi {
   ...
   */
  get size() {
    return ea.sum(ne(this.map.values()).map((e) => e.length));
  }
  /**
...
class c$ {
   ...
   */
  async computeExportsForNode(e, n, r = Wa, i = V.None) {
    const s = [];
  ...
  async computeLocalScopes(e, n = V.None) {
    const r = e.parseResult.value, i = new Hi();
    for (const s of Ir(r))
...
class Qu {
  constructor(e, n, r) {
    var i;
    this.elements = e, this.outerScope = n, this.caseInsensitive = (i = r == null ? void 0 : r.caseInsensitive) !== null && i !== void 0 ? i : !1;
  }
  getAllElements() {
...
class m$ {
  ...
  getScope(e) {
    const n = [], r = this.reflection.getReferenceType(e), i = mt(e.container).precomputedScopes;
    if (i) {
      let a = e.container;
      do {
        const o = i.get(a);
   ...
   */
  getGlobalScope(e, n) {
    return this.globalScopeCache.get(e, () => new f$(this.indexManager.allElements(e)));
  }
}
function g$(t) {
...
class y$ {
  ...
  serialize(e, n) {
    const r = n ?? {}, i = n == null ? void 0 : n.replacer, s = (o, l) => this.replacer(o, l, r), a = i ? (o, l) => i(o, l, s) : s;
    try {
      return this.currentDocument = mt(e), JSON.stringify(e, a, n == null ? void 0 : n.space);
    } finally {
  ...
  replacer(e, n, { refText: r, sourceText: i, textRegions: s, comments: a, uriConverter: o }) {
    ...
    if (!this.ignoreProperties.has(e))
      if (ze(n)) {
        ...
        let d;
        if (s && (d = this.addAstNodeRegionWithAssignmentsTo(Object.assign({}, n)), (!e || n.$document) && (d != null && d.$textRegion) && (d.$textRegion.documentURI = (c = this.currentDocument) === null || c === void 0 ? void 0 : c.uri.toString())), i && !e && (d ?? (d = Object.assign({}, n)), d.$sourceText = (f = n.$cstNode) === null || f === void 0 ? void 0 : f.text), a) {
          d ?? (d = Object.assign({}, n));
  ...
  linkNode(e, n, r, i, s, a) {
    for (const [l, u] of Object.entries(e))
      if (Array.isArray(u))
        for (let c = 0; c < u.length; c++) {
          const f = u[c];
          ec(f) ? u[c] = this.reviveReference(e, l, n, f, r) : le(f) && this.linkNode(f, n, r, e, l, c);
        }
      else ec(u) ? e[l] = this.reviveReference(e, l, n, u, r) : le(u) && this.linkNode(u, n, r, e, l);
    const o = e;
  ...
  getRefNode(e, n, r) {
    try {
      ...
      if (i < 0) {
        const l = r ? r(n) : Dt.parse(n), u = this.langiumDocuments.getDocument(l);
        return u ? u.parseResult.value : "Could not find document for URI: " + n;
      }
      const s = r ? r(n.substring(0, i)) : Dt.parse(n.substring(0, i)), a = this.langiumDocuments.getDocument(s);
      if (!a)
...
class v$ {
  constructor(e) {
    this.entries = new Hi(), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
  }
  /**
...
class R$ {
  ...
  async validateAstNodes(e, n, r, i = V.None) {
    await Promise.all(Yt(e).map(async (s) => {
      await Ee(i);
...
function A$(t) {
  if (t.range)
    return t.range;
  let e;
  return typeof t.property == "string" ? e = _c(t.node.$cstNode, t.property, t.index) : typeof t.keyword == "string" && (e = Wh(t.node.$cstNode, t.keyword, t.index)), e ?? (e = t.node.$cstNode), e ? e.range : {
...
class x$ {
  ...
  async createDescriptions(e, n = V.None) {
    ...
    for (const s of Yt(i))
      await Ee(n), Ic(s).filter((a) => !si(a)).forEach((a) => {
  ...
  createDescription(e) {
    ...
    return {
      ...
      targetPath: n.path,
      segment: Ei(r),
      local: Rt.equals(n.documentUri, i)
    };
  }
}
class S$ {
...
class I$ {
  constructor(e) {
    this._ready = new No(), this.settings = {}, this.workspaceConfig = !1, this.onConfigurationSectionUpdateEmitter = new gd(), this.serviceRegistry = e.ServiceRegistry;
  }
  get ready() {
...
class k$ {
    ...
    for (const a of e) {
      ...
      if (a.state === K.Validated) {
        if (typeof n.validation == "boolean" && n.validation)
          ...
          if (u) {
            const f = ((s = n.validation.categories) !== null && s !== void 0 ? s : Vi.all).filter((d) => !u.includes(d));
  ...
  waitUntil(e, n, r) {
    ...
    return this.currentState >= e ? Promise.resolve(void 0) : r.isCancellationRequested ? Promise.reject(Ki) : new Promise((s, a) => {
  ...
  async validate(e, n) {
    ...
    if (u) {
      ...
      const c = (i = o == null ? void 0 : o.categories) !== null && i !== void 0 ? i : Vi.all;
...
class C$ {
  constructor(e) {
    this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new h$(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
  }
  findAllReferences(e, n) {
    const r = mt(e).uri, i = [];
    return this.referenceIndex.forEach((s) => {
      s.forEach((a) => {
        Rt.equals(a.targetUri, r) && a.targetPath === n && i.push(a);
      });
    }), ne(i);
  }
  allElements(e, n) {
...
class w$ {
  constructor(e) {
    this.initialBuildOptions = {}, this._ready = new No(), this.serviceRegistry = e.ServiceRegistry, this.langiumDocuments = e.workspace.LangiumDocuments, this.documentBuilder = e.workspace.DocumentBuilder, this.fileSystemProvider = e.workspace.FileSystemProvider, this.mutex = e.workspace.WorkspaceLock;
  }
  get ready() {
    return this._ready.promise;
  }
   ...
   */
  includeEntry(e, n, r) {
    const i = Rt.basename(n.uri);
    if (i.startsWith("."))
      return !1;
    if (n.isDirectory)
      return i !== "node_modules" && i !== "out";
    if (n.isFile) {
      const s = Rt.extname(n.uri);
      return r.includes(s);
    }
    return !1;
  }
...
class N$ {
  buildUnexpectedCharactersMessage(e, n, r, i, s) {
    return da.buildUnexpectedCharactersMessage(e, n, r, i, s);
  }
  buildUnableToPopLexerModeMessage(e) {
    return da.buildUnableToPopLexerModeMessage(e);
  }
}
const _$ = { mode: "full" };
class b$ {
  constructor(e) {
    ...
    const r = tc(n) ? Object.values(n) : n, i = e.LanguageMetaData.mode === "production";
  ...
  toTokenTypeDictionary(e) {
    if (tc(e))
      return e;
    const n = Ad(e) ? Object.values(e.modes).flat() : e, r = {};
...
function Ed(t) {
  let e = "";
  return typeof t == "string" ? e = t : e = t.text, e.split(Oh);
}
const nc = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, M$ = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function D$(t) {
  var e, n, r;
  const i = [];
  ...
  for (let o = 0; o < t.lines.length; o++) {
    ...
    if (c = c.substring(0, B$(c)), Ba(c, f) >= c.length) {
      if (i.length > 0) {
      ...
      if (f < c.length) {
        const m = c.substring(f), g = Array.from(m.matchAll(M$));
        i.push(...F$(g, m, s, a + f));
      }
    }
    s++, a = 0;
...
function j$(t) {
  ...
  if (t.tokens.length === 0)
    return new rc([], L.create(s, s));
  const a = [];
  for (; t.index < t.tokens.length; ) {
    const u = K$(t, a[a.length - 1]);
    u && a.push(u);
  }
...
function $d(t) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; )
    i.push(V$(t)), r = e, e = t.tokens[t.index];
  return new ja(i, L.create(n.range.start, r.range.end));
}
function V$(t) {
  return t.tokens[t.index].type === "inline-tag" ? xd(t, !0) : Sd(t);
}
function xd(t, e) {
  ...
  if ((i == null ? void 0 : i.type) === "text")
    if (e) {
      const s = Sd(t);
      return new Ks(r, new ja([s], s.range), e, L.create(n.range.start, s.range.end));
    } else {
      const s = $d(t);
      return new Ks(r, s, e, L.create(n.range.start, s.range.end));
    }
  else {
    const s = n.range;
    return new Ks(r, new ja([], s), e, s);
  }
}
function Sd(t) {
...
function js(t, e) {
  if (typeof t == "string" || typeof t == "object") {
    const n = typeof t == "string" ? Xi(t) : t.source;
...
${n}`), this.inline ? `{${e}}` : e;
  ...
  toMarkdown(e) {
    var n, r;
    return (r = (n = e == null ? void 0 : e.renderTag) === null || n === void 0 ? void 0 : n.call(e, this)) !== null && r !== void 0 ? r : this.toMarkdownDefault(e);
  }
  toMarkdownDefault(e) {
    const n = this.content.toMarkdown(e);
    if (this.inline) {
      const s = W$(this.name, n, e ?? {});
      if (typeof s == "string")
        return s;
    }
    let r = "";
...
function W$(t, e, n) {
  ...
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    return (t === "linkcode" || t === "link" && n.link === "code") && (a = `\`${a}\``), (i = (r = n.renderLink) === null || r === void 0 ? void 0 : r.call(n, e, a)) !== null && i !== void 0 ? i : z$(e, a);
  }
}
function z$(t, e) {
  try {
    return Dt.parse(t, !0), `[${e}](${t})`;
  } catch {
    return t;
  }
}
...
class q$ {
  ...
  findNameInPrecomputedScopes(e, n) {
    const i = mt(e).precomputedScopes;
    if (!i)
      return;
    let s = e;
    do {
...
class Y$ {
  ...
  getComment(e) {
    var n;
    return g$(e) ? e.$comment : (n = uh(e.$cstNode, this.grammarConfig().multilineCommentRules)) === null || n === void 0 ? void 0 : n.text;
  }
}
class X$ {
  constructor(e) {
...
class J$ {
  constructor() {
    this.previousTokenSource = new wo(), this.writeQueue = [], this.readQueue = [], this.done = !0;
  }
  write(e) {
    this.cancelWrite();
    const n = n$();
  ...
  async performNextOperation() {
    ...
    this.done = !1, await Promise.all(e.map(async ({ action: n, deferred: r, cancellationToken: i }) => {
      try {
        ...
        Ts(s) ? r.resolve(void 0) : r.reject(s);
      }
...
class Z$ {
  ...
  dehydrateCstNode(e, n) {
    ...
    return Tc(e) ? r.fullText = e.fullText : r.grammarSource = this.getGrammarElementId(e.grammarSource), r.hidden = e.hidden, r.astNode = n.astNodes.get(e.astNode), yr(e) ? r.content = e.content.map((i) => this.dehydrateCstNode(i, n)) : yc(e) && (r.tokenType = e.tokenType.name, r.offset = e.offset, r.length = e.length, r.startLine = e.range.start.line, r.startColumn = e.range.start.character, r.endLine = e.range.end.line, r.endColumn = e.range.end.character), r;
  }
  hydrate(e) {
  ...
  createHydrationContext(e) {
    ...
    let i;
    if (e.$cstNode)
      for (const s of ta(e.$cstNode)) {
        let a;
        "fullText" in s ? (a = new id(s.fullText), i = a) : "content" in s ? a = new ko() : "tokenType" in s && (a = this.hydrateCstLeafNode(s)), a && (r.set(s, a), a.root = i);
      }
    return {
      astNodes: n,
      cstNodes: r
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (const n of Yt(this.grammar))
      fh(n) && this.grammarElementIdMap.set(n, e++);
  }
}
function xt(t) {
  return {
    documentation: {
      CommentProvider: (e) => new Y$(e),
      DocumentationProvider: (e) => new q$(e)
    },
    parser: {
      AsyncParser: (e) => new X$(e),
      GrammarConfig: (e) => np(e),
      LangiumParser: (e) => BE(e),
      CompletionParser: (e) => UE(e),
      ValueConverter: () => new hd(),
      TokenBuilder: () => new dd(),
      Lexer: (e) => new b$(e),
      ParserErrorMessageProvider: () => new od(),
      LexerErrorMessageProvider: () => new N$()
    },
    workspace: {
      AstNodeLocator: () => new S$(),
      AstNodeDescriptionProvider: (e) => new $$(e),
      ReferenceDescriptionProvider: (e) => new x$(e)
    },
    references: {
      Linker: (e) => new a$(e),
      NameProvider: () => new l$(),
      ScopeProvider: (e) => new m$(e),
      ScopeComputation: (e) => new c$(e),
      References: (e) => new u$(e)
    },
    serializer: {
      Hydrator: (e) => new Z$(e),
      JsonSerializer: (e) => new y$(e)
    },
    validation: {
      DocumentValidator: (e) => new R$(e),
      ValidationRegistry: (e) => new v$(e)
    },
    shared: () => t.shared
  };
}
function St(t) {
  return {
    ...
    workspace: {
      ...
      LangiumDocumentFactory: (e) => new i$(e),
      DocumentBuilder: (e) => new k$(e),
      IndexManager: (e) => new C$(e),
      WorkspaceManager: (e) => new w$(e),
      FileSystemProvider: (e) => t.fileSystemProvider(e),
      WorkspaceLock: () => new J$(),
      ConfigurationProvider: (e) => new I$(e)
    }
  };
}
var sc;
(function(t) {
  t.merge = (e, n) => Wi(Wi({}, e), n);
})(sc || (sc = {}));
function ue(t, e, n, r, i, s, a, o, l) {
  const u = [t, e, n, r, i, s, a, o, l].reduce(Wi, {});
  return kd(u);
}
const Q$ = Symbol("isProxy");
function kd(t, e) {
  const n = new Proxy({}, {
    deleteProperty: () => !1,
    set: () => {
    ...
    get: (r, i) => i === Q$ ? !0 : oc(r, i, t, e || n),
    getOwnPropertyDescriptor: (r, i) => (oc(r, i, t, e || n), Object.getOwnPropertyDescriptor(r, i)),
    // used by for..in
    has: (r, i) => i in t,
    // used by ..in..
...
function oc(t, e, n, r) {
  if (e in t) {
    ...
    t[e] = ac;
    try {
      t[e] = typeof i == "function" ? i(r) : kd(i, r);
    } catch (s) {
...
function Wi(t, e) {
  if (e) {
    for (const [n, r] of Object.entries(e))
      if (r !== void 0) {
        const i = t[n];
        i !== null && r !== null && typeof i == "object" && typeof r == "object" ? t[n] = Wi(i, r) : t[n] = r;
      }
  }
  return t;
}
...
const It = {
  ...
  AstReflection: () => new Sc()
};
function rx() {
  const t = ue(St(It), nx), e = ue(xt({ shared: t }), tx);
  return t.ServiceRegistry.register(e), e;
}
function Kt(t) {
  var e;
  const n = rx(), r = n.serializer.JsonSerializer.deserialize(t);
  return n.shared.workspace.LangiumDocumentFactory.fromModel(r, Dt.parse(`memory://${(e = r.name) !== null && e !== void 0 ? e : "grammar"}.langium`)), r;
}
var ix = Object.defineProperty, A = (t, e) => ix(t, "name", { value: e, configurable: !0 }), lc = "Statement", pi = "Architecture";
function sx(t) {
...
A(ax, "isBranch");
var Qr = "Checkout", ei = "CherryPicking", Hs = "ClassDefStatement", dr = "Commit";
function ox(t) {
  return He.isInstance(t, dr);
}
A(ox, "isCommit");
var Vs = "Curve", Ws = "Edge", zs = "Entry", hr = "GitGraph";
function lx(t) {
  return He.isInstance(t, hr);
}
A(lx, "isGitGraph");
var qs = "Group", mi = "Info";
function ux(t) {
  return He.isInstance(t, mi);
}
A(ux, "isInfo");
var ti = "Item", Ys = "Junction", pr = "Merge";
function cx(t) {
  return He.isInstance(t, pr);
}
A(cx, "isMerge");
var Xs = "Option", gi = "Packet";
function fx(t) {
...
A(px, "isPieSection");
var Js = "Radar", Zs = "Service", Ri = "Treemap";
function mx(t) {
  return He.isInstance(t, Ri);
}
A(mx, "isTreemap");
var Qs = "TreemapRow", ni = "Direction", ri = "Leaf", ii = "Section", Zt, Cd = (Zt = class extends gc {
  getAllTypes() {
    return [pi, Zr, fr, Qr, ei, Hs, dr, Vs, ni, Ws, zs, hr, qs, mi, ti, Ys, ri, pr, Xs, gi, yi, Ti, vi, Js, ii, Zs, lc, Ri, Qs];
  }
  computeIsSubtype(e, n) {
    switch (e) {
      case fr:
  ...
  Grammar: /* @__PURE__ */ A(() => gx(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ A(() => $x, "LanguageMetaData"),
  parser: {}
}, _x = {
  Grammar: /* @__PURE__ */ A(() => yx(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ A(() => xx, "LanguageMetaData"),
  parser: {}
}, bx = {
  ...
  Grammar: /* @__PURE__ */ A(() => vx(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ A(() => Ix, "LanguageMetaData"),
  parser: {}
}, Lx = {
  Grammar: /* @__PURE__ */ A(() => Rx(), "Grammar"),
  LanguageMetaData: /* @__PURE__ */ A(() => kx, "LanguageMetaData"),
  parser: {}
}, Px = {
  ...
  LanguageMetaData: /* @__PURE__ */ A(() => wx, "LanguageMetaData"),
  parser: {}
}, Dx = /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/, Fx = /accTitle[\t ]*:([^\n\r]*)/, Gx = /title([\t ][^\n\r]*|)/, Ux = {
  ACC_DESCR: Dx,
  ACC_TITLE: Fx,
  TITLE: Gx
}, Qt, vs = (Qt = class extends hd {
  runConverter(e, n, r) {
...
}, A(Qt, "AbstractMermaidValueConverter"), Qt), en, Rs = (en = class extends vs {
  runCustomConverter(e, n, r) {
  }
}, A(en, "CommonValueConverter"), en), tn, kt = (tn = class extends dd {
  constructor(e) {
...
}, A(tn, "AbstractMermaidTokenBuilder"), tn), nn;
nn = class extends kt {
}, A(nn, "CommonTokenBuilder");
var rn, Bx = (rn = class extends kt {
  constructor() {
    super(["gitGraph"]);
  }
}, A(rn, "GitGraphTokenBuilder"), rn), wd = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new Bx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new Rs(), "ValueConverter")
  }
};
function Nd(t = It) {
  const e = ue(
...
A(Nd, "createGitGraphServices");
var sn, jx = (sn = class extends kt {
  constructor() {
    super(["info", "showInfo"]);
  }
}, A(sn, "InfoTokenBuilder"), sn), _d = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new jx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new Rs(), "ValueConverter")
  }
};
function bd(t = It) {
...
A(bd, "createInfoServices");
var an, Kx = (an = class extends kt {
  constructor() {
    super(["packet"]);
  }
}, A(an, "PacketTokenBuilder"), an), Od = {
  parser: {
...
A(Ld, "createPacketServices");
var on, Hx = (on = class extends kt {
  constructor() {
    super(["pie", "showData"]);
  }
}, A(on, "PieTokenBuilder"), on), ln, Vx = (ln = class extends vs {
  runCustomConverter(e, n, r) {
    if (e.name === "PIE_SECTION_LABEL")
      return n.replace(/"/g, "").trim();
  }
}, A(ln, "PieValueConverter"), ln), Pd = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new Hx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new Vx(), "ValueConverter")
  }
};
function Md(t = It) {
  const e = ue(
...
A(Md, "createPieServices");
var un, Wx = (un = class extends kt {
  constructor() {
    super(["architecture"]);
  }
}, A(un, "ArchitectureTokenBuilder"), un), cn, zx = (cn = class extends vs {
  runCustomConverter(e, n, r) {
    if (e.name === "ARCH_ICON")
      return n.replace(/[()]/g, "").trim();
...
}, A(cn, "ArchitectureValueConverter"), cn), Dd = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new Wx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new zx(), "ValueConverter")
  }
};
function Fd(t = It) {
  const e = ue(
...
A(Fd, "createArchitectureServices");
var fn, qx = (fn = class extends kt {
  constructor() {
    super(["radar-beta"]);
  }
}, A(fn, "RadarTokenBuilder"), fn), Gd = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new qx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new Rs(), "ValueConverter")
  }
};
function Ud(t = It) {
...
A(Ud, "createRadarServices");
var dn, Yx = (dn = class extends kt {
  constructor() {
    super(["treemap"]);
  }
}, A(dn, "TreemapTokenBuilder"), dn), Xx = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/, hn, Jx = (hn = class extends vs {
  runCustomConverter(e, n, r) {
    if (e.name === "NUMBER2")
...
}, A(pn, "TreemapValidator"), pn), jd = {
  parser: {
    TokenBuilder: /* @__PURE__ */ A(() => new Yx(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ A(() => new Jx(), "ValueConverter")
  },
  validation: {
    TreemapValidator: /* @__PURE__ */ A(() => new Zx(), "TreemapValidator")
  }
};
function Kd(t = It) {
  const e = ue(
  ...
  return e.ServiceRegistry.register(n), Bd(n), { shared: e, Treemap: n };
}
A(Kd, "createTreemapServices");
var nt = {}, Qx = {
  info: /* @__PURE__ */ A(async () => {
    const { createInfoServices: t } = await Promise.resolve().then(() => nS), e = t().Info.parser.LangiumParser;
    nt.info = e;
  }, "info"),
  packet: /* @__PURE__ */ A(async () => {
    const { createPacketServices: t } = await Promise.resolve().then(() => rS), e = t().Packet.parser.LangiumParser;
    nt.packet = e;
  }, "packet"),
  pie: /* @__PURE__ */ A(async () => {
    const { createPieServices: t } = await Promise.resolve().then(() => iS), e = t().Pie.parser.LangiumParser;
    nt.pie = e;
  }, "pie"),
  architecture: /* @__PURE__ */ A(async () => {
    const { createArchitectureServices: t } = await Promise.resolve().then(() => sS), e = t().Architecture.parser.LangiumParser;
    nt.architecture = e;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ A(async () => {
    const { createGitGraphServices: t } = await Promise.resolve().then(() => aS), e = t().GitGraph.parser.LangiumParser;
    nt.gitGraph = e;
  }, "gitGraph"),
  radar: /* @__PURE__ */ A(async () => {
    const { createRadarServices: t } = await Promise.resolve().then(() => oS), e = t().Radar.parser.LangiumParser;
    nt.radar = e;
  }, "radar"),
  treemap: /* @__PURE__ */ A(async () => {
    const { createTreemapServices: t } = await Promise.resolve().then(() => lS), e = t().Treemap.parser.LangiumParser;
    nt.treemap = e;
  }, "treemap")
};
...
A(eS, "parse");
var mn, tS = (mn = class extends Error {
  constructor(e) {
