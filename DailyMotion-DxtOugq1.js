import { a1 as P, r as v } from "./embed-entry-Bpg_TWAa.js";
import { w as D, x as O } from "./page-CxVhG5Fj.js";
function b(t, e) {
...
var M = Object.create, s = Object.defineProperty, w = Object.getOwnPropertyDescriptor, S = Object.getOwnPropertyNames, j = Object.getPrototypeOf, T = Object.prototype.hasOwnProperty, E = (t, e, r) => e in t ? s(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, A = (t, e) => {
  ...
  t
)), x = (t) => h(s({}, "__esModule", { value: !0 }), t), n = (t, e, r) => (E(t, typeof e != "symbol" ? e + "" : e, r), r), d = {};
A(d, {
  default: () => p
});
var _ = x(d), c = L(v), l = D, f = O;
const C = "https://api.dmcdn.net/all.js", N = "DM", K = "dmAsyncInit";
class p extends c.Component {
  ...
  load(e) {
    ...
    (0, l.getSDK)(C, N, K, (u) => u.player).then((u) => {
      if (!this.container)
        return;
      const m = u.player;
...
n(p, "loopOnEnded", !0);
const R = /* @__PURE__ */ P(_), k = /* @__PURE__ */ b({
  __proto__: null,
  default: R
}, [_]);
export {
