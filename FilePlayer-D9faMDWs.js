import { v as b, r as _ } from "./embed-entry-BQjeO8mI.js";
import { au as O, av as A } from "./mermaid-VLURNSYL-C7dSNHug.js";
function R(s, e) {
...
const y = typeof navigator < "u", F = y && navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1, P = y && (/iPad|iPhone|iPod/.test(navigator.userAgent) || F) && !window.MSStream, V = y && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream, T = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js", C = "Hls", B = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js", x = "dashjs", K = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js", G = "flvjs", X = /www\.dropbox\.com\/.+/, f = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/, W = "https://videodelivery.net/{id}/manifest/video.m3u8";
class v extends d.Component {
  ...
  componentDidMount() {
    ...
    e && (this.player.src = e), (P || this.props.config.forceDisableHls) && this.player.load();
  }
  ...
  shouldUseHLS(e) {
    return V && this.props.config.forceSafariHLS || this.props.config.forceHLS ? !0 : P || this.props.config.forceDisableHls ? !1 : c.HLS_EXTENSIONS.test(e) || f.test(e);
  }
  shouldUseDASH(e) {
...
r(v, "displayName", "FilePlayer");
r(v, "canPlay", c.canPlay.file);
